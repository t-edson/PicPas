...
var
  ...
  {$define _CP_UPPER_256 = $2FEF}  // 0F00h to 0FFFh code protected
  {$define _CP_HALF      = $1FDF}  // 0800h to 0FFFh code protected
  {$define _CP_ALL       = $0FCF}  // 0000h to 0FFFh code protected

...
var
  ...
  {$SET_STATE_RAM '092-09B:SFR'}  // PR2, SSPADD, SSPSTAT, WPUA, IOCA, WDTCON, TXSTA, SPBRG, SPBRGH, BAUDCTL
  ...
  {$SET_STATE_RAM '10C-10F:SFR'}  // EEDAT, EEADR, EEDATH, EEADRH
  ...
  {$SET_UNIMP_BITS '19D:1F'} // PSTRCON bits 7,6,5 un-implemented (read as 0)

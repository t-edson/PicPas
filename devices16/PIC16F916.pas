...
var
  ...
  {$SET_STATE_RAM '08C-099:SFR'}  // PIE1, PIE2, PCON, OSCCON, OSCTUNE, ANSEL, PR2, SSPADD, SSPSTAT, WPUB, IOCB, CMCON1, TXSTA, SPBRG
  ...
  {$SET_STATE_RAM '107-109:SFR'}  // LCDCON, LCDPS, LVDCON
  {$SET_STATE_RAM '10A-10A:SFR'}  // mapped to PCLATH
  {$SET_STATE_RAM '10C-111:SFR'}  // EEDATL, EEADRL, EEDATH, EEADRH, LCDDATA0, LCDDATA1
  ...
  {$SET_UNIMP_BITS '00D:F4'} // PIR2 bits 3,1,0 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '08D:F4'} // PIE2 bits 3,1,0 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '091:1F'} // ANSEL bits 7,6,5 un-implemented (read as 0)

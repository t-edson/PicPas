...
var
  ...
  {$SET_MAPPED_RAM '1A0-1EF:bnk3'} // maps to area 020-06F (bank 0)
  ...
  {$define _WRT_512        = $3DFF}  // 0000h to 01FFh write-protected, 0200h to 07FFh may be modified by EECON control
  {$define _WRT_1024       = $3BFF}  // 0000h to 03FFh write-protected, 0400h to 07FFh may be modified by EECON control
  {$define _WRT_1536       = $39FF}  // 0000h to 05FFh write-protected, 0600h to 07FFh may be modified by EECON control

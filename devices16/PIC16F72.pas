...
var
  ...
  {$SET_MAPPED_RAM '0C0-0FF:bnk0'} // maps to area 040-07F (bank 0)
  ...
  {$SET_MAPPED_RAM '140-17F:bnk0'} // maps to area 040-07F (bank 0)
  ...
  {$SET_MAPPED_RAM '1C0-1FF:bnk0'} // maps to area 040-07F (bank 0)

...
var
  ...
  {$SET_STATE_RAM '00E-017:SFR'}  // TMR1L, TMR1H, T1CON, TMR2, T2CON, SSPBUF, SSPCON, CCPR1L, CCPR1H, CCP1CON
  ...
  {$SET_STATE_RAM '10C-10F:SFR'}  // PMDATL, PMADRL, PMDATH, PMADRH
  {$SET_STATE_RAM '120-13F:GPR'} 
  {$SET_STATE_RAM '140-17F:GPR'} 
  ...
  {$SET_MAPPED_RAM '0C0-0FF:bnk1'} // maps to area 040-07F (bank 0)
  ...
  {$SET_MAPPED_RAM '120-13F:bnk2'} // maps to area 020-03F (bank 0)
  {$SET_MAPPED_RAM '140-17F:bnk2'} // maps to area 040-07F (bank 0)
  ...
  {$SET_MAPPED_RAM '1C0-1FF:bnk3'} // maps to area 040-07F (bank 0)

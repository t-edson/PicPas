...
var
  ...
  PIR2_OSFIF          : bit  absolute PIR2.4;
  ...
  PIR3_CLC3IF         : bit  absolute PIR3.3;
  PIR3_CLC2IF         : bit  absolute PIR3.2;
  PIR3_CLC1IF         : bit  absolute PIR3.1;
  ...
  PIE2_OSFIE          : bit  absolute PIE2.4;
  ...
  PIE3_CLC3IE         : bit  absolute PIE3.3;
  PIE3_CLC2IE         : bit  absolute PIE3.2;
  PIE3_CLC1IE         : bit  absolute PIE3.1;
  ...
  CMOUT_MC2OUT        : bit  absolute CMOUT.2;
  ...
  CCPTMRS_P3TSEL1     : bit  absolute CCPTMRS.4;
  CCPTMRS_P3TSEL0     : bit  absolute CCPTMRS.3;
  CCPTMRS_C1TSEL1     : bit  absolute CCPTMRS.2;
  CCPTMRS_C1TSEL0     : bit  absolute CCPTMRS.1;
  ...
  DACLD_DAC1LD        : bit  absolute DACLD.1;
  ...
  COG1RIS1_RIS14      : bit  absolute COG1RIS1.7;
  COG1RIS1_RIS13      : bit  absolute COG1RIS1.6;
  COG1RIS1_RIS12      : bit  absolute COG1RIS1.5;
  COG1RIS1_RIS11      : bit  absolute COG1RIS1.4;
  COG1RIS1_RIS10      : bit  absolute COG1RIS1.3;
  COG1RIS1_RIS9       : bit  absolute COG1RIS1.2;
  COG1RIS1_RIS8       : bit  absolute COG1RIS1.1;
  ...
  COG1RSIM1_RSIM14    : bit  absolute COG1RSIM1.7;
  COG1RSIM1_RSIM13    : bit  absolute COG1RSIM1.6;
  COG1RSIM1_RSIM12    : bit  absolute COG1RSIM1.5;
  COG1RSIM1_RSIM11    : bit  absolute COG1RSIM1.4;
  COG1RSIM1_RSIM10    : bit  absolute COG1RSIM1.3;
  COG1RSIM1_RSIM9     : bit  absolute COG1RSIM1.2;
  COG1RSIM1_RSIM8     : bit  absolute COG1RSIM1.1;
  ...
  COG1FIS1_FIS14      : bit  absolute COG1FIS1.7;
  COG1FIS1_FIS13      : bit  absolute COG1FIS1.6;
  COG1FIS1_FIS12      : bit  absolute COG1FIS1.5;
  COG1FIS1_FIS11      : bit  absolute COG1FIS1.4;
  COG1FIS1_FIS10      : bit  absolute COG1FIS1.3;
  COG1FIS1_FIS9       : bit  absolute COG1FIS1.2;
  COG1FIS1_FIS8       : bit  absolute COG1FIS1.1;
  ...
  COG1FSIM1_FSIM14    : bit  absolute COG1FSIM1.7;
  COG1FSIM1_FSIM13    : bit  absolute COG1FSIM1.6;
  COG1FSIM1_FSIM12    : bit  absolute COG1FSIM1.5;
  COG1FSIM1_FSIM11    : bit  absolute COG1FSIM1.4;
  COG1FSIM1_FSIM10    : bit  absolute COG1FSIM1.3;
  COG1FSIM1_FSIM9     : bit  absolute COG1FSIM1.2;
  COG1FSIM1_FSIM8     : bit  absolute COG1FSIM1.1;
  ...
  PWM5LDCON_LDA       : bit  absolute PWM5LDCON.2;
  PWM5OFCON           : byte absolute $0DA0;
  PWM5OFCON_OFO       : bit  absolute PWM5OFCON.2;
  ...
  {$SET_STATE_RAM '10E-117:SFR'}  // LATC, CMOUT, CM1CON0, CM1CON1, CM1NSEL, CM1PSEL, CM2CON0, CM2CON1, CM2NSEL, CM2PSEL
  ...
  {$SET_STATE_RAM '50F-512:SFR'}  // OPA1NCHS, OPA1PCHS, OPA1CON, OPA1ORS
  {$SET_STATE_RAM '520-56F:GPR'} 
  {$SET_STATE_RAM '570-57F:GPR'} 
  {$SET_STATE_RAM '580-580:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '590-593:SFR'}  // DACLD, DAC1CON0, DAC1REFL, DAC1REFH
  {$SET_STATE_RAM '597-598:SFR'}  // DAC3CON0, DAC3REF
  {$SET_STATE_RAM '5A0-5EF:GPR'} 
  {$SET_STATE_RAM '5F0-5FF:GPR'} 
  {$SET_STATE_RAM '600-600:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '617-619:SFR'}  // PWM3DCL, PWM3DCH, PWM3CON
  ...
  {$SET_STATE_RAM '794-799:SFR'}  // PRG1RTSS, PRG1FTSS, PRG1INS, PRG1CON0, PRG1CON1, PRG1CON2
  ...
  {$SET_STATE_RAM 'D8E-DA0:SFR'}  // PWMEN, PWMLD, PWMOUT, PWM5PHL, PWM5PHH, PWM5DCL, PWM5DCH, PWM5PRL, PWM5PRH, PWM5OFL, PWM5OFH, PWM5TMRL, PWM5TMRH, PWM5CON, PWM5INTE, PWM5INTF, PWM5CLKCON, PWM5LDCON, PWM5OFCON
  {$SET_STATE_RAM 'DF0-DFF:GPR'} 
  {$SET_STATE_RAM 'E00-E00:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM 'E0F-E14:SFR'}  // PPSLOCK, INTPPS, T0CKIPPS, T1CKIPPS, T1GPPS, CCP1PPS
  {$SET_STATE_RAM 'E16-E16:SFR'}  // COG1INPPS
  ...
  {$SET_STATE_RAM 'E28-E2D:SFR'}  // CLCIN0PPS, CLCIN1PPS, CLCIN2PPS, CLCIN3PPS, PRG1RPPS, PRG1FPPS
  {$SET_STATE_RAM 'E30-E32:SFR'}  // MD1CHPPS, MD1CLPPS, MD1MODPPS

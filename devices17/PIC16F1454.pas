...
var
  ...
  TRISA_TRISA5       : bit  absolute TRISA.2;
  TRISA_TRISA4       : bit  absolute TRISA.1;
  ...
  OSCSTAT_SOSCR      : bit  absolute OSCSTAT.6;
  OSCSTAT_PLLRDY     : bit  absolute OSCSTAT.5;
  ...
  LATA_LATA5         : bit  absolute LATA.2;
  LATA_LATA4         : bit  absolute LATA.1;
  ...
  APFCON_CLKRSEL     : bit  absolute APFCON.5;
  APFCON_SDOSEL      : bit  absolute APFCON.4;
  APFCON_SSSEL       : bit  absolute APFCON.3;
  ...
  WPUA_WPUA5         : bit  absolute WPUA.3;
  WPUA_WPUA4         : bit  absolute WPUA.2;
  WPUA_WPUA3         : bit  absolute WPUA.1;
  ...
  ACTCON_ACTEN       : bit  absolute ACTCON.5;
  ACTCON_ACTUD       : bit  absolute ACTCON.4;
  ACTCON_ACTSRC      : bit  absolute ACTCON.3;
  ...
  UCFG_UTEYE         : bit  absolute UCFG.5;
  UCFG_UPUEN         : bit  absolute UCFG.4;
  UCFG_FSEN          : bit  absolute UCFG.3;
  ...
  UEIR_BTOEF         : bit  absolute UEIR.6;
  UEIR_DFN8EF        : bit  absolute UEIR.5;
  UEIR_CRC16EF       : bit  absolute UEIR.4;
  UEIR_CRC5EF        : bit  absolute UEIR.3;
  UEIR_PIDEF         : bit  absolute UEIR.2;
  ...
  UEIE_BTOEE         : bit  absolute UEIE.6;
  UEIE_DFN8EE        : bit  absolute UEIE.5;
  UEIE_CRC16EE       : bit  absolute UEIE.4;
  UEIE_CRC5EE        : bit  absolute UEIE.3;
  UEIE_PIDEE         : bit  absolute UEIE.2;
  ...
  {$SET_STATE_RAM '095-09A:SFR'}  // OPTION_REG, PCON, WDTCON, OSCTUNE, OSCCON, OSCSTAT
  ...
  {$SET_STATE_RAM '39A-39B:SFR'}  // CLKRCON, ACTCON
  ...
  {$SET_STATE_RAM '611-616:SFR'}  // PWM1DCL, PWM1DCH, PWM1CON, PWM2DCL, PWM2DCH, PWM2CON
  ...
  {$SET_STATE_RAM 'E8E-E9F:SFR'}  // UCON, USTAT, UIR, UCFG, UIE, UEIR, UFRMH, UFRML, UADDR, UEIE, UEP0, UEP1, UEP2, UEP3, UEP4, UEP5, UEP6, UEP7
  ...
  {$SET_UNIMP_BITS '011:BB'} // PIR1 bits 6,2 un-implemented (read as 0)
  {$SET_UNIMP_BITS '012:8E'} // PIR2 bits 6,5,4,0 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '091:BB'} // PIE1 bits 6,2 un-implemented (read as 0)
  {$SET_UNIMP_BITS '092:8E'} // PIE2 bits 6,5,4,0 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '117:C0'} // FVRCON bits 5,4,3,2,1,0 un-implemented (read as 0)
  {$SET_UNIMP_BITS '11D:EC'} // APFCON bits 4,1,0 un-implemented (read as 0)
  {$SET_UNIMP_BITS '18C:00'} // ANSELA bits 7,6,5,4,3,2,1,0 un-implemented (read as 0)
  ...
  // Pin  1 : VDD
  // Pin  2 : RA5/SOSCI/T1CKI/PWM2/CLKIN/OSC1
  // Pin  3 : RA4/SOSCO/T1G/SDO/CLKOUT/OSC2/CLKR
  // Pin  4 : RA3/T1G/SS/MCLR/VPP
  // Pin  5 : RC5/RX_DT/T0CKI/PWM1
  // Pin  6 : RC4/TX_CK
  // Pin  7 : RC3/SS/PWM2/CLKR
  // Pin  8 : RC2/SDO
  // Pin  9 : RC1/INT/SDI/SDA/ICSPCLK
  // Pin 10 : RC0/SCK/SCL/ICSPDAT
  // Pin 11 : VUSB3V3
  // Pin 12 : RA1/D-/ICSPCLK
  // Pin 13 : RA0/D+/ICSPDAT
  // Pin 14 : VSS


  // -- RAM to PIN mapping --

  {$MAP_RAM_TO_PIN '00C:1-13,2-12,3-4,4-3,5-2'} // PORTA

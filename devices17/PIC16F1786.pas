...
var
  ...
  PORTE_RE3            : bit  absolute PORTE.1;
  ...
  WPUE_WPUE3           : bit  absolute WPUE.1;
  ...
  INLVLE_INLVLE3       : bit  absolute INLVLE.1;
  ...
  PSMC3OEN_P3OEB       : bit  absolute PSMC3OEN.2;
  PSMC3OEN_P3OEA       : bit  absolute PSMC3OEN.1;
  PSMC3POL             : byte absolute $0856;
  PSMC3POL_P3INPOL     : bit  absolute PSMC3POL.3;
  PSMC3POL_P3POLB      : bit  absolute PSMC3POL.2;
  PSMC3POL_P3POLA      : bit  absolute PSMC3POL.1;
  ...
  PSMC3STR0_P3STRB     : bit  absolute PSMC3STR0.2;
  PSMC3STR0_P3STRA     : bit  absolute PSMC3STR0.1;
  ...
  {$SET_STATE_RAM '010-01C:SFR'}  // PORTE, PIR1, PIR2, PIR3, PIR4, TMR0, TMR1L, TMR1H, T1CON, T1GCON, TMR2, PR2, T2CON
  ...
  {$SET_STATE_RAM '090-09F:SFR'}  // TRISE, PIE1, PIE2, PIE3, PIE4, OPTION_REG, PCON, WDTCON, OSCTUNE, OSCCON, OSCSTAT, ADRESL, ADRESH, ADCON0, ADCON1, ADCON2
  ...
  {$SET_STATE_RAM '111-11F:SFR'}  // CM1CON0, CM1CON1, CM2CON0, CM2CON1, CMOUT, BORCON, FVRCON, DACCON0, DACCON1, CM4CON0, CM4CON1, APFCON2, APFCON1, CM3CON0, CM3CON1
  ...
  {$SET_STATE_RAM '191-197:SFR'}  // EEADRL, EEADRH, EEDATL, EEDATH, EECON1, EECON2, VREGCON
  ...
  {$SET_STATE_RAM '311-313:SFR'}  // CCPR3L, CCPR3H, CCP3CON
  ...
  {$SET_STATE_RAM '390-399:SFR'}  // INLVLE, IOCAP, IOCAN, IOCAF, IOCBP, IOCBN, IOCBF, IOCCP, IOCCN, IOCCF
  ...
  {$SET_UNIMP_BITS '855:03'} // PSMC3OEN bits 7,6,5,4,3,2 un-implemented (read as 0)
  {$SET_UNIMP_BITS '856:43'} // PSMC3POL bits 7,5,4,3,2 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '86E:03'} // PSMC3STR0 bits 7,6,5,4,3,2 un-implemented (read as 0)
  ...
  // Pin  8 : Vss
  // Pin  9 : RA7/PSMC1CLK/PSMC2CLK/PSMC3CLK/OSC1/CLKIN
  ...
  // Pin 19 : Vss
  // Pin 20 : Vdd
  // Pin 21 : RB0/AN12/C2IN1+/PSMC1IN/PSMC2IN/PSMC3IN/CCP1/INT
  ...
  // Pin 26 : RB5/AN13/C4IN2-/T1G/CCP3/C3OUT/SDO
  // Pin 27 : RB6/TX/CK/SDI/SDA/C4IN1+/ICSPCLK/ICDCLK
  // Pin 28 : RB7/RX/DT/SCK/SCL/DAC1OUT2/ICSPDAT/ICDDAT

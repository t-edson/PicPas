...
var
  ...
  CM1CON0_C1ZLF       : bit  absolute CM1CON0.4;
  ...
  CM2CON0_C2ZLF       : bit  absolute CM2CON0.4;
  ...
  PWM3CON_PWM3EN      : bit  absolute PWM3CON.3;
  ...
  PWM4CON_PWM4EN      : bit  absolute PWM4CON.3;
  ...
  COG1CON1_G1POLD     : bit  absolute COG1CON1.5;
  COG1CON1_G1POLC     : bit  absolute COG1CON1.4;
  COG1CON1_G1POLB     : bit  absolute COG1CON1.3;
  COG1CON1_G1POLA     : bit  absolute COG1CON1.2;
  COG1RIS             : byte absolute $0699;
  COG1RIS_G1RIS6      : bit  absolute COG1RIS.7;
  COG1RIS_G1RIS5      : bit  absolute COG1RIS.6;
  COG1RIS_G1RIS4      : bit  absolute COG1RIS.5;
  COG1RIS_G1RIS3      : bit  absolute COG1RIS.4;
  COG1RIS_G1RIS2      : bit  absolute COG1RIS.3;
  COG1RIS_G1RIS1      : bit  absolute COG1RIS.2;
  COG1RIS_G1RIS0      : bit  absolute COG1RIS.1;
  COG1RSIM            : byte absolute $069A;
  COG1RSIM_G1RSIM6    : bit  absolute COG1RSIM.7;
  COG1RSIM_G1RSIM5    : bit  absolute COG1RSIM.6;
  COG1RSIM_G1RSIM4    : bit  absolute COG1RSIM.5;
  COG1RSIM_G1RSIM3    : bit  absolute COG1RSIM.4;
  COG1RSIM_G1RSIM2    : bit  absolute COG1RSIM.3;
  COG1RSIM_G1RSIM1    : bit  absolute COG1RSIM.2;
  COG1RSIM_G1RSIM0    : bit  absolute COG1RSIM.1;
  COG1FIS             : byte absolute $069B;
  COG1FIS_G1FIS6      : bit  absolute COG1FIS.7;
  COG1FIS_G1FIS5      : bit  absolute COG1FIS.6;
  COG1FIS_G1FIS4      : bit  absolute COG1FIS.5;
  COG1FIS_G1FIS3      : bit  absolute COG1FIS.4;
  COG1FIS_G1FIS2      : bit  absolute COG1FIS.3;
  COG1FIS_G1FIS1      : bit  absolute COG1FIS.2;
  COG1FIS_G1FIS0      : bit  absolute COG1FIS.1;
  COG1FSIM            : byte absolute $069C;
  COG1FSIM_G1FSIM6    : bit  absolute COG1FSIM.7;
  COG1FSIM_G1FSIM5    : bit  absolute COG1FSIM.6;
  COG1FSIM_G1FSIM4    : bit  absolute COG1FSIM.5;
  COG1FSIM_G1FSIM3    : bit  absolute COG1FSIM.4;
  COG1FSIM_G1FSIM2    : bit  absolute COG1FSIM.3;
  COG1FSIM_G1FSIM1    : bit  absolute COG1FSIM.2;
  COG1FSIM_G1FSIM0    : bit  absolute COG1FSIM.1;
  ...
  {$SET_STATE_RAM '691-69F:SFR'}  // COG1PHR, COG1PHF, COG1BLKR, COG1BLKF, COG1DBR, COG1DBF, COG1CON0, COG1CON1, COG1RIS, COG1RSIM, COG1FIS, COG1FSIM, COG1ASD0, COG1ASD1, COG1STR
  ...
  {$SET_STATE_RAM 'E17-E17:SFR'}  // COGINPPS
  ...
  // Pin  1 : VDD
  // Pin  2 : RA5/T1CKI/SOSCI/CLKIN/OSC1
  // Pin  3 : RA4/AN3/SOSCO/CLKOUT/OSC2
  // Pin  4 : RA3/MCLR/VPP
  // Pin  5 : RC5
  // Pin  6 : RC4
  // Pin  7 : RC3/AN7/C1IN3-/C2IN3-/OPA2OUT
  // Pin  8 : RC6/AN8/OPA2IN-
  // Pin  9 : RC7/AN9/OPA2IN+
  // Pin 10 : RB7
  // Pin 11 : RB6
  // Pin 12 : RB5/AN11/OPA1IN+
  // Pin 13 : RB4/AN10/OPA1IN-
  // Pin 14 : RC2/AN6/C1IN2-/C2IN2-/OPA1OUT
  // Pin 15 : RC1/AN5/C1IN1-/C2IN1-
  // Pin 16 : RC0/AN4/C2IN+
  // Pin 17 : RA2/AN2/DAC1OUT2/ZCD
  // Pin 18 : RA1/AN1/VREF+/C1IN0-/C2IN0-/ICSPCLK/ICDCLK
  // Pin 19 : RA0/AN0/VREF-/C1IN+/DAC1OUT1/ICSPDAT/ICDDAT
  // Pin 20 : VSS

...
var
  ...
  DACCON0_DACEN       : bit  absolute DACCON0.4;
  DACCON0_DACOE1      : bit  absolute DACCON0.3;
  DACCON0_DACOE2      : bit  absolute DACCON0.2;
  DACCON0_DACPSS      : bit  absolute DACCON0.1;
  ...
  CWG1CON2_G1ASDSC2   : bit  absolute CWG1CON2.5;
  CWG1CON2_G1ASDSC1   : bit  absolute CWG1CON2.4;
  CWG1CON2_G1ASDSFLT  : bit  absolute CWG1CON2.3;
  CWG1CON2_G1ASDSCLC2 : bit  absolute CWG1CON2.2;
  ...
  CLC3SEL1_LC3D3S2    : bit  absolute CLC3SEL1.3;
  CLC3SEL1_LC3D3S1    : bit  absolute CLC3SEL1.2;
  CLC3SEL1_LC3D3S0    : bit  absolute CLC3SEL1.1;
  ...
  CLC4SEL1_LC4D3S2    : bit  absolute CLC4SEL1.3;
  CLC4SEL1_LC4D3S1    : bit  absolute CLC4SEL1.2;
  CLC4SEL1_LC4D3S0    : bit  absolute CLC4SEL1.1;
  ...
  {$SET_STATE_RAM 'F0F-F2F:SFR'}  // CLCDATA, CLC1CON, CLC1POL, CLC1SEL0, CLC1SEL1, CLC1GLS0, CLC1GLS1, CLC1GLS2, CLC1GLS3, CLC2CON, CLC2POL, CLC2SEL0, CLC2SEL1, CLC2GLS0, CLC2GLS1, CLC2GLS2, CLC2GLS3, CLC3CON, CLC3POL, CLC3SEL0, CLC3SEL1, CLC3GLS0, CLC3GLS1, CLC3GLS2, CLC3GLS3, CLC4CON, CLC4POL, CLC4SEL0, CLC4SEL1, CLC4GLS0, CLC4GLS1, CLC4GLS2, CLC4GLS3

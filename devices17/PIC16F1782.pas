...
var
  ...
  PIR4_PSMC2TIF        : bit  absolute PIR4.4;
  PIR4_PSMC1TIF        : bit  absolute PIR4.3;
  ...
  PIE4_PSMC2SIE        : bit  absolute PIE4.3;
  PIE4_PSMC1SIE        : bit  absolute PIE4.2;
  ...
  OPA1CON_OPA1CH1      : bit  absolute OPA1CON.5;
  OPA1CON_OPA1CH0      : bit  absolute OPA1CON.4;
  OPA2CON              : byte absolute $0513;
  OPA2CON_OPA2EN       : bit  absolute OPA2CON.7;
  OPA2CON_OPA2SP       : bit  absolute OPA2CON.6;
  OPA2CON_OPA2CH1      : bit  absolute OPA2CON.5;
  OPA2CON_OPA2CH0      : bit  absolute OPA2CON.4;
  ...
  PSMC1REBS_P1REBSIN   : bit  absolute PSMC1REBS.4;
  ...
  PSMC1FEBS_P1FEBSIN   : bit  absolute PSMC1FEBS.4;
  ...
  PSMC1PHS_P1PHSIN     : bit  absolute PSMC1PHS.5;
  ...
  PSMC1DCS_P1DCSIN     : bit  absolute PSMC1DCS.5;
  ...
  PSMC1PRS_P1PRSIN     : bit  absolute PSMC1PRS.5;
  ...
  PSMC1ASDS_P1ASDSIN   : bit  absolute PSMC1ASDS.4;
  ...
  PSMC2REBS_P2REBSIN   : bit  absolute PSMC2REBS.4;
  ...
  PSMC2FEBS_P2FEBSIN   : bit  absolute PSMC2FEBS.4;
  ...
  PSMC2PHS_P2PHSIN     : bit  absolute PSMC2PHS.5;
  ...
  PSMC2DCS_P2DCSIN     : bit  absolute PSMC2DCS.5;
  ...
  PSMC2PRS_P2PRSIN     : bit  absolute PSMC2PRS.5;
  ...
  PSMC2ASDS_P2ASDSIN   : bit  absolute PSMC2ASDS.4;
  ...
  {$SET_STATE_RAM '014-01C:SFR'}  // PIR4, TMR0, TMR1L, TMR1H, T1CON, T1GCON, TMR2, PR2, T2CON
  ...
  {$SET_STATE_RAM '094-09F:SFR'}  // PIE4, OPTION_REG, PCON, WDTCON, OSCTUNE, OSCCON, OSCSTAT, ADRESL, ADRESH, ADCON0, ADCON1, ADCON2

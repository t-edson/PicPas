...
var
  ...
  CPSCON1_CPSCH2      : bit  absolute CPSCON1.3;
  CPSCON1_CPSCH1      : bit  absolute CPSCON1.2;
  CPSCON1_CPSCH0      : bit  absolute CPSCON1.1;
  ...
  LATE_LATE3          : bit  absolute LATE.1;
  ...
  {$SET_STATE_RAM '010-013:SFR'}  // PORTE, PIR1, PIR2, PIR3
  ...
  {$SET_STATE_RAM '090-093:SFR'}  // TRISE, PIE1, PIE2, PIE3
  ...
  {$SET_STATE_RAM '110-11B:SFR'}  // LATE, CM1CON0, CM1CON1, CM2CON0, CM2CON1, CMOUT, BORCON, FVRCON, DACCON0, DACCON1, SRCON0, SRCON1
  ...
  {$SET_STATE_RAM '798-799:SFR'}  // LCDSE0, LCDSE1
  {$SET_STATE_RAM '7A0-7A1:SFR'}  // LCDDATA0, LCDDATA1
  {$SET_STATE_RAM '7A3-7A4:SFR'}  // LCDDATA3, LCDDATA4
  {$SET_STATE_RAM '7A6-7A7:SFR'}  // LCDDATA6, LCDDATA7
  {$SET_STATE_RAM '7A9-7AA:SFR'}  // LCDDATA9, LCDDATA10

...
var
  ...
  LATE                   : byte absolute $001A;
  LATE_LATE2             : bit  absolute LATE.3;
  ...
  T0CON0_T0OUT           : bit  absolute T0CON0.6;
  T0CON0_T016BIT         : bit  absolute T0CON0.5;
  ...
  ADCON0_ADON            : bit  absolute ADCON0.6;
  ADCON0_ADCONT          : bit  absolute ADCON0.5;
  ADCON0_ADCS            : bit  absolute ADCON0.4;
  ADCON0_ADFM1           : bit  absolute ADCON0.3;
  ADCON0_ADFM0           : bit  absolute ADCON0.2;
  ADCON0_ADGO            : bit  absolute ADCON0.1;
  ADCON0_DONE            : bit  absolute ADCON0.0;
  ADCON1                 : byte absolute $0094;
  ADCON1_ADPPOL          : bit  absolute ADCON1.4;
  ADCON1_ADIPEN          : bit  absolute ADCON1.3;
  ADCON1_ADGPOL          : bit  absolute ADCON1.2;
  ADCON1_ADDSEN          : bit  absolute ADCON1.1;
  ...
  ADCON2_ADMD1           : bit  absolute ADCON2.2;
  ADCON2_ADMD0           : bit  absolute ADCON2.1;
  ...
  ADCON3_ADTMD2          : bit  absolute ADCON3.3;
  ADCON3_ADTMD1          : bit  absolute ADCON3.2;
  ADCON3_ADTMD0          : bit  absolute ADCON3.1;
  ...
  ADPRE_ADPRE7           : bit  absolute ADPRE.7;
  ADPRE_ADPRE6           : bit  absolute ADPRE.6;
  ADPRE_ADPRE5           : bit  absolute ADPRE.5;
  ADPRE_ADPRE4           : bit  absolute ADPRE.4;
  ADPRE_ADPRE3           : bit  absolute ADPRE.3;
  ADPRE_ADPRE2           : bit  absolute ADPRE.2;
  ADPRE_ADPRE1           : bit  absolute ADPRE.1;
  ADPRE_ADPRE0           : bit  absolute ADPRE.0;
  ADACQ                  : byte absolute $009D;
  ADACQ_ADACQ7           : bit  absolute ADACQ.7;
  ADACQ_ADACQ6           : bit  absolute ADACQ.6;
  ADACQ_ADACQ5           : bit  absolute ADACQ.5;
  ADACQ_ADACQ4           : bit  absolute ADACQ.4;
  ADACQ_ADACQ3           : bit  absolute ADACQ.3;
  ADACQ_ADACQ2           : bit  absolute ADACQ.2;
  ADACQ_ADACQ1           : bit  absolute ADACQ.1;
  ADACQ_ADACQ0           : bit  absolute ADACQ.0;
  ...
  T1GCON_GPOL            : bit  absolute T1GCON.5;
  ...
  T3CLK_T3CS3            : bit  absolute T3CLK.3;
  T3CLK_T3CS2            : bit  absolute T3CLK.2;
  T3CLK_T3CS1            : bit  absolute T3CLK.1;
  T3CLK_T3CS0            : bit  absolute T3CLK.0;
  ...
  T5CLK_T5CS3            : bit  absolute T5CLK.3;
  T5CLK_T5CS2            : bit  absolute T5CLK.2;
  T5CLK_T5CS1            : bit  absolute T5CLK.1;
  T5CLK_T5CS0            : bit  absolute T5CLK.0;
  ...
  SCANLADRL_LADR1        : bit  absolute SCANLADRL.1;
  SCANLADRL_LADR0        : bit  absolute SCANLADRL.0;
  ...
  SCANHADRL_HADR2        : bit  absolute SCANHADRL.2;
  ...
  CRCCON0_SHIFTM         : bit  absolute CRCCON0.3;
  CRCCON0_FULL           : bit  absolute CRCCON0.2;
  ...
  SMT2CLK_SMT2CSEL0      : bit  absolute SMT2CLK.0;
  ...
  NCO1CON_N1EN           : bit  absolute NCO1CON.4;
  ...
  NCO1CLK_N1PWS2         : bit  absolute NCO1CLK.6;
  NCO1CLK_N1PWS1         : bit  absolute NCO1CLK.5;
  NCO1CLK_N1PWS0         : bit  absolute NCO1CLK.4;
  NCO1CLK_N1CKS2         : bit  absolute NCO1CLK.3;
  ...
  CWG2ISM_CWG2ISM3       : bit  absolute CWG2ISM.3;
  CWG2ISM_CWG2ISM2       : bit  absolute CWG2ISM.2;
  CWG2ISM_CWG2ISM1       : bit  absolute CWG2ISM.1;
  CWG2ISM_CWG2ISM0       : bit  absolute CWG2ISM.0;
  ...
  CWG3ISM_CWG3ISM3       : bit  absolute CWG3ISM.3;
  CWG3ISM_CWG3ISM2       : bit  absolute CWG3ISM.2;
  CWG3ISM_CWG3ISM1       : bit  absolute CWG3ISM.1;
  CWG3ISM_CWG3ISM0       : bit  absolute CWG3ISM.0;
  CWG3DBR                : byte absolute $068E;
  CWG3DBF                : byte absolute $068F;
  CWG3CON0               : byte absolute $0690;
  CWG3CON0_CWG3MODE2     : bit  absolute CWG3CON0.2;
  CWG3CON0_CWG3MODE1     : bit  absolute CWG3CON0.1;
  CWG3CON0_CWG3MODE0     : bit  absolute CWG3CON0.0;
  ...
  PIR6_CCP5IF            : bit  absolute PIR6.5;
  ...
  PIR7_CWG3IF            : bit  absolute PIR7.3;
  PIR7_CWG2IF            : bit  absolute PIR7.2;
  PIR7_CWG1IF            : bit  absolute PIR7.1;
  ...
  PIE6_CCP5IE            : bit  absolute PIE6.5;
  ...
  PIE7_CWG3IE            : bit  absolute PIE7.3;
  PIE7_CWG2IE            : bit  absolute PIE7.2;
  PIE7_CWG1IE            : bit  absolute PIE7.1;
  ...
  PMD0_CRCMD             : bit  absolute PMD0.5;
  PMD0_SCANMD            : bit  absolute PMD0.4;
  PMD0_NVMMD             : bit  absolute PMD0.3;
  PMD0_CLKRMD            : bit  absolute PMD0.2;
  ...
  PMD3_PWM7MD            : bit  absolute PMD3.7;
  PMD3_PWM6MD            : bit  absolute PMD3.6;
  PMD3_CCP5MD            : bit  absolute PMD3.5;
  ...
  PMD4_CWG3MD            : bit  absolute PMD4.3;
  PMD4_CWG2MD            : bit  absolute PMD4.2;
  PMD4_CWG1MD            : bit  absolute PMD4.1;
  PMD5                   : byte absolute $079B;
  PMD5_SMT2MD            : bit  absolute PMD5.7;
  PMD5_SMT1MD            : bit  absolute PMD5.6;
  PMD5_CLC4MD            : bit  absolute PMD5.5;
  PMD5_CLC3MD            : bit  absolute PMD5.4;
  PMD5_CLC2MD            : bit  absolute PMD5.3;
  PMD5_CLC1MD            : bit  absolute PMD5.2;
  PMD5_DSMMD             : bit  absolute PMD5.1;
  ...
  CCDCON_CCDS1           : bit  absolute CCDCON.6;
  CCDCON_CCDS0           : bit  absolute CCDCON.5;
  ...
  MDCON0_MDEN            : bit  absolute MDCON0.5;
  MDCON0_MDOUT           : bit  absolute MDCON0.4;
  MDCON0_MDOPOL          : bit  absolute MDCON0.3;
  MDCON0_MDBIT           : bit  absolute MDCON0.2;
  MDCON1                 : byte absolute $0898;
  MDCON1_MDCHPOL         : bit  absolute MDCON1.5;
  MDCON1_MDCHSYNC        : bit  absolute MDCON1.4;
  MDCON1_MDCLPOL         : bit  absolute MDCON1.3;
  MDCON1_MDCLSYNC        : bit  absolute MDCON1.2;
  ...
  CCP5PPS_CCP5PPS5       : bit  absolute CCP5PPS.5;
  ...
  SMT1WINPPS_SMU1WINPPS4 : bit  absolute SMT1WINPPS.4;
  SMT1WINPPS_SMU1WINPPS3 : bit  absolute SMT1WINPPS.3;
  SMT1WINPPS_SMU1WINPPS2 : bit  absolute SMT1WINPPS.2;
  SMT1WINPPS_SMU1WINPPS1 : bit  absolute SMT1WINPPS.1;
  SMT1WINPPS_SMU1WINPPS0 : bit  absolute SMT1WINPPS.0;
  SMT1SIGPPS             : byte absolute $0EAA;
  SMT1SIGPPS_SMU1SIGPPS4 : bit  absolute SMT1SIGPPS.4;
  SMT1SIGPPS_SMU1SIGPPS3 : bit  absolute SMT1SIGPPS.3;
  SMT1SIGPPS_SMU1SIGPPS2 : bit  absolute SMT1SIGPPS.2;
  SMT1SIGPPS_SMU1SIGPPS1 : bit  absolute SMT1SIGPPS.1;
  SMT1SIGPPS_SMU1SIGPPS0 : bit  absolute SMT1SIGPPS.0;
  SMT2WINPPS             : byte absolute $0EAB;
  SMT2WINPPS_SMU2WINPPS4 : bit  absolute SMT2WINPPS.4;
  SMT2WINPPS_SMU2WINPPS3 : bit  absolute SMT2WINPPS.3;
  SMT2WINPPS_SMU2WINPPS2 : bit  absolute SMT2WINPPS.2;
  SMT2WINPPS_SMU2WINPPS1 : bit  absolute SMT2WINPPS.1;
  SMT2WINPPS_SMU2WINPPS0 : bit  absolute SMT2WINPPS.0;
  SMT2SIGPPS             : byte absolute $0EAC;
  SMT2SIGPPS_SMU2SIGPPS4 : bit  absolute SMT2SIGPPS.4;
  SMT2SIGPPS_SMU2SIGPPS3 : bit  absolute SMT2SIGPPS.3;
  SMT2SIGPPS_SMU2SIGPPS2 : bit  absolute SMT2SIGPPS.2;
  SMT2SIGPPS_SMU2SIGPPS1 : bit  absolute SMT2SIGPPS.1;
  SMT2SIGPPS_SMU2SIGPPS0 : bit  absolute SMT2SIGPPS.0;
  ...
  CCDND                  : byte absolute $0F61;
  CCDND_CCDND7           : bit  absolute CCDND.7;
  CCDND_CCDND6           : bit  absolute CCDND.6;
  CCDND_CCDND5           : bit  absolute CCDND.5;
  CCDND_CCDND4           : bit  absolute CCDND.4;
  CCDND_CCDND3           : bit  absolute CCDND.3;
  CCDND_CCDND2           : bit  absolute CCDND.2;
  CCDND_CCDND1           : bit  absolute CCDND.1;
  CCDND_CCDND0           : bit  absolute CCDND.0;
  CCDPD                  : byte absolute $0F62;
  CCDPD_CCDPD7           : bit  absolute CCDPD.7;
  CCDPD_CCDPD6           : bit  absolute CCDPD.6;
  CCDPD_CCDPD5           : bit  absolute CCDPD.5;
  CCDPD_CCDPD4           : bit  absolute CCDPD.4;
  CCDPD_CCDPD3           : bit  absolute CCDPD.3;
  CCDPD_CCDPD2           : bit  absolute CCDPD.2;
  CCDPD_CCDPD1           : bit  absolute CCDPD.1;
  CCDPD_CCDPD0           : bit  absolute CCDPD.0;
  ANSELE                 : byte absolute $0F64;
  ANSELE_ANSE2           : bit  absolute ANSELE.3;
  ANSELE_ANSE1           : bit  absolute ANSELE.2;
  ANSELE_ANSE0           : bit  absolute ANSELE.1;
  WPUE                   : byte absolute $0F65;
  WPUE_WPUE3             : bit  absolute WPUE.4;
  WPUE_WPUE2             : bit  absolute WPUE.3;
  WPUE_WPUE1             : bit  absolute WPUE.2;
  WPUE_WPUE0             : bit  absolute WPUE.1;
  ODCONE                 : byte absolute $0F66;
  ODCONE_ODCE2           : bit  absolute ODCONE.3;
  ODCONE_ODCE1           : bit  absolute ODCONE.2;
  ODCONE_ODCE0           : bit  absolute ODCONE.1;
  SLRCONE                : byte absolute $0F67;
  SLRCONE_SLRE2          : bit  absolute SLRCONE.3;
  SLRCONE_SLRE1          : bit  absolute SLRCONE.2;
  SLRCONE_SLRE0          : bit  absolute SLRCONE.1;
  INLVLE                 : byte absolute $0F68;
  INLVLE_INLVLE3         : bit  absolute INLVLE.4;
  INLVLE_INLVLE2         : bit  absolute INLVLE.3;
  INLVLE_INLVLE1         : bit  absolute INLVLE.2;
  INLVLE_INLVLE0         : bit  absolute INLVLE.1;
  IOCEP                  : byte absolute $0F69;
  IOCEP_IOCEP3           : bit  absolute IOCEP.2;
  IOCEN                  : byte absolute $0F6A;
  IOCEN_IOCEN3           : bit  absolute IOCEN.2;
  IOCEF                  : byte absolute $0F6B;
  IOCEF_IOCEF3           : bit  absolute IOCEF.2;
  CCDNE                  : byte absolute $0F6C;
  CCDNE_CCDNE2           : bit  absolute CCDNE.3;
  CCDNE_CCDNE1           : bit  absolute CCDNE.2;
  CCDNE_CCDNE0           : bit  absolute CCDNE.1;
  CCDPE                  : byte absolute $0F6D;
  CCDPE_CCDPE2           : bit  absolute CCDPE.3;
  CCDPE_CCDPE1           : bit  absolute CCDPE.2;
  CCDPE_CCDPE0           : bit  absolute CCDPE.1;
  ...
  {$SET_STATE_RAM '000-01A:SFR'}  // INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON, PORTA, PORTB, PORTC, PORTD, PORTE, TRISA, TRISB, TRISC, TRISD, TRISE, LATA, LATB, LATC, LATD, LATE
  {$SET_STATE_RAM '01C-01F:SFR'}  // TMR0L, TMR0H, T0CON0, T0CON1
  {$SET_STATE_RAM '020-06F:GPR'} 
  {$SET_STATE_RAM '070-07F:GPR'} 
  {$SET_STATE_RAM '080-080:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '08C-091:SFR'}  // ADRESL, ADRESH, ADPREVL, ADPREVH, ADACCL, ADACCH
  {$SET_STATE_RAM '093-09E:SFR'}  // ADCON0, ADCON1, ADCON2, ADCON3, ADSTAT, ADCLK, ADACT, ADREF, ADCAP, ADPRE, ADACQ, ADPCH
  {$SET_STATE_RAM '0A0-0EF:GPR'} 
  {$SET_STATE_RAM '0F0-0FF:GPR'} 
  {$SET_STATE_RAM '100-100:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '10C-117:SFR'}  // ADCNT, ADRPT, ADLTHL, ADLTHH, ADUTHL, ADUTHH, ADSTPTL, ADSTPTH, ADFLTRL, ADFLTRH, ADERRL, ADERRH
  {$SET_STATE_RAM '119-11F:SFR'}  // RC1REG, TX1REG, SP1BRGL, SP1BRGH, RC1STA, TX1STA, BAUD1CON
  ...
  {$SET_STATE_RAM '30C-31F:SFR'}  // CCPR1L, CCPR1H, CCP1CON, CCP1CAP, CCPR2L, CCPR2H, CCP2CON, CCP2CAP, CCPR3L, CCPR3H, CCP3CON, CCP3CAP, CCPR4L, CCPR4H, CCP4CON, CCP4CAP, CCPR5L, CCPR5H, CCP5CON, CCP5CAP
  ...
  {$SET_STATE_RAM '40C-411:SFR'}  // SCANLADRL, SCANLADRH, SCANHADRL, SCANHADRH, SCANCON0, SCANTRIG
  {$SET_STATE_RAM '416-41F:SFR'}  // CRCDATL, CRCDATH, CRCACCL, CRCACCH, CRCSHIFTL, CRCSHIFTH, CRCXORL, CRCXORH, CRCCON0, CRCCON1
  ...
  {$SET_STATE_RAM '50C-51D:SFR'}  // SMT2TMRL, SMT2TMRH, SMT2TMRU, SMT2CPRL, SMT2CPRH, SMT2CPRU, SMT2CPWL, SMT2CPWH, SMT2CPWU, SMT2PRL, SMT2PRH, SMT2PRU, SMT2CON0, SMT2CON1, SMT2STAT, SMT2CLK, SMT2SIG, SMT2WIN
  ...
  {$SET_STATE_RAM '616-61E:SFR'}  // CWG2CLKCON, CWG2ISM, CWG2DBR, CWG2DBF, CWG2CON0, CWG2CON1, CWG2AS0, CWG2AS1, CWG2STR
  {$SET_STATE_RAM '620-66F:GPR'} 
  {$SET_STATE_RAM '670-67F:GPR'} 
  {$SET_STATE_RAM '680-680:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '68C-694:SFR'}  // CWG3CLKCON, CWG3ISM, CWG3DBR, CWG3DBF, CWG3CON0, CWG3CON1, CWG3AS0, CWG3AS1, CWG3STR
  ...
  {$SET_STATE_RAM '80C-814:SFR'}  // WDTCON0, WDTCON1, WDTPSL, WDTPSH, WDTTMR, BORCON, VREGCON, PCON0, CCDCON
  ...
  {$SET_STATE_RAM '895-89B:SFR'}  // CLKRCON, CLKRCLK, MDCON0, MDCON1, MDSRC, MDCARL, MDCARH
  ...
  {$SET_STATE_RAM 'E0F-E37:SFR'}  // CLCDATA, CLC1CON, CLC1POL, CLC1SEL0, CLC1SEL1, CLC1SEL2, CLC1SEL3, CLC1GLS0, CLC1GLS1, CLC1GLS2, CLC1GLS3, CLC2CON, CLC2POL, CLC2SEL0, CLC2SEL1, CLC2SEL2, CLC2SEL3, CLC2GLS0, CLC2GLS1, CLC2GLS2, CLC2GLS3, CLC3CON, CLC3POL, CLC3SEL0, CLC3SEL1, CLC3SEL2, CLC3SEL3, CLC3GLS0, CLC3GLS1, CLC3GLS2, CLC3GLS3, CLC4CON, CLC4POL, CLC4SEL0, CLC4SEL1, CLC4SEL2, CLC4SEL3, CLC4GLS0, CLC4GLS1, CLC4GLS2, CLC4GLS3
  {$SET_STATE_RAM 'E70-E7F:GPR'} 
  {$SET_STATE_RAM 'E80-E80:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM 'E8F-E97:SFR'}  // PPSLOCK, INTPPS, T0CKIPPS, T1CKIPPS, T1GPPS, T3CKIPPS, T3GPPS, T5CKIPPS, T5GPPS
  {$SET_STATE_RAM 'E9C-E9E:SFR'}  // T2AINPPS, T4AINPPS, T6AINPPS
  {$SET_STATE_RAM 'EA1-EA5:SFR'}  // CCP1PPS, CCP2PPS, CCP3PPS, CCP4PPS, CCP5PPS
  {$SET_STATE_RAM 'EA9-EAC:SFR'}  // SMT1WINPPS, SMT1SIGPPS, SMT2WINPPS, SMT2SIGPPS
  {$SET_STATE_RAM 'EB1-EB3:SFR'}  // CWG1PPS, CWG2PPS, CWG3PPS
  {$SET_STATE_RAM 'EB8-EBE:SFR'}  // MDCARLPPS, MDCARHPPS, MDSRCPPS, CLCIN0PPS, CLCIN1PPS, CLCIN2PPS, CLCIN3PPS
  {$SET_STATE_RAM 'EC3-EC3:SFR'}  // ADCACTPPS
  {$SET_STATE_RAM 'EC5-ECC:SFR'}  // SSP1CLKPPS, SSP1DATPPS, SSP1SSPPS, SSP2CLKPPS, SSP2DATPPS, SSP2SSPPS, RXPPS, TXPPS
  {$SET_STATE_RAM 'EF0-EFF:GPR'} 
  {$SET_STATE_RAM 'F00-F00:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM 'F10-F32:SFR'}  // RA0PPS, RA1PPS, RA2PPS, RA3PPS, RA4PPS, RA5PPS, RA6PPS, RA7PPS, RB0PPS, RB1PPS, RB2PPS, RB3PPS, RB4PPS, RB5PPS, RB6PPS, RB7PPS, RC0PPS, RC1PPS, RC2PPS, RC3PPS, RC4PPS, RC5PPS, RC6PPS, RC7PPS, RD0PPS, RD1PPS, RD2PPS, RD3PPS, RD4PPS, RD5PPS, RD6PPS, RD7PPS, RE0PPS, RE1PPS, RE2PPS
  {$SET_STATE_RAM 'F38-F41:SFR'}  // ANSELA, WPUA, ODCONA, SLRCONA, INLVLA, IOCAP, IOCAN, IOCAF, CCDNA, CCDPA
  {$SET_STATE_RAM 'F43-F4C:SFR'}  // ANSELB, WPUB, ODCONB, SLRCONB, INLVLB, IOCBP, IOCBN, IOCBF, CCDNB, CCDPB
  {$SET_STATE_RAM 'F4E-F57:SFR'}  // ANSELC, WPUC, ODCONC, SLRCONC, INLVLC, IOCCP, IOCCN, IOCCF, CCDNC, CCDPC
  {$SET_STATE_RAM 'F59-F5D:SFR'}  // ANSELD, WPUD, ODCOND, SLRCOND, INLVLD
  {$SET_STATE_RAM 'F61-F62:SFR'}  // CCDND, CCDPD
  {$SET_STATE_RAM 'F64-F6D:SFR'}  // ANSELE, WPUE, ODCONE, SLRCONE, INLVLE, IOCEP, IOCEN, IOCEF, CCDNE, CCDPE
  ...
  {$SET_UNIMP_BITS '015:07'} // TRISE bits 7,6,5,4,3 un-implemented (read as 0)
  {$SET_UNIMP_BITS '01A:0F'} // LATE bits 7,6,5,4 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS 'EA5:3F'} // CCP5PPS bits 7,6 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS 'F28:3F'} // RD0PPS bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS 'F29:3F'} // RD1PPS bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS 'F2A:3F'} // RD2PPS bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS 'F2B:3F'} // RD3PPS bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS 'F2C:3F'} // RD4PPS bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS 'F2D:3F'} // RD5PPS bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS 'F2E:3F'} // RD6PPS bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS 'F2F:3F'} // RD7PPS bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS 'F30:3F'} // RE0PPS bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS 'F31:3F'} // RE1PPS bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS 'F32:3F'} // RE2PPS bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS 'F64:07'} // ANSELE bits 7,6,5,4,3 un-implemented (read as 0)
  {$SET_UNIMP_BITS 'F65:0F'} // WPUE bits 7,6,5,4 un-implemented (read as 0)
  {$SET_UNIMP_BITS 'F66:07'} // ODCONE bits 7,6,5,4,3 un-implemented (read as 0)
  {$SET_UNIMP_BITS 'F67:07'} // SLRCONE bits 7,6,5,4,3 un-implemented (read as 0)
  {$SET_UNIMP_BITS 'F68:0F'} // INLVLE bits 7,6,5,4 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS 'F6C:07'} // CCDNE bits 7,6,5,4,3 un-implemented (read as 0)
  {$SET_UNIMP_BITS 'F6D:07'} // CCDPE bits 7,6,5,4,3 un-implemented (read as 0)
  ...
  // Pin 11 : VDD
  // Pin 12 : AVSS/VSS
  // Pin 13 : OSC1/CLKIN/ANA7/IOCA7/RA7
  // Pin 14 : OSC2/CLKOUT/ANA6/IOCA6/RA6
  // Pin 15 : SOSCO/ANC0/IOCC0/RC0
  // Pin 16 : SOSCI/ANC1/IOCC1/RC1
  // Pin 17 : ANC2/IOCC2/RC2
  // Pin 18 : ANC3/SMB_I2C/IOCC3/RC3
  // Pin 19 : AND0/SMB_I2C/RD0
  // Pin 20 : AND1/SMB_I2C/RD1
  // Pin 21 : AND2/RD2
  // Pin 22 : AND3/RD3
  // Pin 23 : ANC4/SMB_I2C/IOCC4/RC4
  // Pin 24 : ANC5/IOCC5/RC5
  // Pin 25 : ANC6/IOCC6/RC6
  // Pin 26 : ANC7/IOCC7/RC7
  // Pin 27 : AND4/RD4
  // Pin 28 : AND5/RD5
  // Pin 29 : AND6/RD6
  // Pin 30 : AND7/RD7
  // Pin 31 : VSS
  // Pin 32 : AVDD/VDD
  // Pin 33 : ZCD/ANB0/C2IN1+/IOCB0/RB0
  // Pin 34 : ANB1/C1IN3-/C2IN3-/SMB_I2C/IOCB1/RB1
  // Pin 35 : ANB2/SMB_I2C/IOCB2/RB2
  // Pin 36 : ANB3/C1IN2-/C2IN2-/IOCB3/RB3
  // Pin 37 : ANB4/IOCB4/RB4
  // Pin 38 : ANB5/IOCB5/RB5
  // Pin 39 : ICDCLK/ANB6/IOCB6/RB6
  // Pin 40 : ICDDAT/DAC1OUT2/ANB7/IOCB7/RB7
  ...
  {$define _WRT_WRT_lower       = $3FFD}  // 0x0000 to x1FFF write protected
  {$define _WRT_ON              = $3FFC}  // 0x0000 to 0x3FFF write protected

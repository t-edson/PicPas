...
var
  ...
  NCO1ACCU_NCO1ACC23     : bit  absolute NCO1ACCU.7;
  NCO1ACCU_NCO1ACC22     : bit  absolute NCO1ACCU.6;
  NCO1ACCU_NCO1ACC21     : bit  absolute NCO1ACCU.5;
  NCO1ACCU_NCO1ACC20     : bit  absolute NCO1ACCU.4;
  ...
  NCO1INCU_NCO1INC23     : bit  absolute NCO1INCU.7;
  NCO1INCU_NCO1INC22     : bit  absolute NCO1INCU.6;
  NCO1INCU_NCO1INC21     : bit  absolute NCO1INCU.5;
  NCO1INCU_NCO1INC20     : bit  absolute NCO1INCU.4;
  ...
  NCO1CLK_N1CKS3         : bit  absolute NCO1CLK.4;
  ...
  PMD4_UART1MD           : bit  absolute PMD4.3;
  ...
  {$SET_STATE_RAM '219-21F:SFR'}  // SSP2BUF, SSP2ADD, SSP2MSK, SSP2STAT, SSP2CON1, SSP2CON2, SSP2CON3
  ...
  {$SET_STATE_RAM '391-39A:SFR'}  // IOCAP, IOCAN, IOCAF, IOCBP, IOCBN, IOCBF, IOCCP, IOCCN, IOCCF, CLKRCON
  ...
  {$SET_STATE_RAM 'E0F-E22:SFR'}  // PPSLOCK, INTPPS, T0CKIPPS, T1CKIPPS, T1GPPS, CCP1PPS, CCP2PPS, CCP3PPS, CCP4PPS, CWG1PPS, CWG2PPS, MDCIN1PPS, MDCIN2PPS, MDMINPPS, SSP2CLKPPS, SSP2DATPPS, SSP2SSPPS, SSP1CLKPPS, SSP1DATPPS, SSP1SSPPS
  ...
  {$SET_UNIMP_BITS '49F:EF'} // NCO1CLK bit 4 un-implemented (read as 0)
  ...
  // Pin 18 : ICSPCLK/ICDCLK/DAC1REF+/VREF+/ANA1/C2IN0-/IOCA1/RA1
  ...
  {$define _WRT_BOOT              = $3FFE}  // 0000h to 01FFh write-protected, 0200h to 3FFFh may be modified
  {$define _WRT_HALF              = $3FFD}  // 0000h to 1FFFh write-protected, 2000h to 3FFFh may be modified
  {$define _WRT_ALL               = $3FFC}  // 0000h to 3FFFh write protected, no addresses may be modified

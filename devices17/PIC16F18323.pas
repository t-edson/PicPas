...
var
  ...
  BORCON_SBOREN          : bit  absolute BORCON.6;
  ...
  CCP1CAP_CCP1CTS2       : bit  absolute CCP1CAP.3;
  CCP1CAP_CCP1CTS1       : bit  absolute CCP1CAP.2;
  CCP1CAP_CCP1CTS0       : bit  absolute CCP1CAP.1;
  ...
  CCP2CAP_CCP2CTS2       : bit  absolute CCP2CAP.3;
  CCP2CAP_CCP2CTS1       : bit  absolute CCP2CAP.2;
  CCP2CAP_CCP2CTS0       : bit  absolute CCP2CAP.1;
  ...
  CWG1AS1_AS3E           : bit  absolute CWG1AS1.4;
  CWG1AS1_AS2E           : bit  absolute CWG1AS1.3;
  CWG1AS1_AS1E           : bit  absolute CWG1AS1.2;
  CWG1AS1_AS0E           : bit  absolute CWG1AS1.1;
  ...
  PMD1_TMR2MD            : bit  absolute PMD1.6;
  PMD1_TMR1MD            : bit  absolute PMD1.5;
  PMD1_TMR0MD            : bit  absolute PMD1.4;
  ...
  PMD3_CCP2MD            : bit  absolute PMD3.3;
  PMD3_CCP1MD            : bit  absolute PMD3.2;
  ...
  CLCDATA_MLC2OUT        : bit  absolute CLCDATA.2;
  CLCDATA_MLC1OUT        : bit  absolute CLCDATA.1;
  ...
  {$SET_STATE_RAM 'E18-E18:SFR'}  // CWG1PPS
  {$SET_STATE_RAM 'E1A-E1C:SFR'}  // MDCIN1PPS, MDCIN2PPS, MDMINPPS
  {$SET_STATE_RAM 'E20-E22:SFR'}  // SSP1CLKPPS, SSP1DATPPS, SSP1SSPPS
  {$SET_STATE_RAM 'E24-E25:SFR'}  // RXPPS, TXPPS
  {$SET_STATE_RAM 'E28-E2B:SFR'}  // CLCIN0PPS, CLCIN1PPS, CLCIN2PPS, CLCIN3PPS
  ...
  {$SET_STATE_RAM 'F0F-F23:SFR'}  // CLCDATA, CLC1CON, CLC1POL, CLC1SEL0, CLC1SEL1, CLC1SEL2, CLC1SEL3, CLC1GLS0, CLC1GLS1, CLC1GLS2, CLC1GLS3, CLC2CON, CLC2POL, CLC2SEL0, CLC2SEL1, CLC2SEL2, CLC2SEL3, CLC2GLS0, CLC2GLS1, CLC2GLS2, CLC2GLS3
  ...
  {$SET_UNIMP_BITS '012:71'} // PIR2 bits 7,3,2,1 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '092:71'} // PIE2 bits 7,3,2,1 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '698:0F'} // CWG1AS1 bits 7,6,5,4 un-implemented (read as 0)
  ...
  // Pin 12 : ICSPCLK/ICDCLK/DAC1REF+/VREF+/ANA1/C1IN0-/C2IN0-/SMB_I2C/IOCA1/RA1

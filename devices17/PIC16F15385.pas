...
var
  ...
  PWM6CON_OE             : bit  absolute PWM6CON.6;
  ...
  RF4PPS_RF4PSS4         : bit  absolute RF4PPS.4;
  RF4PPS_RF4PSS3         : bit  absolute RF4PPS.3;
  RF4PPS_RF4PSS2         : bit  absolute RF4PPS.2;
  RF4PPS_RF4PSS1         : bit  absolute RF4PPS.1;
  RF4PPS_RF4PSS0         : bit  absolute RF4PPS.0;
  ...
  {$SET_STATE_RAM '09B-09F:SFR'}  // ADRESL, ADRESH, ADCON0, ADCON1, ADACT
  ...
  {$SET_STATE_RAM '28C-291:SFR'}  // T2TMR, T2PR, T2CON, T2HLT, T2CLKCON, T2RST
  ...
  {$SET_STATE_RAM '31C-31E:SFR'}  // PWM5DCL, PWM5DCH, PWM5CON
  ...
  {$SET_STATE_RAM '60C-614:SFR'}  // CWG1CLKCON, CWG1DAT, CWG1DBR, CWG1DBF, CWG1CON0, CWG1CON1, CWG1AS0, CWG1AS1, CWG1STR
  ...
  {$SET_STATE_RAM '70C-713:SFR'}  // PIR0, PIR1, PIR2, PIR3, PIR4, PIR5, PIR6, PIR7
  {$SET_STATE_RAM '716-71D:SFR'}  // PIE0, PIE1, PIE2, PIE3, PIE4, PIE5, PIE6, PIE7
  ...
  {$SET_STATE_RAM '895-896:SFR'}  // CLKRCON, CLKRCLK
  ...
  {$SET_STATE_RAM '1E9C-1E9C:SFR'}  // T2INPPS
  ...
  {$SET_UNIMP_BITS '016:0F'} // TRISE bits 7,6,5,4 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '1E38:1F'} // RF0PPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1E39:1F'} // RF1PPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1E3A:1F'} // RF2PPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1E3B:1F'} // RF3PPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1E3C:1F'} // RF4PPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1E3D:1F'} // RF5PPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1E3E:1F'} // RF6PPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1E3F:1F'} // RF7PPS bits 7,6,5 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '1F28:1F'} // RD0PPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F29:1F'} // RD1PPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F2A:1F'} // RD2PPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F2B:1F'} // RD3PPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F2C:1F'} // RD4PPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F2D:1F'} // RD5PPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F2E:1F'} // RD6PPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F2F:1F'} // RD7PPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F30:1F'} // RE0PPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F31:1F'} // RE1PPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F32:1F'} // RE2PPS bits 7,6,5 un-implemented (read as 0)
  ...
  // Pin  6 : VSS
  // Pin  7 : VDD
  // Pin  8 : ZCD1/ANB0/C2IN1+/IOCB0/RB0
  // Pin  9 : ANB1/C1IN3-/C2IN3-/SMB_I2C/IOCB1/RB1
  // Pin 10 : ANB2/SMB_I2C/IOCB2/RB2
  // Pin 11 : ANB3/C1IN2-/C2IN2-/IOCB3/RB3
  // Pin 12 : ANF4/RF4
  // Pin 13 : ANF5/RF5
  // Pin 14 : ANF6/RF6
  // Pin 15 : ANF7/RF7
  // Pin 16 : ANB4/IOCB4/RB4
  // Pin 17 : ANB5/IOCB5/RB5
  // Pin 18 : ICSPCLK/ICDCLK/ANB6/IOCB6/RB6
  // Pin 19 : ICSPDAT/ICDDAT/DAC1OUT2/ANB7/IOCB7/RB7
  // Pin 20 : VPP/MCLR_n/ICD_n/IOCE3/RE3
  // Pin 21 : ANA0/C1IN0-/C2IN0-/IOCA0/RA0
  // Pin 22 : ANA1/C1IN1-/C2IN1-/IOCA1/RA1
  // Pin 23 : DAC1OUT1/VREF-/ANA2/C1IN0+/C2IN0+/IOCA2/RA2
  // Pin 24 : DAC1REF+/VREF+/ANA3/C1IN1+/IOCA3/RA3
  // Pin 25 : ANA4/IOCA4/RA4
  // Pin 26 : ANA5/IOCA5/RA5
  // Pin 27 : ANE0/RE0
  // Pin 28 : ANE1/RE1
  // Pin 29 : ANE2/RE2
  // Pin 30 : VDD
  // Pin 31 : AVSS/VSS
  // Pin 32 : OSC1/CLKIN/ANA7/IOCA7/RA7
  // Pin 33 : OSC2/CLKOUT/ANA6/IOCA6/RA6
  // Pin 34 : SOSCO/ANC0/IOCC0/RC0
  // Pin 35 : SOSCI/ANC1/IOCC1/RC1
  // Pin 36 : ANF0/RF0
  // Pin 37 : ANF1/RF1
  // Pin 38 : ANF2/RF2
  // Pin 39 : ANF3/RF3
  // Pin 40 : ANC2/IOCC2/RC2
  // Pin 41 : ANC3/SMB_I2C/IOCC3/RC3
  // Pin 42 : AND0/SMB_I2C/RD0
  // Pin 43 : AND1/SMB_I2C/RD1
  // Pin 44 : AND2/RD2
  // Pin 45 : AND3/RD3
  // Pin 46 : ANC4/SMB_I2C/IOCC4/RC4
  // Pin 47 : ANC5/IOCC5/RC5
  // Pin 48 : ANC6/IOCC6/RC6


  // -- RAM to PIN mapping --

  {$MAP_RAM_TO_PIN '00C:0-21,1-22,2-23,3-24,4-25,5-26,6-33,7-32'} // PORTA
  {$MAP_RAM_TO_PIN '00D:0-8,1-9,2-10,3-11,4-16,5-17,6-18,7-19'} // PORTB
  {$MAP_RAM_TO_PIN '00E:0-34,1-35,2-40,3-41,4-46,5-47,6-48,7-1'} // PORTC
  {$MAP_RAM_TO_PIN '00F:0-42,1-43,2-44,3-45,4-2,5-3,6-4,7-5'} // PORTD
  {$MAP_RAM_TO_PIN '010:0-27,1-28,2-29,3-20'} // PORTE
  {$MAP_RAM_TO_PIN '011:0-36,1-37,2-38,3-39,4-12,5-13,6-14,7-15'} // PORTF

...
var
  ...
  PIR3_CWGIF             : bit  absolute PIR3.4;
  PIR3_ZCDIF             : bit  absolute PIR3.3;
  ...
  PIR5_AT1IF             : bit  absolute PIR5.3;
  PIR5_PID1EIF           : bit  absolute PIR5.2;
  PIR5_PID1DIF           : bit  absolute PIR5.1;
  ...
  PIE3_CWGIE             : bit  absolute PIE3.4;
  PIE3_ZCDIE             : bit  absolute PIE3.3;
  ...
  PIE5_AT1IE             : bit  absolute PIE5.3;
  PIE5_PID1EIE           : bit  absolute PIE5.2;
  PIE5_PID1DIE           : bit  absolute PIE5.1;
  ...
  PID1ACCU_PID1ACC34     : bit  absolute PID1ACCU.3;
  PID1ACCU_PID1ACC33     : bit  absolute PID1ACCU.2;
  PID1ACCU_PID1ACC32     : bit  absolute PID1ACCU.1;
  ...
  CWG1ISM_IS3            : bit  absolute CWG1ISM.4;
  ...
  SCANTRIG_TSEL3         : bit  absolute SCANTRIG.4;
  SCANTRIG_TSEL2         : bit  absolute SCANTRIG.3;
  ...
  AT1CON0_APMOD          : bit  absolute AT1CON0.2;
  AT1CON0_MODE           : bit  absolute AT1CON0.1;
  AT1CON1                : byte absolute $0815;
  AT1CON1_PHP            : bit  absolute AT1CON1.5;
  AT1CON1_PRP            : bit  absolute AT1CON1.4;
  AT1CON1_MPP            : bit  absolute AT1CON1.3;
  AT1CON1_ACCS           : bit  absolute AT1CON1.2;
  AT1CON1_VALID          : bit  absolute AT1CON1.1;
  ...
  AT1SIG_AT1SSEL2        : bit  absolute AT1SIG.2;
  AT1SIG_AT1SSEL1        : bit  absolute AT1SIG.1;
  AT1SIG_AT1SSEL0        : bit  absolute AT1SIG.0;
  AT1CSEL1               : byte absolute $088E;
  AT1CSEL1_AT1CP1S2      : bit  absolute AT1CSEL1.2;
  AT1CSEL1_AT1CP1S1      : bit  absolute AT1CSEL1.1;
  AT1CSEL1_AT1CP1S0      : bit  absolute AT1CSEL1.0;
  ...
  AT1CCON1_AT1CC1EN      : bit  absolute AT1CCON1.5;
  AT1CCON1_AT1CC1POL     : bit  absolute AT1CCON1.4;
  AT1CCON1_AT1CAP1P      : bit  absolute AT1CCON1.3;
  AT1CCON1_AT1CC1MODE    : bit  absolute AT1CCON1.2;
  ...
  AT1CCON2_AT1CC2EN      : bit  absolute AT1CCON2.5;
  AT1CCON2_AT1CC2POL     : bit  absolute AT1CCON2.4;
  AT1CCON2_AT1CAP2P      : bit  absolute AT1CCON2.3;
  AT1CCON2_AT1CC2MODE    : bit  absolute AT1CCON2.2;
  ...
  AT1CCON3_AT1CC3EN      : bit  absolute AT1CCON3.5;
  AT1CCON3_AT1CC3POL     : bit  absolute AT1CCON3.4;
  AT1CCON3_AT1CAP3P      : bit  absolute AT1CCON3.3;
  AT1CCON3_AT1CC3MODE    : bit  absolute AT1CCON3.2;
  ...
  SMT1SIG_SSEL4          : bit  absolute SMT1SIG.5;
  SMT1SIG_SSEL3          : bit  absolute SMT1SIG.4;
  ...
  SMT1WIN_WSEL4          : bit  absolute SMT1WIN.5;
  ...
  {$SET_STATE_RAM '010-01F:SFR'}  // PIR1, PIR2, PIR3, PIR4, PIR5, TMR0, TMR1L, TMR1H, T1CON, T1GCON, T2TMR, T2PR, T2CON, T2HLT, T2CLKCON, T2RST
  ...
  {$SET_STATE_RAM '090-096:SFR'}  // PIE1, PIE2, PIE3, PIE4, PIE5, OPTION_REG, PCON
  ...
  {$SET_STATE_RAM '58C-59D:SFR'}  // PID1SETL, PID1SETH, PID1INL, PID1INH, PID1K1L, PID1K1H, PID1K2L, PID1K2H, PID1K3L, PID1K3H, PID1OUTLL, PID1OUTLH, PID1OUTHL, PID1OUTHH, PID1OUTU, PID1Z1L, PID1Z1H, PID1Z1U
  {$SET_STATE_RAM '5F0-5FF:GPR'} 
  {$SET_STATE_RAM '600-600:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '60C-614:SFR'}  // PID1Z2L, PID1Z2H, PID1Z2U, PID1ACCLL, PID1ACCLH, PID1ACCHL, PID1ACCHH, PID1ACCU, PID1CON
  ...
  {$SET_STATE_RAM '691-697:SFR'}  // CWG1DBR, CWG1DBF, CWG1AS0, CWG1AS1, CWG1OCON0, CWG1CON0, CWG1CON1
  {$SET_STATE_RAM '699-69A:SFR'}  // CWG1CLKCON, CWG1ISM
  ...
  {$SET_STATE_RAM '80C-81D:SFR'}  // AT1RESL, AT1RESH, AT1MISSL, AT1MISSH, AT1PERL, AT1PERH, AT1PHSL, AT1PHSH, AT1CON0, AT1CON1, AT1IR0, AT1IE0, AT1IR1, AT1IE1, AT1STPTL, AT1STPTH, AT1ERRL, AT1ERRH
  {$SET_STATE_RAM '870-87F:GPR'} 
  {$SET_STATE_RAM '880-880:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '88C-899:SFR'}  // AT1CLK, AT1SIG, AT1CSEL1, AT1CC1L, AT1CC1H, AT1CCON1, AT1CSEL2, AT1CC2L, AT1CC2H, AT1CCON2, AT1CSEL3, AT1CC3L, AT1CC3H, AT1CCON3
  ...
  {$SET_STATE_RAM 'E0F-E2E:SFR'}  // PPSLOCK, INTPPS, T0CKIPPS, T1CKIPPS, T1GPPS, CCP1PPS, CCP2PPS, ATINPPS, CWGINPPS, T2PPS, T3CKIPPS, T3GPPS, T4PPS, T5CKIPPS, T5GPPS, T6PPS, ATCC1PPS, SSPCLKPPS, SSPDATPPS, SSPSSPPS, ATCC2PPS, RXPPS, CKPPS, SMT1SIGPPS, SMT1WINPPS, CLCIN0PPS, CLCIN1PPS, CLCIN2PPS, CLCIN3PPS, SMT2SIGPPS, SMT2WINPPS, ATCC3PPS
  ...
  {$SET_UNIMP_BITS '011:6F'} // PIR2 bits 7,4 un-implemented (read as 0)
  {$SET_UNIMP_BITS '012:33'} // PIR3 bits 7,6,3,2 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '091:6F'} // PIE2 bits 7,4 un-implemented (read as 0)
  {$SET_UNIMP_BITS '092:33'} // PIE3 bits 7,6,3,2 un-implemented (read as 0)
  ...
  // Pin 15 : RC1/AN5/C1IN1-/C2IN1-
  // Pin 16 : RC0/AN4/C2IN+
  // Pin 17 : RA2/AN2/ZCDIN
  // Pin 18 : RA1/AN1/C2IN0-/C1IN0-/VREF+/ICSPCLK
  // Pin 19 : RA0/AN0/C1IN+/DACOUT/ICSPDAT
  // Pin 20 : VSS

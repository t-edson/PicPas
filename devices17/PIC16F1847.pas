...
var
  ...
  APFCON0_SDO1SEL     : bit  absolute APFCON0.6;
  APFCON0_SS1SEL      : bit  absolute APFCON0.5;
  APFCON0_P2BSEL      : bit  absolute APFCON0.4;
  APFCON0_CCP2SEL     : bit  absolute APFCON0.3;
  APFCON0_P1DSEL      : bit  absolute APFCON0.2;
  APFCON0_P1CSEL      : bit  absolute APFCON0.1;
  APFCON0_CCP1SEL     : bit  absolute APFCON0.0;
  ...
  CCP3CON_DC3B1       : bit  absolute CCP3CON.6;
  CCP3CON_DC3B0       : bit  absolute CCP3CON.5;
  CCP3CON_CCP3M3      : bit  absolute CCP3CON.4;
  CCP3CON_CCP3M2      : bit  absolute CCP3CON.3;
  CCP3CON_CCP3M1      : bit  absolute CCP3CON.2;
  CCP3CON_CCP3M0      : bit  absolute CCP3CON.1;
  ...
  {$SET_STATE_RAM '011-01C:SFR'}  // PIR1, PIR2, PIR3, PIR4, TMR0, TMR1L, TMR1H, T1CON, T1GCON, TMR2, PR2, T2CON
  ...
  {$SET_STATE_RAM '091-09E:SFR'}  // PIE1, PIE2, PIE3, PIE4, OPTION_REG, PCON, WDTCON, OSCTUNE, OSCCON, OSCSTAT, ADRESL, ADRESH, ADCON0, ADCON1
  ...
  {$SET_STATE_RAM '298-29E:SFR'}  // CCPR2L, CCPR2H, CCP2CON, PWM2CON, CCP2AS, PSTR2CON, CCPTMRS
  ...
  {$SET_UNIMP_BITS '014:03'} // PIR4 bits 7,6,5,4,3,2 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '094:03'} // PIE4 bits 7,6,5,4,3,2 un-implemented (read as 0)
  ...
  // Pin  1 : RA2/AN2/C12IN2-/C12IN+/Vref-/DACOUT
  // Pin  2 : RA3/AN3/C12IN3-/C1IN+/Vref+/C1OUT/CCP3/SRQ
  // Pin  3 : RA4/AN4/C2OUT/T0CKI/CCP4/SRNQ
  // Pin  4 : RA5/MCLR/Vpp/SS1
  // Pin  5 : Vss
  // Pin  6 : RB0/T1G/CCP1/P1A/INT/SRI/FLT0
  // Pin  7 : RB1/AN11/RX/DT/SDA1/SDI1
  // Pin  8 : RB2/AN10/MDMIN/TX/CK/RX/DT/SDA2/SDI2/SDO1
  // Pin  9 : RB3/AN9/MDOUT/CCP1/P1A
  // Pin 10 : RB4/AN8/SCL1/SCK1/MDCIN2
  // Pin 11 : RB5/AN7/P1B/TX/CK/SCL2/SCK2/SS1
  // Pin 12 : RB6/AN5/T1CKI/T1OSI/P1C/CCP2/P2A/ICSPCLK/ICDCLK
  // Pin 13 : RB7/AN6/T1OSO/P1D/P2B/MDCIN1/ICSPDAT/ICDDAT
  // Pin 14 : Vdd
  // Pin 15 : RA6/OSC2/CLKOUT/CLKR/P1D/P2B/SDO1
  // Pin 16 : RA7/OSC1/CLKIN/P1C/CCP2/P2A
  // Pin 17 : RA0/AN0/C12IN0-/SDO2
  // Pin 18 : RA1/AN1/C12IN1-/SS2

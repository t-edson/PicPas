...
var
  ...
  PIR2_OSFIF          : bit  absolute PIR2.3;
  PIR2_BCLIF          : bit  absolute PIR2.2;
  ...
  PIE2_OSFIE          : bit  absolute PIE2.3;
  PIE2_BCLIE          : bit  absolute PIE2.2;
  ...
  {$SET_STATE_RAM '000-012:SFR'}  // INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON, PORTA, PORTB, PORTC, PORTD, PORTE, PIR1, PIR2
  ...
  {$SET_STATE_RAM '08C-092:SFR'}  // TRISA, TRISB, TRISC, TRISD, TRISE, PIE1, PIE2

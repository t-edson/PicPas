...
var
  ...
  {$SET_STATE_RAM '000-010:SFR'}  // INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON, PORTA, PORTB, PORTC, PORTD, PORTE
  {$SET_STATE_RAM '012-016:SFR'}  // TRISA, TRISB, TRISC, TRISD, TRISE
  {$SET_STATE_RAM '018-01C:SFR'}  // LATA, LATB, LATC, LATD, LATE
  ...
  {$SET_STATE_RAM '1D0C-1D1C:SFR'}  // LCDCON, LCDPS, LCDSE0, LCDSE1, LCDSE2, LCDSE3, LCDSE4, LCDSE5, LCDVCON1, LCDVCON2, LCDREF, LCDRL, LCDDATA0, LCDDATA1, LCDDATA2, LCDDATA3, LCDDATA4
  {$SET_STATE_RAM '1D1E-1D22:SFR'}  // LCDDATA6, LCDDATA7, LCDDATA8, LCDDATA9, LCDDATA10
  {$SET_STATE_RAM '1D24-1D28:SFR'}  // LCDDATA12, LCDDATA13, LCDDATA14, LCDDATA15, LCDDATA16
  {$SET_STATE_RAM '1D2A-1D2E:SFR'}  // LCDDATA18, LCDDATA19, LCDDATA20, LCDDATA21, LCDDATA22
  {$SET_STATE_RAM '1D30-1D34:SFR'}  // LCDDATA24, LCDDATA25, LCDDATA26, LCDDATA27, LCDDATA28
  {$SET_STATE_RAM '1D36-1D3A:SFR'}  // LCDDATA30, LCDDATA31, LCDDATA32, LCDDATA33, LCDDATA34
  {$SET_STATE_RAM '1D3C-1D40:SFR'}  // LCDDATA36, LCDDATA37, LCDDATA38, LCDDATA39, LCDDATA40
  {$SET_STATE_RAM '1D42-1D46:SFR'}  // LCDDATA42, LCDDATA43, LCDDATA44, LCDDATA45, LCDDATA46

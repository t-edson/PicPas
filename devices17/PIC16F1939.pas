...
var
  ...
  ANSELB_ANSB5        : bit  absolute ANSELB.7;
  ANSELB_ANSB4        : bit  absolute ANSELB.6;
  ANSELB_ANSB3        : bit  absolute ANSELB.5;
  ANSELB_ANSB2        : bit  absolute ANSELB.4;
  ANSELB_ANSB1        : bit  absolute ANSELB.3;
  ANSELB_ANSB0        : bit  absolute ANSELB.2;
  ...
  {$SET_STATE_RAM '000-013:SFR'}  // INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON, PORTA, PORTB, PORTC, PORTD, PORTE, PIR1, PIR2, PIR3
  ...
  {$SET_STATE_RAM '08C-093:SFR'}  // TRISA, TRISB, TRISC, TRISD, TRISE, PIE1, PIE2, PIE3
  ...
  {$SET_STATE_RAM '18F-196:SFR'}  // ANSELD, ANSELE, EEADRL, EEADRH, EEDATL, EEDATH, EECON1, EECON2
  ...
  {$SET_STATE_RAM '798-79A:SFR'}  // LCDSE0, LCDSE1, LCDSE2
  {$SET_STATE_RAM '7A0-7AB:SFR'}  // LCDDATA0, LCDDATA1, LCDDATA2, LCDDATA3, LCDDATA4, LCDDATA5, LCDDATA6, LCDDATA7, LCDDATA8, LCDDATA9, LCDDATA10, LCDDATA11
  ...
  {$SET_UNIMP_BITS '110:0F'} // LATE bits 7,6,5,4 un-implemented (read as 0)
  ...
  // Pin  5 : RA3/AN3/C1IN+/Vref+/SEG15
  // Pin  6 : RA4/C1OUT/CPS6/T0CKI/SRQ/SEG4
  // Pin  7 : RA5/AN4/C2OUT/CPS7/SRNQ/SS/Vcap/SEG5
  // Pin  8 : RE0/AN5/P3A/CCP3/SEG21
  // Pin  9 : RE1/AN6/P3B/SEG22
  // Pin 10 : RE2/AN7/CCP5/SEG23
  // Pin 11 : Vdd
  // Pin 12 : Vss
  // Pin 13 : RA7/OSC1/CLKIN/SEG2
  // Pin 14 : RA6/OSC2/CLKOUT/Vcap/SEG1
  // Pin 15 : RC0/T1OSO/T1CKI/P2B
  // Pin 16 : RC1/T1OSI/CCP2/P2A
  // Pin 17 : RC2/CCP1/P1A/SEG3
  // Pin 18 : RC3/SCL/SCK/SEG6
  // Pin 19 : RD0/CPS8/COM3
  // Pin 20 : RD1/CPS9/CCP4
  // Pin 21 : RD2/CPS10/P2B
  // Pin 22 : RD3/CPS11/P2C/SEG16
  // Pin 23 : RC4/SDI/SDA/T1G/SEG11
  // Pin 24 : RC5/SDO/SEG10
  // Pin 25 : RC6/TX/CK/SEG9
  // Pin 26 : RC7/RX/DT/SEG8
  // Pin 27 : RD4/CPS12/P2D/SEG17
  // Pin 28 : RD5/CPS13/P1B/SEG18
  // Pin 29 : RD6/CPS14/P1C/SEG19
  // Pin 30 : RD7/CPS15/P1D/SEG20
  // Pin 31 : Vss
  // Pin 32 : Vdd
  // Pin 33 : RB0/AN12/CPS0/SRI/INT/SEG0
  // Pin 34 : RB1/AN10/C12IN3-/CPS1/VLCD1
  // Pin 35 : RB2/AN8/CPS2/VLCD2
  // Pin 36 : RB3/AN9/C12IN2-/CPS3/CCP2/P2A/VLCD3
  // Pin 37 : RB4/AN11/CPS4/COM0
  // Pin 38 : RB5/AN13/CPS5/CCP3/P3A/T1G/COM1
  // Pin 39 : RB6/ICSPCLK/ICDCLK/SEG14

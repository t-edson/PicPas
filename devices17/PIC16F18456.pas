...
var
  ...
  CCP3CON_OE             : bit  absolute CCP3CON.6;
  ...
  CWG3AS0_LSBD1          : bit  absolute CWG3AS0.5;
  CWG3AS0_LSBD0          : bit  absolute CWG3AS0.4;
  ...
  PIE0_INTIE             : bit  absolute PIE0.0;
  ...
  PMD4_CCP5MD            : bit  absolute PMD4.4;
  ...
  VREGCON_PM             : bit  absolute VREGCON.1;
  ...
  INLVLB_INLVB7          : bit  absolute INLVLB.7;
  INLVLB_INLVB6          : bit  absolute INLVLB.6;
  ...
  INLVLC_INLVC7          : bit  absolute INLVLC.7;
  INLVLC_INLVC6          : bit  absolute INLVLC.6;
  ...
  {$SET_STATE_RAM '010-010:SFR'}  // PORTE
  {$SET_STATE_RAM '012-014:SFR'}  // TRISA, TRISB, TRISC
  {$SET_STATE_RAM '016-016:SFR'}  // TRISE
  {$SET_STATE_RAM '018-01A:SFR'}  // LATA, LATB, LATC
  {$SET_STATE_RAM '01C-01C:SFR'}  // LATE
  ...
  {$SET_STATE_RAM '68C-694:SFR'}  // CWG3CLKCON, CWG3DAT, CWG3DBR, CWG3DBF, CWG3CON0, CWG3CON1, CWG3AS0, CWG3AS1, CWG3STR
  ...
  {$SET_STATE_RAM '1EC5-1ECE:SFR'}  // SSP1CLKPPS, SSP1DATPPS, SSP1SSPPS, SSP2CLKPPS, SSP2DATPPS, SSP2SSPPS, RX1DTPPS, TX1CKPPS, RX2DTPPS, TX2CKPPS
  ...
  {$SET_STATE_RAM '1F65-1F6B:SFR'}  // WPUE, ODCONE, SLRCONE, INLVLE, IOCEP, IOCEN, IOCEF
  ...
  {$SET_UNIMP_BITS '01C:08'} // LATE bits 7,6,5,4,2,1,0 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '68D:0F'} // CWG3DAT bits 7,6,5,4 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '693:1F'} // CWG3AS1 bits 7,6,5 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '713:37'} // PIR7 bits 7,6,3 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '71D:37'} // PIE7 bits 7,6,3 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '79A:7F'} // PMD4 bit 7 un-implemented (read as 0)
  {$SET_UNIMP_BITS '79B:E0'} // PMD5 bits 4,3,2,1,0 un-implemented (read as 0)
  {$SET_UNIMP_BITS '79C:33'} // PMD6 bits 7,6,3,2 un-implemented (read as 0)
  {$SET_UNIMP_BITS '79D:7F'} // PMD7 bit 7 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '1E90:1F'} // INTPPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1E91:1F'} // T0CKIPPS bits 7,6,5 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '1ECB:1F'} // RX1DTPPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1ECC:1F'} // TX1CKPPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1ECD:1F'} // RX2DTPPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1ECE:1F'} // TX2CKPPS bits 7,6,5 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '1F66:00'} // ODCONE bits 7,6,5,4,3,2,1,0 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F67:00'} // SLRCONE bits 7,6,5,4,3,2,1,0 un-implemented (read as 0)
  ...
  // Pin  1 : RA0/ANA0/C1IN0-/C2IN0-/CLCIN0/IOCA0
  // Pin  2 : RA1/ANA1/C1N1-/C1N1+/CLCIN1/IOCA1
  // Pin  3 : RA2/ANA2/ADCVREF-/C1IN0+/C2IN0+/DAC1VREF-/DAC1OUT1/IOCA2
  // Pin  4 : RA3/ANA3/ADCVREF+/C1IN1+/DAC1VREF+/MDCARL/IOCA3
  // Pin  5 : RA4/ANA4/MDCARH/T0CKL/CCP5IN/IOCA4
  // Pin  6 : RA5/ANA5/MDSRC/SS1_n/IOCA5
  // Pin  7 : RA6/ANA6/OSC2/CLKOUT/IOCA6
  // Pin  8 : RA7/ANA7/OSC1/CLKIN/IOCA7
  // Pin  9 : RB0/ANB0/C2IN1+/CCP4IN/CWG1IN/ZCD1/INT0/IOCB0
  // Pin 10 : RB1/ANB1/C1IN3-/C2IN3-/CWG2IN/SLK2/SCL2/IOCB1
  // Pin 11 : RB2/ANB2/CWG3IN/SDI2/SDA2/SS2_n/IOCB2
  // Pin 12 : RB3/ANB3/C1IN2-/CSIN2-/IOCB3
  // Pin 13 : RB4/ANB4/ADACT/T5G/SMT2WIN/IOCB4
  // Pin 14 : RB5/ANB5/T1G/SMT2SIG/CCP3IN/IOCB5
  // Pin 15 : RB6/ANB6/CK2/CLCIN2/ICSPCLK/ICDCLK/IOCB6
  // Pin 16 : RB7/ANB7/DAC1OUT2/T6IN/RX2/DT2/ICSPDAT/ICDDAT/IOCB7
  // Pin 17 : RC0/ANC0/T1CKI/T3CK/T3G/SMT1WIN/SOSCO/IOCC0
  // Pin 18 : RC1/ANC1/SMT1SIG/CCP2IN/SOSCI/IOCC1
  // Pin 19 : RC2/ANC2/T5CKI/CCP1IN/IOCC2
  // Pin 20 : RC3/ANC3/T2IN/SCK1/SCL1/IOCC3
  // Pin 21 : RC4/ANC4/SDI1/SDA1/IOCC4
  // Pin 22 : RC5/ANC5/T4IN/IOCC5
  // Pin 23 : RC6/ANC6/CK1/IOCC6
  // Pin 24 : RC7/ANC7/RX1/DT1/IOCC7
  // Pin 25 : RE3/MCLR_n/VPP/IOCE3
  // Pin 26 : VDD
  // Pin 27 : VSS
  // Pin 28 : VSS
  ...
  {$define _ZCDDIS_OFF       = $3FFF}  // Zero-cross detect circuit is disabled at POR.
  {$define _ZCDDIS_ON        = $3BFF}  // Zero-cross detect circuit is always enabled

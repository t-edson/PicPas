...
var
  ...
  APFCON_RXDTSEL      : bit  absolute APFCON.6;
  ...
  // Pin  1 : VDD
  // Pin  2 : RA5/CLKIN/OSC1/T1OSI/T1CKI
  // Pin  3 : SDO/RA4/AN3/CPS3/OSC2/CLKOUT/T1OSO/CLKR/T1G
  // Pin  4 : RA3/SS/T1G/VPP/MCLR
  // Pin  5 : RC5/P1A/CCP1/DT/RX/MDCIN2
  // Pin  6 : RC4/C2OUT/SRNQ/P1B/CK/TX/MDOUT
  // Pin  7 : RC3/AN7/CPS7/C12IN3-/P1C/SS/MDMIN
  // Pin  8 : RC2/AN6/CPS6/C12IN2-/P1D/SDO/MDCIN1
  // Pin  9 : RC1/AN5/CPS5/C12IN1-/SDA/SDI
  // Pin 10 : RC0/AN4/CPS4/C2IN+/SCL/SCK
  // Pin 11 : RA2/AN2/CPS2/T0CKI/INT/C1OUT/SRQ/FLT0
  // Pin 12 : RA1/AN1/CPS1/C12IN0-/VREF/SRI/RX/DT/ICSPCLK
  // Pin 13 : RA0/AN0/CPS0/C1IN+/DACOUT/TX/CK/ICSPDAT/ICDDAT
  // Pin 14 : VSS

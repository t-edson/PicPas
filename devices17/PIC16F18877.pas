...
var
  ...
  {$SET_STATE_RAM '1E9C-1E9E:SFR'}  // T2AINPPS, T4AINPPS, T6AINPPS
  {$SET_STATE_RAM '1EA1-1EA5:SFR'}  // CCP1PPS, CCP2PPS, CCP3PPS, CCP4PPS, CCP5PPS
  {$SET_STATE_RAM '1EA9-1EAC:SFR'}  // SMT1WINPPS, SMT1SIGPPS, SMT2WINPPS, SMT2SIGPPS
  {$SET_STATE_RAM '1EB1-1EB3:SFR'}  // CWG1PPS, CWG2PPS, CWG3PPS
  {$SET_STATE_RAM '1EB8-1EBE:SFR'}  // MDCARLPPS, MDCARHPPS, MDSRCPPS, CLCIN0PPS, CLCIN1PPS, CLCIN2PPS, CLCIN3PPS
  {$SET_STATE_RAM '1EC3-1EC3:SFR'}  // ADCACTPPS
  {$SET_STATE_RAM '1EC5-1ECC:SFR'}  // SSP1CLKPPS, SSP1DATPPS, SSP1SSPPS, SSP2CLKPPS, SSP2DATPPS, SSP2SSPPS, RXPPS, TXPPS
  {$SET_STATE_RAM '1EF0-1EFF:GPR'} 
  {$SET_STATE_RAM '1F00-1F00:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '1F10-1F32:SFR'}  // RA0PPS, RA1PPS, RA2PPS, RA3PPS, RA4PPS, RA5PPS, RA6PPS, RA7PPS, RB0PPS, RB1PPS, RB2PPS, RB3PPS, RB4PPS, RB5PPS, RB6PPS, RB7PPS, RC0PPS, RC1PPS, RC2PPS, RC3PPS, RC4PPS, RC5PPS, RC6PPS, RC7PPS, RD0PPS, RD1PPS, RD2PPS, RD3PPS, RD4PPS, RD5PPS, RD6PPS, RD7PPS, RE0PPS, RE1PPS, RE2PPS
  {$SET_STATE_RAM '1F38-1F41:SFR'}  // ANSELA, WPUA, ODCONA, SLRCONA, INLVLA, IOCAP, IOCAN, IOCAF, CCDNA, CCDPA
  {$SET_STATE_RAM '1F43-1F4C:SFR'}  // ANSELB, WPUB, ODCONB, SLRCONB, INLVLB, IOCBP, IOCBN, IOCBF, CCDNB, CCDPB
  {$SET_STATE_RAM '1F4E-1F57:SFR'}  // ANSELC, WPUC, ODCONC, SLRCONC, INLVLC, IOCCP, IOCCN, IOCCF, CCDNC, CCDPC
  {$SET_STATE_RAM '1F59-1F5D:SFR'}  // ANSELD, WPUD, ODCOND, SLRCOND, INLVLD
  {$SET_STATE_RAM '1F61-1F62:SFR'}  // CCDND, CCDPD
  {$SET_STATE_RAM '1F64-1F6D:SFR'}  // ANSELE, WPUE, ODCONE, SLRCONE, INLVLE, IOCEP, IOCEN, IOCEF, CCDNE, CCDPE
  ...
  {$SET_UNIMP_BITS '093:D5'} // ADCON0 bits 5,3,1 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '1E9C:1F'} // T2AINPPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1E9D:1F'} // T4AINPPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1E9E:1F'} // T6AINPPS bits 7,6,5 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '1EA5:3F'} // CCP5PPS bits 7,6 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '1EAB:1F'} // SMT2WINPPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1EAC:1F'} // SMT2SIGPPS bits 7,6,5 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '1EB3:1F'} // CWG3PPS bits 7,6,5 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '1ECB:1F'} // RXPPS bits 7,6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1ECC:1F'} // TXPPS bits 7,6,5 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '1F32:3F'} // RE2PPS bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F64:07'} // ANSELE bits 7,6,5,4,3 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F65:0F'} // WPUE bits 7,6,5,4 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F66:07'} // ODCONE bits 7,6,5,4,3 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F67:07'} // SLRCONE bits 7,6,5,4,3 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F68:0F'} // INLVLE bits 7,6,5,4 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '1F6C:07'} // CCDNE bits 7,6,5,4,3 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F6D:07'} // CCDPE bits 7,6,5,4,3 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1FE4:07'} // STATUS_SHAD bits 7,6,5,4,3 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1FE6:3F'} // BSR_SHAD bits 7,6 un-implemented (read as 0)
  ...
  // Pin 39 : ICSPCLK/ICDCLK/ANB6/IOCB6/RB6
  // Pin 40 : ICSPDAT/ICDDAT/DAC1OUT2/ANB7/IOCB7/RB7
  ...
  {$define _WRT_WRT_lower       = $3FFD}  // 0x0000 to x3FFF write protected
  {$define _WRT_ON              = $3FFC}  // 0x0000 to 0x7FFF write protected

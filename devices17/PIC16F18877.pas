...
var
  ...
  ODCONE_ODCE2             : bit  absolute ODCONE.2;
  ...
  CCDNE_CCDNE2             : bit  absolute CCDNE.2;
  CCDNE_CCDNE1             : bit  absolute CCDNE.1;
  CCDNE_CCDNE0             : bit  absolute CCDNE.0;
  CCDPE                    : byte absolute $1F6D;
  CCDPE_CCDPE2             : bit  absolute CCDPE.2;
  CCDPE_CCDPE1             : bit  absolute CCDPE.1;
  CCDPE_CCDPE0             : bit  absolute CCDPE.0;
  ...
  BSR_SHAD_BSR_SHAD5       : bit  absolute BSR_SHAD.5;
  ...
  {$SET_STATE_RAM '1000-100B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '1020-106F:GPR'} 
  {$SET_STATE_RAM '1070-107F:GPR'} 
  {$SET_STATE_RAM '1080-108B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '10A0-10EF:GPR'} 
  {$SET_STATE_RAM '10F0-10FF:GPR'} 
  {$SET_STATE_RAM '1100-110B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '1120-116F:GPR'} 
  {$SET_STATE_RAM '1170-117F:GPR'} 
  {$SET_STATE_RAM '1180-118B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '11A0-11EF:GPR'} 
  {$SET_STATE_RAM '11F0-11FF:GPR'} 
  {$SET_STATE_RAM '1200-120B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '1220-126F:GPR'} 
  {$SET_STATE_RAM '1270-127F:GPR'} 
  {$SET_STATE_RAM '1280-128B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '12A0-12EF:GPR'} 
  {$SET_STATE_RAM '12F0-12FF:GPR'} 
  {$SET_STATE_RAM '1300-130B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '1320-136F:GPR'} 
  {$SET_STATE_RAM '1370-137F:GPR'} 
  {$SET_STATE_RAM '1380-138B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '13A0-13EF:GPR'} 
  {$SET_STATE_RAM '13F0-13FF:GPR'} 
  {$SET_STATE_RAM '1400-140B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '1420-146F:GPR'} 
  {$SET_STATE_RAM '1470-147F:GPR'} 
  {$SET_STATE_RAM '1480-148B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '14A0-14EF:GPR'} 
  {$SET_STATE_RAM '14F0-14FF:GPR'} 
  {$SET_STATE_RAM '1500-150B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '1520-156F:GPR'} 
  {$SET_STATE_RAM '1570-157F:GPR'} 
  {$SET_STATE_RAM '1580-158B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '15A0-15EF:GPR'} 
  {$SET_STATE_RAM '15F0-15FF:GPR'} 
  {$SET_STATE_RAM '1600-160B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '1620-166F:GPR'} 
  {$SET_STATE_RAM '1670-167F:GPR'} 
  {$SET_STATE_RAM '1680-168B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '16A0-16EF:GPR'} 
  {$SET_STATE_RAM '16F0-16FF:GPR'} 
  {$SET_STATE_RAM '1700-170B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '1720-176F:GPR'} 
  {$SET_STATE_RAM '1770-177F:GPR'} 
  {$SET_STATE_RAM '1780-178B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '17A0-17EF:GPR'} 
  {$SET_STATE_RAM '17F0-17FF:GPR'} 
  {$SET_STATE_RAM '1800-180B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '1820-186F:GPR'} 
  {$SET_STATE_RAM '1870-187F:GPR'} 
  {$SET_STATE_RAM '1880-188B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '18A0-18EF:GPR'} 
  {$SET_STATE_RAM '18F0-18FF:GPR'} 
  {$SET_STATE_RAM '1900-190B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '1920-196F:GPR'} 
  {$SET_STATE_RAM '1970-197F:GPR'} 
  {$SET_STATE_RAM '1980-198B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '19F0-19FF:GPR'} 
  {$SET_STATE_RAM '1A00-1A0B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '1A70-1A7F:GPR'} 
  {$SET_STATE_RAM '1A80-1A8B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '1AF0-1AFF:GPR'} 
  {$SET_STATE_RAM '1B00-1B0B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '1B70-1B7F:GPR'} 
  {$SET_STATE_RAM '1B80-1B8B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '1BF0-1BFF:GPR'} 
  {$SET_STATE_RAM '1C00-1C0B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '1C70-1C7F:GPR'} 
  {$SET_STATE_RAM '1C80-1C8B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '1CF0-1CFF:GPR'} 
  {$SET_STATE_RAM '1D00-1D0B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '1D70-1D7F:GPR'} 
  {$SET_STATE_RAM '1D80-1D8B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  {$SET_STATE_RAM '1DF0-1DFF:GPR'} 
  {$SET_STATE_RAM '1E00-1E0B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  ...
  {$SET_STATE_RAM '1E80-1E8B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  ...
  {$SET_STATE_RAM '1F00-1F0B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON
  ...
  {$SET_STATE_RAM '1F80-1F8B:SFR'}  // mapped to INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON

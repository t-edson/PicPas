...
var
  ...
  DAC2CON0_EN         : bit  absolute DAC2CON0.6;
  ...
  DAC2CON0_NSS        : bit  absolute DAC2CON0.1;
  DAC2REF             : byte absolute $011B;
  DAC2REF_DAC2R4      : bit  absolute DAC2REF.5;
  ...
  ANSELC_ANSC4        : bit  absolute ANSELC.3;
  ANSELC_ANSC3        : bit  absolute ANSELC.2;
  ANSELC_ANSC2        : bit  absolute ANSELC.1;
  ...
  {$SET_STATE_RAM '10C-11C:SFR'}  // LATA, LATB, LATC, LATD, LATE, CM1CON0, CM1CON1, CM2CON0, CM2CON1, CMOUT, BORCON, FVRCON, DAC1CON0, DAC1CON1, DAC2CON0, DAC2REF, ZCD1CON
  ...
  {$SET_STATE_RAM '30C-310:SFR'}  // SLRCONA, SLRCONB, SLRCONC, SLRCOND, SLRCONE

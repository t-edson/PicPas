...
var
  ...
  PIR6_PWM12IF         : bit  absolute PIR6.5;
  PIR6_PWM11IF         : bit  absolute PIR6.4;
  PIR6_PWM6IF          : bit  absolute PIR6.3;
  PIR6_PWM5IF          : bit  absolute PIR6.2;
  ...
  T1CON_SYNC           : bit  absolute T1CON.2;
  T1CON_ON             : bit  absolute T1CON.1;
  ...
  CM1CON0_POL          : bit  absolute CM1CON0.5;
  CM1CON0_ZLF          : bit  absolute CM1CON0.4;
  CM1CON0_Reserved     : bit  absolute CM1CON0.3;
  ...
  CM1NSEL_C1NCH3       : bit  absolute CM1NSEL.3;
  CM1NSEL_C1NCH2       : bit  absolute CM1NSEL.2;
  CM1NSEL_C1NCH1       : bit  absolute CM1NSEL.1;
  CM1NSEL_C1NCH0       : bit  absolute CM1NSEL.0;
  ...
  CM2NSEL_C2NCH3       : bit  absolute CM2NSEL.3;
  CM2NSEL_C2NCH2       : bit  absolute CM2NSEL.2;
  CM2NSEL_C2NCH1       : bit  absolute CM2NSEL.1;
  CM2NSEL_C2NCH0       : bit  absolute CM2NSEL.0;
  CM2PSEL              : byte absolute $0119;
  CM3CON0              : byte absolute $011A;
  CM3CON1              : byte absolute $011B;
  CM3NSEL              : byte absolute $011C;
  CM3NSEL_C3NCH3       : bit  absolute CM3NSEL.3;
  CM3NSEL_C3NCH2       : bit  absolute CM3NSEL.2;
  CM3NSEL_C3NCH1       : bit  absolute CM3NSEL.1;
  CM3NSEL_C3NCH0       : bit  absolute CM3NSEL.0;
  CM3PSEL              : byte absolute $011D;
  ANSELA               : byte absolute $018C;
  ANSELA_ANSA5         : bit  absolute ANSELA.6;
  ...
  MD3CON0_EN           : bit  absolute MD3CON0.6;
  MD3CON0_OPOL         : bit  absolute MD3CON0.4;
  MD3CON0_BIT          : bit  absolute MD3CON0.3;
  MD3CON1              : byte absolute $021C;
  MD3CON1_CHPOL        : bit  absolute MD3CON1.5;
  MD3CON1_CHSYNC       : bit  absolute MD3CON1.4;
  MD3CON1_CLPOL        : bit  absolute MD3CON1.3;
  MD3CON1_CLSYNC       : bit  absolute MD3CON1.2;
  ...
  MD3CARL_MD3CL4       : bit  absolute MD3CARL.7;
  MD3CARL_MD3CL3       : bit  absolute MD3CARL.6;
  MD3CARL_CL4          : bit  absolute MD3CARL.5;
  MD3CARL_CL3          : bit  absolute MD3CARL.4;
  MD3CARL_CL2          : bit  absolute MD3CARL.3;
  MD3CARL_CL1          : bit  absolute MD3CARL.2;
  MD3CARL_CL0          : bit  absolute MD3CARL.1;
  ...
  CCP1CAP_CTS3         : bit  absolute CCP1CAP.4;
  ...
  CCPTMRS2_P9TSEL1     : bit  absolute CCPTMRS2.6;
  CCPTMRS2_P9TSEL0     : bit  absolute CCPTMRS2.5;
  CCPTMRS2_P4TSEL1     : bit  absolute CCPTMRS2.4;
  CCPTMRS2_P4TSEL0     : bit  absolute CCPTMRS2.3;
  CCPTMRS2_P3TSEL1     : bit  absolute CCPTMRS2.2;
  CCPTMRS2_P3TSEL0     : bit  absolute CCPTMRS2.1;
  ...
  MD1CARL_MD1CL4       : bit  absolute MD1CARL.7;
  MD1CARL_MD1CL3       : bit  absolute MD1CARL.6;
  ...
  MD2CARL_MD2CL4       : bit  absolute MD2CARL.7;
  MD2CARL_MD2CL3       : bit  absolute MD2CARL.6;
  ...
  HIDRVB_HIDB1         : bit  absolute HIDRVB.3;
  HIDRVB_HIDB0         : bit  absolute HIDRVB.2;
  ...
  T4CON_OUTPS3         : bit  absolute T4CON.4;
  T4CON_OUTPS2         : bit  absolute T4CON.3;
  T4CON_OUTPS1         : bit  absolute T4CON.2;
  T4CON_OUTPS0         : bit  absolute T4CON.1;
  ...
  T8CON_T8OUTPS0       : bit  absolute T8CON.0;
  ...
  OPA1CON_ORPOL        : bit  absolute OPA1CON.3;
  OPA1CON_ORM1         : bit  absolute OPA1CON.2;
  OPA1CON_ORM0         : bit  absolute OPA1CON.1;
  ...
  OPA3CON_SP           : bit  absolute OPA3CON.5;
  ...
  DACLD_DAC2LD         : bit  absolute DACLD.3;
  DACLD_DAC1LD         : bit  absolute DACLD.2;
  ...
  DAC1CON0_PSS0        : bit  absolute DAC1CON0.3;
  DAC1CON0_NSS1        : bit  absolute DAC1CON0.2;
  DAC1CON0_NSS0        : bit  absolute DAC1CON0.1;
  DAC1CON0_DAC1NSS0    : bit  absolute DAC1CON0.0;
  ...
  DAC2CON0_DAC2NSS0    : bit  absolute DAC2CON0.0;
  DAC2REFL             : byte absolute $0592;
  DAC2REFH             : byte absolute $0593;
  DAC3CON0             : byte absolute $0594;
  DAC3CON0_DACPSS1     : bit  absolute DAC3CON0.4;
  DAC3CON0_PSS1        : bit  absolute DAC3CON0.3;
  DAC3REF              : byte absolute $0595;
  DAC3REF_DAC3R4       : bit  absolute DAC3REF.5;
  ...
  DAC4REF_DAC4R4       : bit  absolute DAC4REF.5;
  DAC5CON0             : byte absolute $0598;
  DAC5CON0_DAC5NSS0    : bit  absolute DAC5CON0.0;
  DAC5REFL             : byte absolute $0599;
  DAC5REFH             : byte absolute $059A;
  DAC6CON0             : byte absolute $059B;
  DAC6CON0_DAC6NSS0    : bit  absolute DAC6CON0.0;
  DAC6REFL             : byte absolute $059C;
  DAC6REFH             : byte absolute $059D;
  DAC7CON0             : byte absolute $059E;
  DAC7REF              : byte absolute $059F;
  DAC7REF_DAC7R4       : bit  absolute DAC7REF.5;
  DAC8CON0             : byte absolute $060C;
  DAC8REF              : byte absolute $060D;
  DAC8REF_DAC8R4       : bit  absolute DAC8REF.5;
  PRG4RTSS             : byte absolute $060E;
  PRG4RTSS_RTSS3       : bit  absolute PRG4RTSS.4;
  PRG4RTSS_RTSS2       : bit  absolute PRG4RTSS.3;
  PRG4RTSS_RTSS1       : bit  absolute PRG4RTSS.2;
  PRG4RTSS_RTSS0       : bit  absolute PRG4RTSS.1;
  PRG4FTSS             : byte absolute $060F;
  PRG4FTSS_FTSS3       : bit  absolute PRG4FTSS.4;
  PRG4FTSS_FTSS2       : bit  absolute PRG4FTSS.3;
  PRG4FTSS_FTSS1       : bit  absolute PRG4FTSS.2;
  PRG4FTSS_FTSS0       : bit  absolute PRG4FTSS.1;
  PRG4INS              : byte absolute $0610;
  PRG4INS_INS3         : bit  absolute PRG4INS.4;
  PRG4INS_INS2         : bit  absolute PRG4INS.3;
  PRG4INS_INS1         : bit  absolute PRG4INS.2;
  PRG4INS_INS0         : bit  absolute PRG4INS.1;
  PRG4CON0             : byte absolute $0611;
  PRG4CON0_FEDG        : bit  absolute PRG4CON0.6;
  PRG4CON0_REDG        : bit  absolute PRG4CON0.5;
  PRG4CON0_OS          : bit  absolute PRG4CON0.2;
  ...
  COG1CON1_POLD        : bit  absolute COG1CON1.5;
  COG1CON1_POLC        : bit  absolute COG1CON1.4;
  COG1CON1_POLB        : bit  absolute COG1CON1.3;
  COG1CON1_POLA        : bit  absolute COG1CON1.2;
  ...
  CM4NSEL_C4NCH3       : bit  absolute CM4NSEL.3;
  CM4NSEL_C4NCH2       : bit  absolute CM4NSEL.2;
  CM4NSEL_C4NCH1       : bit  absolute CM4NSEL.1;
  CM4NSEL_C4NCH0       : bit  absolute CM4NSEL.0;
  CM4PSEL              : byte absolute $090F;
  CM5CON0              : byte absolute $0910;
  CM5CON1              : byte absolute $0911;
  CM5NSEL              : byte absolute $0912;
  CM5NSEL_C5NCH3       : bit  absolute CM5NSEL.3;
  CM5NSEL_C5NCH2       : bit  absolute CM5NSEL.2;
  CM5NSEL_C5NCH1       : bit  absolute CM5NSEL.1;
  CM5NSEL_C5NCH0       : bit  absolute CM5NSEL.0;
  CM5PSEL              : byte absolute $0913;
  CM6CON0              : byte absolute $0914;
  CM6CON1              : byte absolute $0915;
  CM6NSEL              : byte absolute $0916;
  CM6NSEL_C6NCH3       : bit  absolute CM6NSEL.3;
  CM6NSEL_C6NCH2       : bit  absolute CM6NSEL.2;
  CM6NSEL_C6NCH1       : bit  absolute CM6NSEL.1;
  CM6NSEL_C6NCH0       : bit  absolute CM6NSEL.0;
  CM6PSEL              : byte absolute $0917;
  CM7CON0              : byte absolute $0918;
  CM7CON1              : byte absolute $0919;
  CM7NSEL              : byte absolute $091A;
  CM7NSEL_C7NCH3       : bit  absolute CM7NSEL.3;
  CM7NSEL_C7NCH2       : bit  absolute CM7NSEL.2;
  CM7NSEL_C7NCH1       : bit  absolute CM7NSEL.1;
  CM7NSEL_C7NCH0       : bit  absolute CM7NSEL.0;
  CM7PSEL              : byte absolute $091B;
  CM8CON0              : byte absolute $091C;
  CM8CON1              : byte absolute $091D;
  CM8NSEL              : byte absolute $091E;
  CM8NSEL_C8NCH3       : bit  absolute CM8NSEL.3;
  CM8NSEL_C8NCH2       : bit  absolute CM8NSEL.2;
  CM8NSEL_C8NCH1       : bit  absolute CM8NSEL.1;
  CM8NSEL_C8NCH0       : bit  absolute CM8NSEL.0;
  ...
  MD4CARL_MD4CL4       : bit  absolute MD4CARL.7;
  MD4CARL_MD4CL3       : bit  absolute MD4CARL.6;
  ...
  PWM5PHL_PWM5PHL7     : bit  absolute PWM5PHL.7;
  PWM5PHL_PWM5PHL6     : bit  absolute PWM5PHL.6;
  PWM5PHL_PWM5PHL5     : bit  absolute PWM5PHL.5;
  PWM5PHL_PWM5PHL4     : bit  absolute PWM5PHL.4;
  PWM5PHL_PWM5PHL3     : bit  absolute PWM5PHL.3;
  PWM5PHL_PWM5PHL2     : bit  absolute PWM5PHL.2;
  PWM5PHL_PWM5PHL1     : bit  absolute PWM5PHL.1;
  PWM5PHL_PWM5PHL0     : bit  absolute PWM5PHL.0;
  PWM5PHH              : byte absolute $0D92;
  PWM5PHH_PWM5PHH7     : bit  absolute PWM5PHH.7;
  PWM5PHH_PWM5PHH6     : bit  absolute PWM5PHH.6;
  PWM5PHH_PWM5PHH5     : bit  absolute PWM5PHH.5;
  PWM5PHH_PWM5PHH4     : bit  absolute PWM5PHH.4;
  PWM5PHH_PWM5PHH3     : bit  absolute PWM5PHH.3;
  PWM5PHH_PWM5PHH2     : bit  absolute PWM5PHH.2;
  PWM5PHH_PWM5PHH1     : bit  absolute PWM5PHH.1;
  PWM5PHH_PWM5PHH0     : bit  absolute PWM5PHH.0;
  PWM5DCL              : byte absolute $0D93;
  PWM5DCL_PWM5DCL7     : bit  absolute PWM5DCL.7;
  PWM5DCL_PWM5DCL6     : bit  absolute PWM5DCL.6;
  PWM5DCL_PWM5DCL5     : bit  absolute PWM5DCL.5;
  PWM5DCL_PWM5DCL4     : bit  absolute PWM5DCL.4;
  PWM5DCL_PWM5DCL3     : bit  absolute PWM5DCL.3;
  PWM5DCL_PWM5DCL2     : bit  absolute PWM5DCL.2;
  PWM5DCL_PWM5DCL1     : bit  absolute PWM5DCL.1;
  PWM5DCL_PWM5DCL0     : bit  absolute PWM5DCL.0;
  PWM5DCH              : byte absolute $0D94;
  PWM5DCH_PWM5DCH7     : bit  absolute PWM5DCH.7;
  PWM5DCH_PWM5DCH6     : bit  absolute PWM5DCH.6;
  PWM5DCH_PWM5DCH5     : bit  absolute PWM5DCH.5;
  PWM5DCH_PWM5DCH4     : bit  absolute PWM5DCH.4;
  PWM5DCH_PWM5DCH3     : bit  absolute PWM5DCH.3;
  PWM5DCH_PWM5DCH2     : bit  absolute PWM5DCH.2;
  PWM5DCH_PWM5DCH1     : bit  absolute PWM5DCH.1;
  PWM5DCH_PWM5DCH0     : bit  absolute PWM5DCH.0;
  PWM5PRL              : byte absolute $0D95;
  PWM5PRL_PWM5PRL7     : bit  absolute PWM5PRL.7;
  PWM5PRL_PWM5PRL6     : bit  absolute PWM5PRL.6;
  PWM5PRL_PWM5PRL5     : bit  absolute PWM5PRL.5;
  PWM5PRL_PWM5PRL4     : bit  absolute PWM5PRL.4;
  PWM5PRL_PWM5PRL3     : bit  absolute PWM5PRL.3;
  PWM5PRL_PWM5PRL2     : bit  absolute PWM5PRL.2;
  PWM5PRL_PWM5PRL1     : bit  absolute PWM5PRL.1;
  PWM5PRL_PWM5PRL0     : bit  absolute PWM5PRL.0;
  PWM5PRH              : byte absolute $0D96;
  PWM5PRH_PWM5PRH7     : bit  absolute PWM5PRH.7;
  PWM5PRH_PWM5PRH6     : bit  absolute PWM5PRH.6;
  PWM5PRH_PWM5PRH5     : bit  absolute PWM5PRH.5;
  PWM5PRH_PWM5PRH4     : bit  absolute PWM5PRH.4;
  PWM5PRH_PWM5PRH3     : bit  absolute PWM5PRH.3;
  PWM5PRH_PWM5PRH2     : bit  absolute PWM5PRH.2;
  PWM5PRH_PWM5PRH1     : bit  absolute PWM5PRH.1;
  PWM5PRH_PWM5PRH0     : bit  absolute PWM5PRH.0;
  PWM5OFL              : byte absolute $0D97;
  PWM5OFL_PWM5OFL7     : bit  absolute PWM5OFL.7;
  PWM5OFL_PWM5OFL6     : bit  absolute PWM5OFL.6;
  PWM5OFL_PWM5OFL5     : bit  absolute PWM5OFL.5;
  PWM5OFL_PWM5OFL4     : bit  absolute PWM5OFL.4;
  PWM5OFL_PWM5OFL3     : bit  absolute PWM5OFL.3;
  PWM5OFL_PWM5OFL2     : bit  absolute PWM5OFL.2;
  PWM5OFL_PWM5OFL1     : bit  absolute PWM5OFL.1;
  PWM5OFL_PWM5OFL0     : bit  absolute PWM5OFL.0;
  PWM5OFH              : byte absolute $0D98;
  PWM5OFH_PWM5OFH7     : bit  absolute PWM5OFH.7;
  PWM5OFH_PWM5OFH6     : bit  absolute PWM5OFH.6;
  PWM5OFH_PWM5OFH5     : bit  absolute PWM5OFH.5;
  PWM5OFH_PWM5OFH4     : bit  absolute PWM5OFH.4;
  PWM5OFH_PWM5OFH3     : bit  absolute PWM5OFH.3;
  PWM5OFH_PWM5OFH2     : bit  absolute PWM5OFH.2;
  PWM5OFH_PWM5OFH1     : bit  absolute PWM5OFH.1;
  PWM5OFH_PWM5OFH0     : bit  absolute PWM5OFH.0;
  PWM5TMRL             : byte absolute $0D99;
  PWM5TMRL_PWM5TMRL7   : bit  absolute PWM5TMRL.7;
  PWM5TMRL_PWM5TMRL6   : bit  absolute PWM5TMRL.6;
  PWM5TMRL_PWM5TMRL5   : bit  absolute PWM5TMRL.5;
  PWM5TMRL_PWM5TMRL4   : bit  absolute PWM5TMRL.4;
  PWM5TMRL_PWM5TMRL3   : bit  absolute PWM5TMRL.3;
  PWM5TMRL_PWM5TMRL2   : bit  absolute PWM5TMRL.2;
  PWM5TMRL_PWM5TMRL1   : bit  absolute PWM5TMRL.1;
  PWM5TMRL_PWM5TMRL0   : bit  absolute PWM5TMRL.0;
  PWM5TMRH             : byte absolute $0D9A;
  PWM5TMRH_PWM5TMRH7   : bit  absolute PWM5TMRH.7;
  PWM5TMRH_PWM5TMRH6   : bit  absolute PWM5TMRH.6;
  PWM5TMRH_PWM5TMRH5   : bit  absolute PWM5TMRH.5;
  PWM5TMRH_PWM5TMRH4   : bit  absolute PWM5TMRH.4;
  PWM5TMRH_PWM5TMRH3   : bit  absolute PWM5TMRH.3;
  PWM5TMRH_PWM5TMRH2   : bit  absolute PWM5TMRH.2;
  PWM5TMRH_PWM5TMRH1   : bit  absolute PWM5TMRH.1;
  PWM5TMRH_PWM5TMRH0   : bit  absolute PWM5TMRH.0;
  PWM5CON              : byte absolute $0D9B;
  PWM5CON_PWM5MODE1    : bit  absolute PWM5CON.2;
  PWM5CON_PWM5MODE0    : bit  absolute PWM5CON.1;
  ...
  PWM5CLKCON_PWM5PS2   : bit  absolute PWM5CLKCON.6;
  PWM5CLKCON_PWM5PS1   : bit  absolute PWM5CLKCON.5;
  PWM5CLKCON_PWM5PS0   : bit  absolute PWM5CLKCON.4;
  PWM5CLKCON_PWM5CS2   : bit  absolute PWM5CLKCON.3;
  PWM5CLKCON_PWM5CS1   : bit  absolute PWM5CLKCON.2;
  PWM5CLKCON_PWM5CS0   : bit  absolute PWM5CLKCON.1;
  PWM5LDCON            : byte absolute $0D9F;
  PWM5LDCON_PWM5LD     : bit  absolute PWM5LDCON.7;
  PWM5LDCON_PWM5LDM    : bit  absolute PWM5LDCON.6;
  PWM5LDCON_LDA        : bit  absolute PWM5LDCON.4;
  PWM5LDCON_LDT        : bit  absolute PWM5LDCON.3;
  PWM5LDCON_PWM5LDS1   : bit  absolute PWM5LDCON.2;
  PWM5LDCON_PWM5LDS0   : bit  absolute PWM5LDCON.1;
  ...
  PWM5OFCON_PWM5OFM1   : bit  absolute PWM5OFCON.4;
  PWM5OFCON_OFO        : bit  absolute PWM5OFCON.3;
  PWM5OFCON_PWM5OFS1   : bit  absolute PWM5OFCON.2;
  PWM5OFCON_PWM5OFS0   : bit  absolute PWM5OFCON.1;
  PWM6PHL              : byte absolute $0DA1;
  PWM6PHL_PWM6PHL7     : bit  absolute PWM6PHL.7;
  PWM6PHL_PWM6PHL6     : bit  absolute PWM6PHL.6;
  PWM6PHL_PWM6PHL5     : bit  absolute PWM6PHL.5;
  PWM6PHL_PWM6PHL4     : bit  absolute PWM6PHL.4;
  PWM6PHL_PWM6PHL3     : bit  absolute PWM6PHL.3;
  PWM6PHL_PWM6PHL2     : bit  absolute PWM6PHL.2;
  PWM6PHL_PWM6PHL1     : bit  absolute PWM6PHL.1;
  PWM6PHL_PWM6PHL0     : bit  absolute PWM6PHL.0;
  PWM6PHH              : byte absolute $0DA2;
  PWM6PHH_PWM6PHH7     : bit  absolute PWM6PHH.7;
  PWM6PHH_PWM6PHH6     : bit  absolute PWM6PHH.6;
  PWM6PHH_PWM6PHH5     : bit  absolute PWM6PHH.5;
  PWM6PHH_PWM6PHH4     : bit  absolute PWM6PHH.4;
  PWM6PHH_PWM6PHH3     : bit  absolute PWM6PHH.3;
  PWM6PHH_PWM6PHH2     : bit  absolute PWM6PHH.2;
  PWM6PHH_PWM6PHH1     : bit  absolute PWM6PHH.1;
  PWM6PHH_PWM6PHH0     : bit  absolute PWM6PHH.0;
  PWM6DCL              : byte absolute $0DA3;
  PWM6DCL_PWM6DCL7     : bit  absolute PWM6DCL.7;
  PWM6DCL_PWM6DCL6     : bit  absolute PWM6DCL.6;
  PWM6DCL_PWM6DCL5     : bit  absolute PWM6DCL.5;
  PWM6DCL_PWM6DCL4     : bit  absolute PWM6DCL.4;
  PWM6DCL_PWM6DCL3     : bit  absolute PWM6DCL.3;
  PWM6DCL_PWM6DCL2     : bit  absolute PWM6DCL.2;
  PWM6DCL_PWM6DCL1     : bit  absolute PWM6DCL.1;
  PWM6DCL_PWM6DCL0     : bit  absolute PWM6DCL.0;
  PWM6DCH              : byte absolute $0DA4;
  PWM6DCH_PWM6DCH7     : bit  absolute PWM6DCH.7;
  PWM6DCH_PWM6DCH6     : bit  absolute PWM6DCH.6;
  PWM6DCH_PWM6DCH5     : bit  absolute PWM6DCH.5;
  PWM6DCH_PWM6DCH4     : bit  absolute PWM6DCH.4;
  PWM6DCH_PWM6DCH3     : bit  absolute PWM6DCH.3;
  PWM6DCH_PWM6DCH2     : bit  absolute PWM6DCH.2;
  PWM6DCH_PWM6DCH1     : bit  absolute PWM6DCH.1;
  PWM6DCH_PWM6DCH0     : bit  absolute PWM6DCH.0;
  PWM6PRL              : byte absolute $0DA5;
  PWM6PRL_PWM6PRL7     : bit  absolute PWM6PRL.7;
  PWM6PRL_PWM6PRL6     : bit  absolute PWM6PRL.6;
  PWM6PRL_PWM6PRL5     : bit  absolute PWM6PRL.5;
  PWM6PRL_PWM6PRL4     : bit  absolute PWM6PRL.4;
  PWM6PRL_PWM6PRL3     : bit  absolute PWM6PRL.3;
  PWM6PRL_PWM6PRL2     : bit  absolute PWM6PRL.2;
  PWM6PRL_PWM6PRL1     : bit  absolute PWM6PRL.1;
  PWM6PRL_PWM6PRL0     : bit  absolute PWM6PRL.0;
  PWM6PRH              : byte absolute $0DA6;
  PWM6PRH_PWM6PRH7     : bit  absolute PWM6PRH.7;
  PWM6PRH_PWM6PRH6     : bit  absolute PWM6PRH.6;
  PWM6PRH_PWM6PRH5     : bit  absolute PWM6PRH.5;
  PWM6PRH_PWM6PRH4     : bit  absolute PWM6PRH.4;
  PWM6PRH_PWM6PRH3     : bit  absolute PWM6PRH.3;
  PWM6PRH_PWM6PRH2     : bit  absolute PWM6PRH.2;
  PWM6PRH_PWM6PRH1     : bit  absolute PWM6PRH.1;
  PWM6PRH_PWM6PRH0     : bit  absolute PWM6PRH.0;
  PWM6OFL              : byte absolute $0DA7;
  PWM6OFL_PWM6OFL7     : bit  absolute PWM6OFL.7;
  PWM6OFL_PWM6OFL6     : bit  absolute PWM6OFL.6;
  PWM6OFL_PWM6OFL5     : bit  absolute PWM6OFL.5;
  PWM6OFL_PWM6OFL4     : bit  absolute PWM6OFL.4;
  PWM6OFL_PWM6OFL3     : bit  absolute PWM6OFL.3;
  PWM6OFL_PWM6OFL2     : bit  absolute PWM6OFL.2;
  PWM6OFL_PWM6OFL1     : bit  absolute PWM6OFL.1;
  PWM6OFL_PWM6OFL0     : bit  absolute PWM6OFL.0;
  PWM6OFH              : byte absolute $0DA8;
  PWM6OFH_PWM6OFH7     : bit  absolute PWM6OFH.7;
  PWM6OFH_PWM6OFH6     : bit  absolute PWM6OFH.6;
  PWM6OFH_PWM6OFH5     : bit  absolute PWM6OFH.5;
  PWM6OFH_PWM6OFH4     : bit  absolute PWM6OFH.4;
  PWM6OFH_PWM6OFH3     : bit  absolute PWM6OFH.3;
  PWM6OFH_PWM6OFH2     : bit  absolute PWM6OFH.2;
  PWM6OFH_PWM6OFH1     : bit  absolute PWM6OFH.1;
  PWM6OFH_PWM6OFH0     : bit  absolute PWM6OFH.0;
  PWM6TMRL             : byte absolute $0DA9;
  PWM6TMRL_PWM6TMRL7   : bit  absolute PWM6TMRL.7;
  PWM6TMRL_PWM6TMRL6   : bit  absolute PWM6TMRL.6;
  PWM6TMRL_PWM6TMRL5   : bit  absolute PWM6TMRL.5;
  PWM6TMRL_PWM6TMRL4   : bit  absolute PWM6TMRL.4;
  PWM6TMRL_PWM6TMRL3   : bit  absolute PWM6TMRL.3;
  PWM6TMRL_PWM6TMRL2   : bit  absolute PWM6TMRL.2;
  PWM6TMRL_PWM6TMRL1   : bit  absolute PWM6TMRL.1;
  PWM6TMRL_PWM6TMRL0   : bit  absolute PWM6TMRL.0;
  PWM6TMRH             : byte absolute $0DAA;
  PWM6TMRH_PWM6TMRH7   : bit  absolute PWM6TMRH.7;
  PWM6TMRH_PWM6TMRH6   : bit  absolute PWM6TMRH.6;
  PWM6TMRH_PWM6TMRH5   : bit  absolute PWM6TMRH.5;
  PWM6TMRH_PWM6TMRH4   : bit  absolute PWM6TMRH.4;
  PWM6TMRH_PWM6TMRH3   : bit  absolute PWM6TMRH.3;
  PWM6TMRH_PWM6TMRH2   : bit  absolute PWM6TMRH.2;
  PWM6TMRH_PWM6TMRH1   : bit  absolute PWM6TMRH.1;
  PWM6TMRH_PWM6TMRH0   : bit  absolute PWM6TMRH.0;
  PWM6CON              : byte absolute $0DAB;
  PWM6CON_PWM6MODE1    : bit  absolute PWM6CON.2;
  PWM6CON_PWM6MODE0    : bit  absolute PWM6CON.1;
  PWM6INTE             : byte absolute $0DAC;
  PWM6INTF             : byte absolute $0DAD;
  PWM6CLKCON           : byte absolute $0DAE;
  PWM6CLKCON_PWM6PS2   : bit  absolute PWM6CLKCON.6;
  PWM6CLKCON_PWM6PS1   : bit  absolute PWM6CLKCON.5;
  PWM6CLKCON_PWM6PS0   : bit  absolute PWM6CLKCON.4;
  PWM6CLKCON_PWM6CS2   : bit  absolute PWM6CLKCON.3;
  PWM6CLKCON_PWM6CS1   : bit  absolute PWM6CLKCON.2;
  PWM6CLKCON_PWM6CS0   : bit  absolute PWM6CLKCON.1;
  PWM6LDCON            : byte absolute $0DAF;
  PWM6LDCON_PWM6LD     : bit  absolute PWM6LDCON.7;
  PWM6LDCON_PWM6LDM    : bit  absolute PWM6LDCON.6;
  PWM6LDCON_PWM6LDS1   : bit  absolute PWM6LDCON.2;
  PWM6LDCON_PWM6LDS0   : bit  absolute PWM6LDCON.1;
  PWM6OFCON            : byte absolute $0DB0;
  PWM6OFCON_PWM6OFM1   : bit  absolute PWM6OFCON.4;
  PWM6OFCON_PWM6OFS1   : bit  absolute PWM6OFCON.2;
  PWM6OFCON_PWM6OFS0   : bit  absolute PWM6OFCON.1;
  PWM11PHL             : byte absolute $0DB1;
  PWM11PHL_PWM11PHL7   : bit  absolute PWM11PHL.7;
  PWM11PHL_PWM11PHL6   : bit  absolute PWM11PHL.6;
  PWM11PHL_PWM11PHL5   : bit  absolute PWM11PHL.5;
  PWM11PHL_PWM11PHL4   : bit  absolute PWM11PHL.4;
  PWM11PHL_PWM11PHL3   : bit  absolute PWM11PHL.3;
  PWM11PHL_PWM11PHL2   : bit  absolute PWM11PHL.2;
  PWM11PHL_PWM11PHL1   : bit  absolute PWM11PHL.1;
  PWM11PHL_PWM11PHL0   : bit  absolute PWM11PHL.0;
  PWM11PHH             : byte absolute $0DB2;
  PWM11PHH_PWM11PHH7   : bit  absolute PWM11PHH.7;
  PWM11PHH_PWM11PHH6   : bit  absolute PWM11PHH.6;
  PWM11PHH_PWM11PHH5   : bit  absolute PWM11PHH.5;
  PWM11PHH_PWM11PHH4   : bit  absolute PWM11PHH.4;
  PWM11PHH_PWM11PHH3   : bit  absolute PWM11PHH.3;
  PWM11PHH_PWM11PHH2   : bit  absolute PWM11PHH.2;
  PWM11PHH_PWM11PHH1   : bit  absolute PWM11PHH.1;
  PWM11PHH_PWM11PHH0   : bit  absolute PWM11PHH.0;
  PWM11DCL             : byte absolute $0DB3;
  PWM11DCL_PWM11DCL7   : bit  absolute PWM11DCL.7;
  PWM11DCL_PWM11DCL6   : bit  absolute PWM11DCL.6;
  PWM11DCL_PWM11DCL5   : bit  absolute PWM11DCL.5;
  PWM11DCL_PWM11DCL4   : bit  absolute PWM11DCL.4;
  PWM11DCL_PWM11DCL3   : bit  absolute PWM11DCL.3;
  PWM11DCL_PWM11DCL2   : bit  absolute PWM11DCL.2;
  PWM11DCL_PWM11DCL1   : bit  absolute PWM11DCL.1;
  PWM11DCL_PWM11DCL0   : bit  absolute PWM11DCL.0;
  PWM11DCH             : byte absolute $0DB4;
  PWM11DCH_PWM11DCH7   : bit  absolute PWM11DCH.7;
  PWM11DCH_PWM11DCH6   : bit  absolute PWM11DCH.6;
  PWM11DCH_PWM11DCH5   : bit  absolute PWM11DCH.5;
  PWM11DCH_PWM11DCH4   : bit  absolute PWM11DCH.4;
  PWM11DCH_PWM11DCH3   : bit  absolute PWM11DCH.3;
  PWM11DCH_PWM11DCH2   : bit  absolute PWM11DCH.2;
  PWM11DCH_PWM11DCH1   : bit  absolute PWM11DCH.1;
  PWM11DCH_PWM11DCH0   : bit  absolute PWM11DCH.0;
  PWM11PRL             : byte absolute $0DB5;
  PWM11PRL_PWM11PRL7   : bit  absolute PWM11PRL.7;
  PWM11PRL_PWM11PRL6   : bit  absolute PWM11PRL.6;
  PWM11PRL_PWM11PRL5   : bit  absolute PWM11PRL.5;
  PWM11PRL_PWM11PRL4   : bit  absolute PWM11PRL.4;
  PWM11PRL_PWM11PRL3   : bit  absolute PWM11PRL.3;
  PWM11PRL_PWM11PRL2   : bit  absolute PWM11PRL.2;
  PWM11PRL_PWM11PRL1   : bit  absolute PWM11PRL.1;
  PWM11PRL_PWM11PRL0   : bit  absolute PWM11PRL.0;
  PWM11PRH             : byte absolute $0DB6;
  PWM11PRH_PWM11PRH7   : bit  absolute PWM11PRH.7;
  PWM11PRH_PWM11PRH6   : bit  absolute PWM11PRH.6;
  PWM11PRH_PWM11PRH5   : bit  absolute PWM11PRH.5;
  PWM11PRH_PWM11PRH4   : bit  absolute PWM11PRH.4;
  PWM11PRH_PWM11PRH3   : bit  absolute PWM11PRH.3;
  PWM11PRH_PWM11PRH2   : bit  absolute PWM11PRH.2;
  PWM11PRH_PWM11PRH1   : bit  absolute PWM11PRH.1;
  PWM11PRH_PWM11PRH0   : bit  absolute PWM11PRH.0;
  PWM11OFL             : byte absolute $0DB7;
  PWM11OFL_PWM11OFL7   : bit  absolute PWM11OFL.7;
  PWM11OFL_PWM11OFL6   : bit  absolute PWM11OFL.6;
  PWM11OFL_PWM11OFL5   : bit  absolute PWM11OFL.5;
  PWM11OFL_PWM11OFL4   : bit  absolute PWM11OFL.4;
  PWM11OFL_PWM11OFL3   : bit  absolute PWM11OFL.3;
  PWM11OFL_PWM11OFL2   : bit  absolute PWM11OFL.2;
  PWM11OFL_PWM11OFL1   : bit  absolute PWM11OFL.1;
  PWM11OFL_PWM11OFL0   : bit  absolute PWM11OFL.0;
  PWM11OFH             : byte absolute $0DB8;
  PWM11OFH_PWM11OFH7   : bit  absolute PWM11OFH.7;
  PWM11OFH_PWM11OFH6   : bit  absolute PWM11OFH.6;
  PWM11OFH_PWM11OFH5   : bit  absolute PWM11OFH.5;
  PWM11OFH_PWM11OFH4   : bit  absolute PWM11OFH.4;
  PWM11OFH_PWM11OFH3   : bit  absolute PWM11OFH.3;
  PWM11OFH_PWM11OFH2   : bit  absolute PWM11OFH.2;
  PWM11OFH_PWM11OFH1   : bit  absolute PWM11OFH.1;
  PWM11OFH_PWM11OFH0   : bit  absolute PWM11OFH.0;
  PWM11TMRL            : byte absolute $0DB9;
  PWM11TMRL_PWM11TMRL7 : bit  absolute PWM11TMRL.7;
  PWM11TMRL_PWM11TMRL6 : bit  absolute PWM11TMRL.6;
  PWM11TMRL_PWM11TMRL5 : bit  absolute PWM11TMRL.5;
  PWM11TMRL_PWM11TMRL4 : bit  absolute PWM11TMRL.4;
  PWM11TMRL_PWM11TMRL3 : bit  absolute PWM11TMRL.3;
  PWM11TMRL_PWM11TMRL2 : bit  absolute PWM11TMRL.2;
  PWM11TMRL_PWM11TMRL1 : bit  absolute PWM11TMRL.1;
  PWM11TMRL_PWM11TMRL0 : bit  absolute PWM11TMRL.0;
  PWM11TMRH            : byte absolute $0DBA;
  PWM11TMRH_PWM11TMRH7 : bit  absolute PWM11TMRH.7;
  PWM11TMRH_PWM11TMRH6 : bit  absolute PWM11TMRH.6;
  PWM11TMRH_PWM11TMRH5 : bit  absolute PWM11TMRH.5;
  PWM11TMRH_PWM11TMRH4 : bit  absolute PWM11TMRH.4;
  PWM11TMRH_PWM11TMRH3 : bit  absolute PWM11TMRH.3;
  PWM11TMRH_PWM11TMRH2 : bit  absolute PWM11TMRH.2;
  PWM11TMRH_PWM11TMRH1 : bit  absolute PWM11TMRH.1;
  PWM11TMRH_PWM11TMRH0 : bit  absolute PWM11TMRH.0;
  PWM11CON             : byte absolute $0DBB;
  PWM11CON_PWM11MODE1  : bit  absolute PWM11CON.2;
  PWM11CON_PWM11MODE0  : bit  absolute PWM11CON.1;
  PWM11INTE            : byte absolute $0DBC;
  PWM11INTF            : byte absolute $0DBD;
  PWM11CLKCON          : byte absolute $0DBE;
  PWM11CLKCON_PWM11PS2 : bit  absolute PWM11CLKCON.6;
  PWM11CLKCON_PWM11PS1 : bit  absolute PWM11CLKCON.5;
  PWM11CLKCON_PWM11PS0 : bit  absolute PWM11CLKCON.4;
  PWM11CLKCON_PWM11CS2 : bit  absolute PWM11CLKCON.3;
  PWM11CLKCON_PWM11CS1 : bit  absolute PWM11CLKCON.2;
  PWM11CLKCON_PWM11CS0 : bit  absolute PWM11CLKCON.1;
  PWM11LDCON           : byte absolute $0DBF;
  PWM11LDCON_PWM11LD   : bit  absolute PWM11LDCON.7;
  PWM11LDCON_PWM11LDM  : bit  absolute PWM11LDCON.6;
  PWM11LDCON_PWM11LDS1 : bit  absolute PWM11LDCON.2;
  PWM11LDCON_PWM11LDS0 : bit  absolute PWM11LDCON.1;
  PWM11OFCON           : byte absolute $0DC0;
  PWM11OFCON_PWM11OFM1 : bit  absolute PWM11OFCON.4;
  PWM11OFCON_PWM11OFS1 : bit  absolute PWM11OFCON.2;
  PWM11OFCON_PWM11OFS0 : bit  absolute PWM11OFCON.1;
  PWM12PHL             : byte absolute $0DC1;
  PWM12PHL_PWM12PHL7   : bit  absolute PWM12PHL.7;
  PWM12PHL_PWM12PHL6   : bit  absolute PWM12PHL.6;
  PWM12PHL_PWM12PHL5   : bit  absolute PWM12PHL.5;
  PWM12PHL_PWM12PHL4   : bit  absolute PWM12PHL.4;
  PWM12PHL_PWM12PHL3   : bit  absolute PWM12PHL.3;
  PWM12PHL_PWM12PHL2   : bit  absolute PWM12PHL.2;
  PWM12PHL_PWM12PHL1   : bit  absolute PWM12PHL.1;
  PWM12PHL_PWM12PHL0   : bit  absolute PWM12PHL.0;
  PWM12PHH             : byte absolute $0DC2;
  PWM12PHH_PWM12PHH7   : bit  absolute PWM12PHH.7;
  PWM12PHH_PWM12PHH6   : bit  absolute PWM12PHH.6;
  PWM12PHH_PWM12PHH5   : bit  absolute PWM12PHH.5;
  PWM12PHH_PWM12PHH4   : bit  absolute PWM12PHH.4;
  PWM12PHH_PWM12PHH3   : bit  absolute PWM12PHH.3;
  PWM12PHH_PWM12PHH2   : bit  absolute PWM12PHH.2;
  PWM12PHH_PWM12PHH1   : bit  absolute PWM12PHH.1;
  PWM12PHH_PWM12PHH0   : bit  absolute PWM12PHH.0;
  PWM12DCL             : byte absolute $0DC3;
  PWM12DCL_PWM12DCL7   : bit  absolute PWM12DCL.7;
  PWM12DCL_PWM12DCL6   : bit  absolute PWM12DCL.6;
  PWM12DCL_PWM12DCL5   : bit  absolute PWM12DCL.5;
  PWM12DCL_PWM12DCL4   : bit  absolute PWM12DCL.4;
  PWM12DCL_PWM12DCL3   : bit  absolute PWM12DCL.3;
  PWM12DCL_PWM12DCL2   : bit  absolute PWM12DCL.2;
  PWM12DCL_PWM12DCL1   : bit  absolute PWM12DCL.1;
  PWM12DCL_PWM12DCL0   : bit  absolute PWM12DCL.0;
  PWM12DCH             : byte absolute $0DC4;
  PWM12DCH_PWM12DCH7   : bit  absolute PWM12DCH.7;
  PWM12DCH_PWM12DCH6   : bit  absolute PWM12DCH.6;
  PWM12DCH_PWM12DCH5   : bit  absolute PWM12DCH.5;
  PWM12DCH_PWM12DCH4   : bit  absolute PWM12DCH.4;
  PWM12DCH_PWM12DCH3   : bit  absolute PWM12DCH.3;
  PWM12DCH_PWM12DCH2   : bit  absolute PWM12DCH.2;
  PWM12DCH_PWM12DCH1   : bit  absolute PWM12DCH.1;
  PWM12DCH_PWM12DCH0   : bit  absolute PWM12DCH.0;
  PWM12PRL             : byte absolute $0DC5;
  PWM12PRL_PWM12PRL7   : bit  absolute PWM12PRL.7;
  PWM12PRL_PWM12PRL6   : bit  absolute PWM12PRL.6;
  PWM12PRL_PWM12PRL5   : bit  absolute PWM12PRL.5;
  PWM12PRL_PWM12PRL4   : bit  absolute PWM12PRL.4;
  PWM12PRL_PWM12PRL3   : bit  absolute PWM12PRL.3;
  PWM12PRL_PWM12PRL2   : bit  absolute PWM12PRL.2;
  PWM12PRL_PWM12PRL1   : bit  absolute PWM12PRL.1;
  PWM12PRL_PWM12PRL0   : bit  absolute PWM12PRL.0;
  PWM12PRH             : byte absolute $0DC6;
  PWM12PRH_PWM12PRH7   : bit  absolute PWM12PRH.7;
  PWM12PRH_PWM12PRH6   : bit  absolute PWM12PRH.6;
  PWM12PRH_PWM12PRH5   : bit  absolute PWM12PRH.5;
  PWM12PRH_PWM12PRH4   : bit  absolute PWM12PRH.4;
  PWM12PRH_PWM12PRH3   : bit  absolute PWM12PRH.3;
  PWM12PRH_PWM12PRH2   : bit  absolute PWM12PRH.2;
  PWM12PRH_PWM12PRH1   : bit  absolute PWM12PRH.1;
  PWM12PRH_PWM12PRH0   : bit  absolute PWM12PRH.0;
  PWM12OFL             : byte absolute $0DC7;
  PWM12OFL_PWM12OFL7   : bit  absolute PWM12OFL.7;
  PWM12OFL_PWM12OFL6   : bit  absolute PWM12OFL.6;
  PWM12OFL_PWM12OFL5   : bit  absolute PWM12OFL.5;
  PWM12OFL_PWM12OFL4   : bit  absolute PWM12OFL.4;
  PWM12OFL_PWM12OFL3   : bit  absolute PWM12OFL.3;
  PWM12OFL_PWM12OFL2   : bit  absolute PWM12OFL.2;
  PWM12OFL_PWM12OFL1   : bit  absolute PWM12OFL.1;
  PWM12OFL_PWM12OFL0   : bit  absolute PWM12OFL.0;
  PWM12OFH             : byte absolute $0DC8;
  PWM12OFH_PWM12OFH7   : bit  absolute PWM12OFH.7;
  PWM12OFH_PWM12OFH6   : bit  absolute PWM12OFH.6;
  PWM12OFH_PWM12OFH5   : bit  absolute PWM12OFH.5;
  PWM12OFH_PWM12OFH4   : bit  absolute PWM12OFH.4;
  PWM12OFH_PWM12OFH3   : bit  absolute PWM12OFH.3;
  PWM12OFH_PWM12OFH2   : bit  absolute PWM12OFH.2;
  PWM12OFH_PWM12OFH1   : bit  absolute PWM12OFH.1;
  PWM12OFH_PWM12OFH0   : bit  absolute PWM12OFH.0;
  PWM12TMRL            : byte absolute $0DC9;
  PWM12TMRL_PWM12TMRL7 : bit  absolute PWM12TMRL.7;
  PWM12TMRL_PWM12TMRL6 : bit  absolute PWM12TMRL.6;
  PWM12TMRL_PWM12TMRL5 : bit  absolute PWM12TMRL.5;
  PWM12TMRL_PWM12TMRL4 : bit  absolute PWM12TMRL.4;
  PWM12TMRL_PWM12TMRL3 : bit  absolute PWM12TMRL.3;
  PWM12TMRL_PWM12TMRL2 : bit  absolute PWM12TMRL.2;
  PWM12TMRL_PWM12TMRL1 : bit  absolute PWM12TMRL.1;
  PWM12TMRL_PWM12TMRL0 : bit  absolute PWM12TMRL.0;
  PWM12TMRH            : byte absolute $0DCA;
  PWM12TMRH_PWM12TMRH7 : bit  absolute PWM12TMRH.7;
  PWM12TMRH_PWM12TMRH6 : bit  absolute PWM12TMRH.6;
  PWM12TMRH_PWM12TMRH5 : bit  absolute PWM12TMRH.5;
  PWM12TMRH_PWM12TMRH4 : bit  absolute PWM12TMRH.4;
  PWM12TMRH_PWM12TMRH3 : bit  absolute PWM12TMRH.3;
  PWM12TMRH_PWM12TMRH2 : bit  absolute PWM12TMRH.2;
  PWM12TMRH_PWM12TMRH1 : bit  absolute PWM12TMRH.1;
  PWM12TMRH_PWM12TMRH0 : bit  absolute PWM12TMRH.0;
  PWM12CON             : byte absolute $0DCB;
  PWM12CON_PWM12MODE1  : bit  absolute PWM12CON.2;
  PWM12CON_PWM12MODE0  : bit  absolute PWM12CON.1;
  PWM12INTE            : byte absolute $0DCC;
  PWM12INTF            : byte absolute $0DCD;
  PWM12CLKCON          : byte absolute $0DCE;
  PWM12CLKCON_PWM12PS2 : bit  absolute PWM12CLKCON.6;
  PWM12CLKCON_PWM12PS1 : bit  absolute PWM12CLKCON.5;
  PWM12CLKCON_PWM12PS0 : bit  absolute PWM12CLKCON.4;
  PWM12CLKCON_PWM12CS2 : bit  absolute PWM12CLKCON.3;
  PWM12CLKCON_PWM12CS1 : bit  absolute PWM12CLKCON.2;
  PWM12CLKCON_PWM12CS0 : bit  absolute PWM12CLKCON.1;
  PWM12LDCON           : byte absolute $0DCF;
  PWM12LDCON_PWM12LD   : bit  absolute PWM12LDCON.7;
  PWM12LDCON_PWM12LDM  : bit  absolute PWM12LDCON.6;
  PWM12LDCON_PWM12LDS1 : bit  absolute PWM12LDCON.2;
  PWM12LDCON_PWM12LDS0 : bit  absolute PWM12LDCON.1;
  PWM12OFCON           : byte absolute $0DD0;
  PWM12OFCON_PWM12OFM1 : bit  absolute PWM12OFCON.4;
  PWM12OFCON_PWM12OFS1 : bit  absolute PWM12OFCON.2;
  PWM12OFCON_PWM12OFS0 : bit  absolute PWM12OFCON.1;
  ...
  {$SET_STATE_RAM '000-01F:SFR'}  // INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON, PORTA, PORTB, PORTC, PORTD, PORTE, PIR1, PIR2, PIR3, PIR4, PIR5, PIR6, TMR0, TMR1L, TMR1H, T1CON, T1GCON, TMR3L, TMR3H, T3CON, T3GCON
  {$SET_STATE_RAM '020-06F:GPR'} 
  {$SET_STATE_RAM '070-07F:GPR'} 
  {$SET_STATE_RAM '080-080:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '08C-09F:SFR'}  // TRISA, TRISB, TRISC, TRISD, TRISE, PIE1, PIE2, PIE3, PIE4, PIE5, PIE6, OPTION_REG, PCON, WDTCON, OSCTUNE, OSCCON, OSCSTAT, BORCON, FVRCON, ZCD1CON
  {$SET_STATE_RAM '0A0-0EF:GPR'} 
  {$SET_STATE_RAM '0F0-0FF:GPR'} 
  {$SET_STATE_RAM '100-100:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '10C-11D:SFR'}  // LATA, LATB, LATC, LATD, LATE, CMOUT, CM1CON0, CM1CON1, CM1NSEL, CM1PSEL, CM2CON0, CM2CON1, CM2NSEL, CM2PSEL, CM3CON0, CM3CON1, CM3NSEL, CM3PSEL
  {$SET_STATE_RAM '120-16F:GPR'} 
  {$SET_STATE_RAM '170-17F:GPR'} 
  {$SET_STATE_RAM '180-180:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '18C-197:SFR'}  // ANSELA, ANSELB, ANSELC, ANSELD, ANSELE, PMADRL, PMADRH, PMDATL, PMDATH, PMCON1, PMCON2, VREGCON
  {$SET_STATE_RAM '199-19F:SFR'}  // RC1REG, TX1REG, SP1BRGL, SP1BRGH, RC1STA, TX1STA, BAUD1CON
  {$SET_STATE_RAM '1A0-1EF:GPR'} 
  {$SET_STATE_RAM '1F0-1FF:GPR'} 
  {$SET_STATE_RAM '200-200:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '20C-217:SFR'}  // WPUA, WPUB, WPUC, WPUD, WPUE, SSP1BUF, SSP1ADD, SSP1MSK, SSP1STAT, SSP1CON1, SSP1CON2, SSP1CON3
  {$SET_STATE_RAM '21B-21F:SFR'}  // MD3CON0, MD3CON1, MD3SRC, MD3CARL, MD3CARH
  {$SET_STATE_RAM '220-26F:GPR'} 
  {$SET_STATE_RAM '270-27F:GPR'} 
  {$SET_STATE_RAM '280-280:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '28C-29C:SFR'}  // ODCONA, ODCONB, ODCONC, ODCOND, ODCONE, CCPR1L, CCPR1H, CCP1CON, CCP1CAP, CCPR2L, CCPR2H, CCP2CON, CCP2CAP, CCPR7L, CCPR7H, CCP7CON, CCP7CAP
  {$SET_STATE_RAM '29E-29F:SFR'}  // CCPTMRS1, CCPTMRS2
  {$SET_STATE_RAM '2A0-2EF:GPR'} 
  {$SET_STATE_RAM '2F0-2FF:GPR'} 
  {$SET_STATE_RAM '300-300:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '30C-319:SFR'}  // SLRCONA, SLRCONB, SLRCONC, SLRCOND, SLRCONE, CCPR8L, CCPR8H, CCP8CON, CCP8CAP, MD1CON0, MD1CON1, MD1SRC, MD1CARL, MD1CARH
  {$SET_STATE_RAM '31B-31F:SFR'}  // MD2CON0, MD2CON1, MD2SRC, MD2CARL, MD2CARH
  {$SET_STATE_RAM '320-36F:GPR'} 
  {$SET_STATE_RAM '370-37F:GPR'} 
  {$SET_STATE_RAM '380-380:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '38C-399:SFR'}  // INLVLA, INLVLB, INLVLC, INLVLD, INLVE, IOCAP, IOCAN, IOCAF, IOCBP, IOCBN, IOCBF, IOCCP, IOCCN, IOCCF
  {$SET_STATE_RAM '39D-39F:SFR'}  // IOCEP, IOCEN, IOCEF
  {$SET_STATE_RAM '3A0-3EF:GPR'} 
  {$SET_STATE_RAM '3F0-3FF:GPR'} 
  {$SET_STATE_RAM '400-400:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '40D-40D:SFR'}  // HIDRVB
  {$SET_STATE_RAM '40F-418:SFR'}  // TMR5L, TMR5H, T5CON, T5GCON, T4TMR, T4PR, T4CON, T4HLT, T4CLKCON, T4RST
  ...
  {$SET_STATE_RAM '48E-498:SFR'}  // ADRESL, ADRESH, ADCON0, ADCON1, ADCON2, T2TMR, T2PR, T2CON, T2HLT, T2CLKCON, T2RST
  {$SET_STATE_RAM '49A-49F:SFR'}  // T8TMR, T8PR, T8CON, T8HLT, T8CLKCON, T8RST
  {$SET_STATE_RAM '4A0-4EF:GPR'} 
  {$SET_STATE_RAM '4F0-4FF:GPR'} 
  {$SET_STATE_RAM '500-500:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '50F-51E:SFR'}  // OPA1NCHS, OPA1PCHS, OPA1CON, OPA1ORS, OPA2NCHS, OPA2PCHS, OPA2CON, OPA2ORS, OPA3NCHS, OPA3PCHS, OPA3CON, OPA3ORS, OPA4NCHS, OPA4PCHS, OPA4CON, OPA4ORS
  {$SET_STATE_RAM '520-56F:GPR'} 
  {$SET_STATE_RAM '570-57F:GPR'} 
  {$SET_STATE_RAM '580-580:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '58D-59F:SFR'}  // DACLD, DAC1CON0, DAC1REFL, DAC1REFH, DAC2CON0, DAC2REFL, DAC2REFH, DAC3CON0, DAC3REF, DAC4CON0, DAC4REF, DAC5CON0, DAC5REFL, DAC5REFH, DAC6CON0, DAC6REFL, DAC6REFH, DAC7CON0, DAC7REF
  {$SET_STATE_RAM '5A0-5EF:GPR'} 
  {$SET_STATE_RAM '5F0-5FF:GPR'} 
  {$SET_STATE_RAM '600-600:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '60C-61F:SFR'}  // DAC8CON0, DAC8REF, PRG4RTSS, PRG4FTSS, PRG4INS, PRG4CON0, PRG4CON1, PRG4CON2, PWM3DCL, PWM3DCH, PWM3CON, PWM4DCL, PWM4DCH, PWM4CON, PWM9DCL, PWM9DCH, PWM9CON, PWM10DCL, PWM10DCH, PWM10CON
  {$SET_STATE_RAM '620-64F:GPR'} 
  {$SET_STATE_RAM '670-67F:GPR'} 
  {$SET_STATE_RAM '680-680:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '68D-69F:SFR'}  // COG1PHR, COG1PHF, COG1BLKR, COG1BLKF, COG1DBR, COG1DBF, COG1CON0, COG1CON1, COG1RIS0, COG1RIS1, COG1RSIM0, COG1RSIM1, COG1FIS0, COG1FIS1, COG1FSIM0, COG1FSIM1, COG1ASD0, COG1ASD1, COG1STR
  {$SET_STATE_RAM '6F0-6FF:GPR'} 
  {$SET_STATE_RAM '700-700:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '70D-71F:SFR'}  // COG2PHR, COG2PHF, COG2BLKR, COG2BLKF, COG2DBR, COG2DBF, COG2CON0, COG2CON1, COG2RIS0, COG2RIS1, COG2RSIM0, COG2RSIM1, COG2FIS0, COG2FIS1, COG2FSIM0, COG2FSIM1, COG2ASD0, COG2ASD1, COG2STR
  {$SET_STATE_RAM '770-77F:GPR'} 
  {$SET_STATE_RAM '780-780:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '78E-79F:SFR'}  // PRG1RTSS, PRG1FTSS, PRG1INS, PRG1CON0, PRG1CON1, PRG1CON2, PRG2RTSS, PRG2FTSS, PRG2INS, PRG2CON0, PRG2CON1, PRG2CON2, PRG3RTSS, PRG3FTSS, PRG3INS, PRG3CON0, PRG3CON1, PRG3CON2
  {$SET_STATE_RAM '7F0-7FF:GPR'} 
  {$SET_STATE_RAM '800-800:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '80D-81F:SFR'}  // COG3PHR, COG3PHF, COG3BLKR, COG3BLKF, COG3DBR, COG3DBF, COG3CON0, COG3CON1, COG3RIS0, COG3RIS1, COG3RSIM0, COG3RSIM1, COG3FIS0, COG3FIS1, COG3FSIM0, COG3FSIM1, COG3ASD0, COG3ASD1, COG3STR
  {$SET_STATE_RAM '870-87F:GPR'} 
  {$SET_STATE_RAM '880-880:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '88D-89F:SFR'}  // COG4PHR, COG4PHF, COG4BLKR, COG4BLKF, COG4DBR, COG4DBF, COG4CON0, COG4CON1, COG4RIS0, COG4RIS1, COG4RSIM0, COG4RSIM1, COG4FIS0, COG4FIS1, COG4FSIM0, COG4FSIM1, COG4ASD0, COG4ASD1, COG4STR
  {$SET_STATE_RAM '8F0-8FF:GPR'} 
  {$SET_STATE_RAM '900-900:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '90C-91F:SFR'}  // CM4CON0, CM4CON1, CM4NSEL, CM4PSEL, CM5CON0, CM5CON1, CM5NSEL, CM5PSEL, CM6CON0, CM6CON1, CM6NSEL, CM6PSEL, CM7CON0, CM7CON1, CM7NSEL, CM7PSEL, CM8CON0, CM8CON1, CM8NSEL, CM8PSEL

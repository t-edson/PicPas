...
var
  ...
  PIR4_PSMC3SIF        : bit  absolute PIR4.3;
  PIR4_PSMC2SIF        : bit  absolute PIR4.2;
  PIR4_PSMC1SIF        : bit  absolute PIR4.1;
  ...
  PIE4_PSMC3SIE        : bit  absolute PIE4.3;
  PIE4_PSMC2SIE        : bit  absolute PIE4.2;
  PIE4_PSMC1SIE        : bit  absolute PIE4.1;
  ...
  ANSELB_ANSB6         : bit  absolute ANSELB.7;
  ANSELB_ANSB5         : bit  absolute ANSELB.6;
  ANSELB_ANSB4         : bit  absolute ANSELB.5;
  ANSELB_ANSB3         : bit  absolute ANSELB.4;
  ANSELB_ANSB2         : bit  absolute ANSELB.3;
  ANSELB_ANSB1         : bit  absolute ANSELB.2;
  ANSELB_ANSB0         : bit  absolute ANSELB.1;
  ...
  ODCOND_ODCOND7       : bit  absolute ODCOND.7;
  ODCOND_ODCOND6       : bit  absolute ODCOND.6;
  ODCOND_ODCOND5       : bit  absolute ODCOND.5;
  ODCOND_ODCOND4       : bit  absolute ODCOND.4;
  ODCOND_ODCOND3       : bit  absolute ODCOND.3;
  ODCOND_ODCOND2       : bit  absolute ODCOND.2;
  ODCOND_ODCOND1       : bit  absolute ODCOND.1;
  ODCOND_ODCOND0       : bit  absolute ODCOND.0;
  ODCONE               : byte absolute $0290;
  ODCONE_ODCONE2       : bit  absolute ODCONE.2;
  ODCONE_ODCONE1       : bit  absolute ODCONE.1;
  ODCONE_ODCONE0       : bit  absolute ODCONE.0;
  ...
  SLRCOND_SLRCOND7     : bit  absolute SLRCOND.7;
  SLRCOND_SLRCOND6     : bit  absolute SLRCOND.6;
  SLRCOND_SLRCOND5     : bit  absolute SLRCOND.5;
  SLRCOND_SLRCOND4     : bit  absolute SLRCOND.4;
  SLRCOND_SLRCOND3     : bit  absolute SLRCOND.3;
  SLRCOND_SLRCOND2     : bit  absolute SLRCOND.2;
  SLRCOND_SLRCOND1     : bit  absolute SLRCOND.1;
  SLRCOND_SLRCOND0     : bit  absolute SLRCOND.0;
  SLRCONE              : byte absolute $0310;
  SLRCONE_SLRCONE2     : bit  absolute SLRCONE.3;
  SLRCONE_SLRCONE1     : bit  absolute SLRCONE.2;
  SLRCONE_SLRCONE0     : bit  absolute SLRCONE.1;
  ...
  OPA1CON_OPA1PCH1     : bit  absolute OPA1CON.2;
  OPA1CON_OPA1PCH0     : bit  absolute OPA1CON.1;
  OPA2CON              : byte absolute $0513;
  OPA2CON_OPA2PCH1     : bit  absolute OPA2CON.2;
  OPA2CON_OPA2PCH0     : bit  absolute OPA2CON.1;
  OPA3CON              : byte absolute $0515;
  OPA3CON_OPA3PCH1     : bit  absolute OPA3CON.2;
  OPA3CON_OPA3PCH0     : bit  absolute OPA3CON.1;
  ...
  PSMC1SYNC_P1POFST    : bit  absolute PSMC1SYNC.6;
  PSMC1SYNC_P1PRPOL    : bit  absolute PSMC1SYNC.5;
  PSMC1SYNC_P1DCPOL    : bit  absolute PSMC1SYNC.4;
  PSMC1SYNC_P1SYNC2    : bit  absolute PSMC1SYNC.3;
  PSMC1SYNC_P1SYNC1    : bit  absolute PSMC1SYNC.2;
  PSMC1SYNC_P1SYNC0    : bit  absolute PSMC1SYNC.1;
  PSMC1CLK             : byte absolute $0814;
  PSMC1CLK_P1CPRE1     : bit  absolute PSMC1CLK.5;
  PSMC1CLK_P1CPRE0     : bit  absolute PSMC1CLK.4;
  PSMC1CLK_P1CSRC1     : bit  absolute PSMC1CLK.3;
  PSMC1CLK_P1CSRC0     : bit  absolute PSMC1CLK.2;
  ...
  PSMC1BLNK_P1REBM1    : bit  absolute PSMC1BLNK.3;
  PSMC1BLNK_P1REBM0    : bit  absolute PSMC1BLNK.2;
  PSMC1REBS            : byte absolute $0818;
  PSMC1REBS_P1REBSIN   : bit  absolute PSMC1REBS.5;
  ...
  PSMC1FEBS_P1FEBSIN   : bit  absolute PSMC1FEBS.5;
  ...
  PSMC1PHS_P1PHSIN     : bit  absolute PSMC1PHS.6;
  PSMC1PHS_P1PHSC4     : bit  absolute PSMC1PHS.5;
  PSMC1PHS_P1PHSC3     : bit  absolute PSMC1PHS.4;
  PSMC1PHS_P1PHSC2     : bit  absolute PSMC1PHS.3;
  PSMC1PHS_P1PHSC1     : bit  absolute PSMC1PHS.2;
  PSMC1PHS_P1PHST      : bit  absolute PSMC1PHS.1;
  PSMC1DCS             : byte absolute $081B;
  PSMC1DCS_P1DCSIN     : bit  absolute PSMC1DCS.6;
  PSMC1DCS_P1DCSC4     : bit  absolute PSMC1DCS.5;
  PSMC1DCS_P1DCSC3     : bit  absolute PSMC1DCS.4;
  PSMC1DCS_P1DCSC2     : bit  absolute PSMC1DCS.3;
  PSMC1DCS_P1DCSC1     : bit  absolute PSMC1DCS.2;
  PSMC1DCS_P1DCST      : bit  absolute PSMC1DCS.1;
  PSMC1PRS             : byte absolute $081C;
  PSMC1PRS_P1PRSIN     : bit  absolute PSMC1PRS.6;
  PSMC1PRS_P1PRSC4     : bit  absolute PSMC1PRS.5;
  PSMC1PRS_P1PRSC3     : bit  absolute PSMC1PRS.4;
  PSMC1PRS_P1PRSC2     : bit  absolute PSMC1PRS.3;
  PSMC1PRS_P1PRSC1     : bit  absolute PSMC1PRS.2;
  PSMC1PRS_P1PRST      : bit  absolute PSMC1PRS.1;
  ...
  PSMC1ASDC_P1ASDOV    : bit  absolute PSMC1ASDC.4;
  ...
  PSMC1ASDS_P1ASDSIN   : bit  absolute PSMC1ASDS.5;
  ...
  PSMC1STR1_P1LSMEN    : bit  absolute PSMC1STR1.6;
  PSMC1STR1_P1HSMEN    : bit  absolute PSMC1STR1.5;
  ...
  PSMC2SYNC_P2POFST    : bit  absolute PSMC2SYNC.6;
  PSMC2SYNC_P2PRPOL    : bit  absolute PSMC2SYNC.5;
  PSMC2SYNC_P2DCPOL    : bit  absolute PSMC2SYNC.4;
  PSMC2SYNC_P2SYNC2    : bit  absolute PSMC2SYNC.3;
  PSMC2SYNC_P2SYNC1    : bit  absolute PSMC2SYNC.2;
  PSMC2SYNC_P2SYNC0    : bit  absolute PSMC2SYNC.1;
  PSMC2CLK             : byte absolute $0834;
  PSMC2CLK_P2CPRE1     : bit  absolute PSMC2CLK.5;
  PSMC2CLK_P2CPRE0     : bit  absolute PSMC2CLK.4;
  PSMC2CLK_P2CSRC1     : bit  absolute PSMC2CLK.3;
  PSMC2CLK_P2CSRC0     : bit  absolute PSMC2CLK.2;
  PSMC2OEN             : byte absolute $0835;
  PSMC2OEN_P2OEB       : bit  absolute PSMC2OEN.2;
  PSMC2OEN_P2OEA       : bit  absolute PSMC2OEN.1;
  PSMC2POL             : byte absolute $0836;
  PSMC2POL_P2INPOL     : bit  absolute PSMC2POL.3;
  PSMC2POL_P2POLB      : bit  absolute PSMC2POL.2;
  PSMC2POL_P2POLA      : bit  absolute PSMC2POL.1;
  PSMC2BLNK            : byte absolute $0837;
  PSMC2BLNK_P2FEBM1    : bit  absolute PSMC2BLNK.5;
  PSMC2BLNK_P2FEBM0    : bit  absolute PSMC2BLNK.4;
  PSMC2BLNK_P2REBM1    : bit  absolute PSMC2BLNK.3;
  PSMC2BLNK_P2REBM0    : bit  absolute PSMC2BLNK.2;
  PSMC2REBS            : byte absolute $0838;
  PSMC2REBS_P2REBSIN   : bit  absolute PSMC2REBS.5;
  ...
  PSMC2FEBS_P2FEBSIN   : bit  absolute PSMC2FEBS.5;
  ...
  PSMC2PHS_P2PHSIN     : bit  absolute PSMC2PHS.6;
  PSMC2PHS_P2PHSC4     : bit  absolute PSMC2PHS.5;
  PSMC2PHS_P2PHSC3     : bit  absolute PSMC2PHS.4;
  PSMC2PHS_P2PHSC2     : bit  absolute PSMC2PHS.3;
  PSMC2PHS_P2PHSC1     : bit  absolute PSMC2PHS.2;
  PSMC2PHS_P2PHST      : bit  absolute PSMC2PHS.1;
  PSMC2DCS             : byte absolute $083B;
  PSMC2DCS_P2DCSIN     : bit  absolute PSMC2DCS.6;
  PSMC2DCS_P2DCSC4     : bit  absolute PSMC2DCS.5;
  PSMC2DCS_P2DCSC3     : bit  absolute PSMC2DCS.4;
  PSMC2DCS_P2DCSC2     : bit  absolute PSMC2DCS.3;
  PSMC2DCS_P2DCSC1     : bit  absolute PSMC2DCS.2;
  PSMC2DCS_P2DCST      : bit  absolute PSMC2DCS.1;
  PSMC2PRS             : byte absolute $083C;
  PSMC2PRS_P2PRSIN     : bit  absolute PSMC2PRS.6;
  PSMC2PRS_P2PRSC4     : bit  absolute PSMC2PRS.5;
  PSMC2PRS_P2PRSC3     : bit  absolute PSMC2PRS.4;
  PSMC2PRS_P2PRSC2     : bit  absolute PSMC2PRS.3;
  PSMC2PRS_P2PRSC1     : bit  absolute PSMC2PRS.2;
  PSMC2PRS_P2PRST      : bit  absolute PSMC2PRS.1;
  ...
  PSMC2ASDC_P2ASDOV    : bit  absolute PSMC2ASDC.4;
  PSMC2ASDL            : byte absolute $083E;
  PSMC2ASDL_P2ASDLB    : bit  absolute PSMC2ASDL.2;
  PSMC2ASDL_P2ASDLA    : bit  absolute PSMC2ASDL.1;
  PSMC2ASDS            : byte absolute $083F;
  PSMC2ASDS_P2ASDSIN   : bit  absolute PSMC2ASDS.5;
  ...
  PSMC2STR0_P2STRB     : bit  absolute PSMC2STR0.2;
  PSMC2STR0_P2STRA     : bit  absolute PSMC2STR0.1;
  PSMC2STR1            : byte absolute $084F;
  PSMC2STR1_P2SSYNC    : bit  absolute PSMC2STR1.7;
  PSMC2STR1_P2LSMEN    : bit  absolute PSMC2STR1.6;
  PSMC2STR1_P2HSMEN    : bit  absolute PSMC2STR1.5;
  PSMC3CON             : byte absolute $0851;
  ...
  PSMC3SYNC            : byte absolute $0853;
  PSMC3SYNC_P3POFST    : bit  absolute PSMC3SYNC.6;
  PSMC3SYNC_P3PRPOL    : bit  absolute PSMC3SYNC.5;
  PSMC3SYNC_P3DCPOL    : bit  absolute PSMC3SYNC.4;
  PSMC3SYNC_P3SYNC2    : bit  absolute PSMC3SYNC.3;
  PSMC3SYNC_P3SYNC1    : bit  absolute PSMC3SYNC.2;
  PSMC3SYNC_P3SYNC0    : bit  absolute PSMC3SYNC.1;
  PSMC3CLK             : byte absolute $0854;
  PSMC3CLK_P3CPRE1     : bit  absolute PSMC3CLK.5;
  PSMC3CLK_P3CPRE0     : bit  absolute PSMC3CLK.4;
  PSMC3CLK_P3CSRC1     : bit  absolute PSMC3CLK.3;
  PSMC3CLK_P3CSRC0     : bit  absolute PSMC3CLK.2;
  PSMC3OEN             : byte absolute $0855;
  PSMC3OEN_P3OEF       : bit  absolute PSMC3OEN.5;
  PSMC3OEN_P3OEE       : bit  absolute PSMC3OEN.4;
  PSMC3OEN_P3OED       : bit  absolute PSMC3OEN.3;
  PSMC3OEN_P3OEC       : bit  absolute PSMC3OEN.2;
  PSMC3OEN_P3OEB       : bit  absolute PSMC3OEN.1;
  PSMC3OEN_P3OEA       : bit  absolute PSMC3OEN.0;
  PSMC3POL             : byte absolute $0856;
  PSMC3POL_P3INPOL     : bit  absolute PSMC3POL.6;
  PSMC3POL_P3POLF      : bit  absolute PSMC3POL.5;
  PSMC3POL_P3POLE      : bit  absolute PSMC3POL.4;
  PSMC3POL_P3POLD      : bit  absolute PSMC3POL.3;
  PSMC3POL_P3POLC      : bit  absolute PSMC3POL.2;
  PSMC3POL_P3POLB      : bit  absolute PSMC3POL.1;
  PSMC3POL_P3POLA      : bit  absolute PSMC3POL.0;
  PSMC3BLNK            : byte absolute $0857;
  PSMC3BLNK_P3FEBM1    : bit  absolute PSMC3BLNK.5;
  PSMC3BLNK_P3FEBM0    : bit  absolute PSMC3BLNK.4;
  PSMC3BLNK_P3REBM1    : bit  absolute PSMC3BLNK.3;
  PSMC3BLNK_P3REBM0    : bit  absolute PSMC3BLNK.2;
  PSMC3REBS            : byte absolute $0858;
  PSMC3REBS_P3REBSIN   : bit  absolute PSMC3REBS.5;
  ...
  PSMC3FEBS            : byte absolute $0859;
  PSMC3FEBS_P3FEBSIN   : bit  absolute PSMC3FEBS.5;
  ...
  PSMC3PHS             : byte absolute $085A;
  PSMC3PHS_P3PHSIN     : bit  absolute PSMC3PHS.6;
  PSMC3PHS_P3PHSC4     : bit  absolute PSMC3PHS.5;
  PSMC3PHS_P3PHSC3     : bit  absolute PSMC3PHS.4;
  PSMC3PHS_P3PHSC2     : bit  absolute PSMC3PHS.3;
  PSMC3PHS_P3PHSC1     : bit  absolute PSMC3PHS.2;
  PSMC3PHS_P3PHST      : bit  absolute PSMC3PHS.1;
  PSMC3DCS             : byte absolute $085B;
  PSMC3DCS_P3DCSIN     : bit  absolute PSMC3DCS.6;
  PSMC3DCS_P3DCSC4     : bit  absolute PSMC3DCS.5;
  PSMC3DCS_P3DCSC3     : bit  absolute PSMC3DCS.4;
  PSMC3DCS_P3DCSC2     : bit  absolute PSMC3DCS.3;
  PSMC3DCS_P3DCSC1     : bit  absolute PSMC3DCS.2;
  PSMC3DCS_P3DCST      : bit  absolute PSMC3DCS.1;
  PSMC3PRS             : byte absolute $085C;
  PSMC3PRS_P3PRSIN     : bit  absolute PSMC3PRS.6;
  PSMC3PRS_P3PRSC4     : bit  absolute PSMC3PRS.5;
  PSMC3PRS_P3PRSC3     : bit  absolute PSMC3PRS.4;
  PSMC3PRS_P3PRSC2     : bit  absolute PSMC3PRS.3;
  PSMC3PRS_P3PRSC1     : bit  absolute PSMC3PRS.2;
  PSMC3PRS_P3PRST      : bit  absolute PSMC3PRS.1;
  PSMC3ASDC            : byte absolute $085D;
  ...
  PSMC3ASDC_P3ASDOV    : bit  absolute PSMC3ASDC.4;
  PSMC3ASDL            : byte absolute $085E;
  PSMC3ASDL_P3ASDLF    : bit  absolute PSMC3ASDL.5;
  PSMC3ASDL_P3ASDLE    : bit  absolute PSMC3ASDL.4;
  PSMC3ASDL_P3ASDLD    : bit  absolute PSMC3ASDL.3;
  PSMC3ASDL_P3ASDLC    : bit  absolute PSMC3ASDL.2;
  PSMC3ASDL_P3ASDLB    : bit  absolute PSMC3ASDL.1;
  PSMC3ASDL_P3ASDLA    : bit  absolute PSMC3ASDL.0;
  PSMC3ASDS            : byte absolute $085F;
  PSMC3ASDS_P3ASDSIN   : bit  absolute PSMC3ASDS.5;
  ...
  PSMC3STR0            : byte absolute $086E;
  PSMC3STR0_P3STRF     : bit  absolute PSMC3STR0.5;
  PSMC3STR0_P3STRE     : bit  absolute PSMC3STR0.4;
  PSMC3STR0_P3STRD     : bit  absolute PSMC3STR0.3;
  PSMC3STR0_P3STRC     : bit  absolute PSMC3STR0.2;
  PSMC3STR0_P3STRB     : bit  absolute PSMC3STR0.1;
  PSMC3STR0_P3STRA     : bit  absolute PSMC3STR0.0;
  PSMC3STR1            : byte absolute $086F;
  PSMC3STR1_P3SSYNC    : bit  absolute PSMC3STR1.7;
  PSMC3STR1_P3LSMEN    : bit  absolute PSMC3STR1.6;
  PSMC3STR1_P3HSMEN    : bit  absolute PSMC3STR1.5;
  ...
  {$SET_STATE_RAM '000-01C:SFR'}  // INDF0, INDF1, PCL, STATUS, FSR0L, FSR0H, FSR1L, FSR1H, BSR, WREG, PCLATH, INTCON, PORTA, PORTB, PORTC, PORTD, PORTE, PIR1, PIR2, PIR3, PIR4, TMR0, TMR1L, TMR1H, T1CON, T1GCON, TMR2, PR2, T2CON
  {$SET_STATE_RAM '020-06F:GPR'} 
  {$SET_STATE_RAM '070-07F:GPR'} 
  {$SET_STATE_RAM '080-080:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '08C-09F:SFR'}  // TRISA, TRISB, TRISC, TRISD, TRISE, PIE1, PIE2, PIE3, PIE4, OPTION_REG, PCON, WDTCON, OSCTUNE, OSCCON, OSCSTAT, ADRESL, ADRESH, ADCON0, ADCON1, ADCON2
  {$SET_STATE_RAM '0A0-0EF:GPR'} 
  {$SET_STATE_RAM '0F0-0FF:GPR'} 
  {$SET_STATE_RAM '100-100:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '10C-11F:SFR'}  // LATA, LATB, LATC, LATD, LATE, CM1CON0, CM1CON1, CM2CON0, CM2CON1, CMOUT, BORCON, FVRCON, DACCON0, DACCON1, CM4CON0, CM4CON1, APFCON2, APFCON1, CM3CON0, CM3CON1
  ...
  {$SET_STATE_RAM '18F-197:SFR'}  // ANSELD, ANSELE, EEADRL, EEADRH, EEDATL, EEDATH, EECON1, EECON2, VREGCON
  ...
  {$SET_STATE_RAM '28C-293:SFR'}  // ODCONA, ODCONB, ODCONC, ODCOND, ODCONE, CCPR1L, CCPR1H, CCP1CON
  ...
  {$SET_STATE_RAM '30C-313:SFR'}  // SLRCONA, SLRCONB, SLRCONC, SLRCOND, SLRCONE, CCPR3L, CCPR3H, CCP3CON
  {$SET_STATE_RAM '320-32F:GPR'} 
  {$SET_STATE_RAM '370-37F:GPR'} 
  {$SET_STATE_RAM '380-380:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '38C-399:SFR'}  // INLVLA, INLVLB, INLVLC, INLVLD, INLVLE, IOCAP, IOCAN, IOCAF, IOCBP, IOCBN, IOCBF, IOCCP, IOCCN, IOCCF
  ...
  {$SET_STATE_RAM '513-513:SFR'}  // OPA2CON
  {$SET_STATE_RAM '515-515:SFR'}  // OPA3CON
  {$SET_STATE_RAM '51A-51A:SFR'}  // CLKRCON
  ...
  {$SET_UNIMP_BITS '014:77'} // PIR4 bits 7,3 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '094:77'} // PIE4 bits 7,3 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '11C:01'} // APFCON2 bits 7,6,5,4,3,2,1 un-implemented (read as 0)
  {$SET_UNIMP_BITS '18C:BF'} // ANSELA bit 6 un-implemented (read as 0)
  {$SET_UNIMP_BITS '18D:7F'} // ANSELB bit 7 un-implemented (read as 0)
  {$SET_UNIMP_BITS '18F:07'} // ANSELD bits 7,6,5,4,3 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '515:C3'} // OPA3CON bits 5,4,3,2 un-implemented (read as 0)
  {$SET_UNIMP_BITS '812:EF'} // PSMC1MDL bit 4 un-implemented (read as 0)
  {$SET_UNIMP_BITS '813:E7'} // PSMC1SYNC bits 4,3 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '818:9E'} // PSMC1REBS bits 6,5,0 un-implemented (read as 0)
  {$SET_UNIMP_BITS '819:9E'} // PSMC1FEBS bits 6,5,0 un-implemented (read as 0)
  {$SET_UNIMP_BITS '81A:9F'} // PSMC1PHS bits 6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '81B:9F'} // PSMC1DCS bits 6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '81C:9F'} // PSMC1PRS bits 6,5 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '81F:9E'} // PSMC1ASDS bits 6,5,0 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '833:E7'} // PSMC2SYNC bits 4,3 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '838:9E'} // PSMC2REBS bits 6,5,0 un-implemented (read as 0)
  {$SET_UNIMP_BITS '839:9E'} // PSMC2FEBS bits 6,5,0 un-implemented (read as 0)
  {$SET_UNIMP_BITS '83A:9F'} // PSMC2PHS bits 6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '83B:9F'} // PSMC2DCS bits 6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '83C:9F'} // PSMC2PRS bits 6,5 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '83F:9E'} // PSMC2ASDS bits 6,5,0 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '852:EF'} // PSMC3MDL bit 4 un-implemented (read as 0)
  {$SET_UNIMP_BITS '853:E7'} // PSMC3SYNC bits 4,3 un-implemented (read as 0)
  {$SET_UNIMP_BITS '854:33'} // PSMC3CLK bits 7,6,3,2 un-implemented (read as 0)
  {$SET_UNIMP_BITS '855:3F'} // PSMC3OEN bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS '856:7F'} // PSMC3POL bit 7 un-implemented (read as 0)
  {$SET_UNIMP_BITS '857:33'} // PSMC3BLNK bits 7,6,3,2 un-implemented (read as 0)
  {$SET_UNIMP_BITS '858:9E'} // PSMC3REBS bits 6,5,0 un-implemented (read as 0)
  {$SET_UNIMP_BITS '859:9E'} // PSMC3FEBS bits 6,5,0 un-implemented (read as 0)
  {$SET_UNIMP_BITS '85A:9F'} // PSMC3PHS bits 6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '85B:9F'} // PSMC3DCS bits 6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '85C:9F'} // PSMC3PRS bits 6,5 un-implemented (read as 0)
  {$SET_UNIMP_BITS '85D:E1'} // PSMC3ASDC bits 4,3,2,1 un-implemented (read as 0)
  {$SET_UNIMP_BITS '85E:3F'} // PSMC3ASDL bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS '85F:9E'} // PSMC3ASDS bits 6,5,0 un-implemented (read as 0)
  {$SET_UNIMP_BITS '86D:0F'} // PSMC3FFA bits 7,6,5,4 un-implemented (read as 0)
  {$SET_UNIMP_BITS '86E:3F'} // PSMC3STR0 bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS '86F:83'} // PSMC3STR1 bits 6,5,4,3,2 un-implemented (read as 0)
  ...
  // Pin  1 : RE3/MCLR/Vpp
  // Pin  2 : RA0/AN0/C1IN0-/C2IN0-/C3IN0-/C4IN0-
  ...
  // Pin  8 : RE0/AN5/CCP3
  // Pin  9 : RE1/AN6/PSMC3B
  // Pin 10 : RE2/AN7/PSMC3A
  // Pin 11 : Vdd
  // Pin 12 : Vss
  // Pin 13 : RA7/PSMC1CLK/PSMC2CLK/PSMC3CLK/OSC1/CLKIN
  // Pin 14 : RA6/C2OUT/OSC2/CLKOUT/VCAP
  // Pin 15 : RC0/SOSCO/T1CKI/PSMC1A
  // Pin 16 : RC1/SOSCI/CCP2/PSMC1B
  // Pin 17 : RC2/CCP1/PSMC1C
  // Pin 18 : RC3/SCK/SCL/PSMC1D
  // Pin 19 : RD0/OPA3IN+
  // Pin 20 : RD1/AN21/C1IN4-/C2IN4-/C3IN4-/C4IN4-/OPA3OUT
  // Pin 21 : RD2/OPA3IN-
  // Pin 22 : RD3
  // Pin 23 : RC4/SDI/SDA/PSMC1E
  // Pin 24 : RC5/SDO/PSMC1F
  // Pin 25 : RC6/TX/CK/PSMC2A
  // Pin 26 : RC7/RX/DT/PSMC2B
  // Pin 27 : RD4/PSMC3F
  // Pin 28 : RD5/PSMC3E
  // Pin 29 : RD6/C3OUT/PSMC3D
  // Pin 30 : RD7/C4OUT/PSMC3C
  // Pin 31 : Vss
  // Pin 32 : Vdd
  // Pin 33 : RB0/AN12/C2IN1+/PSMC1IN/PSMC2IN/PSMC3IN/CCP1/INT
  // Pin 34 : RB1/AN10/C1IN3-/C2IN3-/C3IN3-/C4IN3-/OPA2OUT
  // Pin 35 : RB2/AN8/OPA2IN-/CLKR
  // Pin 36 : RB3/AN9/C1IN2-/C2IN2-/C3IN2-/OPA2IN+/CCP2
  // Pin 37 : RB4/AN11/C3IN1+
  // Pin 38 : RB5/AN13/C4IN2-/T1G/CCP3/SDO
  // Pin 39 : RB6/TX/CK/SDI/SDA/C4IN1+/ICSPCLK/ICDCLK
  // Pin 40 : RB7/SCK/RX/DT/SCL/DAC1OUT2/ICSPDAT/ICDDAT

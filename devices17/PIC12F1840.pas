...
var
  ...
  ADCON1_ADCS2        : bit  absolute ADCON1.5;
  ADCON1_ADCS1        : bit  absolute ADCON1.4;
  ADCON1_ADCS0        : bit  absolute ADCON1.3;
  ...
  CM1CON1_C1INTP      : bit  absolute CM1CON1.5;
  CM1CON1_C1INTN      : bit  absolute CM1CON1.4;
  CM1CON1_C1PCH1      : bit  absolute CM1CON1.3;
  CM1CON1_C1PCH0      : bit  absolute CM1CON1.2;
  CM1CON1_C1NCH       : bit  absolute CM1CON1.1;
  ...
  SRCON1_SRSPE        : bit  absolute SRCON1.6;
  SRCON1_SRSCKE       : bit  absolute SRCON1.5;
  SRCON1_SRSC1E       : bit  absolute SRCON1.4;
  SRCON1_SRRPE        : bit  absolute SRCON1.3;
  SRCON1_SRRCKE       : bit  absolute SRCON1.2;
  SRCON1_SRRC1E       : bit  absolute SRCON1.1;
  ...
  APFCON_P1BSEL       : bit  absolute APFCON.2;
  APFCON_CCP1SEL      : bit  absolute APFCON.1;
  ...
  {$SET_STATE_RAM '115-11B:SFR'}  // CMOUT, BORCON, FVRCON, DACCON0, DACCON1, SRCON0, SRCON1
  ...
  // Pin  6 : RA1/AN1/CPS1/Vref/C1IN0-/SRI/RX/DT/SCL/SCK/MDMIN/ICSPCLK/ICPCLK
  // Pin  7 : RA0/AN0/CPS0/C1IN+/DACOUT/TX/CK/SDO/SS/P1B/MDOUT/ICSPDAT/ICDDAT
  // Pin  8 : Vss

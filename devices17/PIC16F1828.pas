...
var
  ...
  SSP1CON             : byte absolute $0215;
  SSP1CON_WCOL        : bit  absolute SSP1CON.7;
  SSP1CON_SSPOV       : bit  absolute SSP1CON.6;
  SSP1CON_SSPEN       : bit  absolute SSP1CON.5;
  SSP1CON_CKP         : bit  absolute SSP1CON.4;
  SSP1CON_SSPM3       : bit  absolute SSP1CON.3;
  SSP1CON_SSPM2       : bit  absolute SSP1CON.2;
  SSP1CON_SSPM1       : bit  absolute SSP1CON.1;
  SSP1CON_SSPM0       : bit  absolute SSP1CON.0;
  ...
  {$SET_STATE_RAM '211-217:SFR'}  // SSP1BUF, SSP1ADD, SSP1MSK, SSP1STAT, SSP1CON, SSP1CON2, SSP1CON3
  ...
  {$SET_STATE_RAM '298-29E:SFR'}  // CCPR2L, CCPR2H, CCP2CON, PWM2CON, CCP2AS, PSTR2CON, CCPTMRS0
  ...
  // Pin  8 : RC6/AN8/CPS8/CCP4/SS
  // Pin  9 : RC7/AN9/CPS9/SDO
  // Pin 10 : RB7/CK/TX
  // Pin 11 : RB6/SCL1/SCK1
  // Pin 12 : RB5/AN11/CPS11/RX/DT

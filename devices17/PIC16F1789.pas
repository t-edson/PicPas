...
var
  ...
  DAC1CON0_DAC1EN      : bit  absolute DAC1CON0.6;
  ...
  DAC1CON0_DAC1NSS     : bit  absolute DAC1CON0.1;
  ...
  OPA3CON_OPA3PCH2     : bit  absolute OPA3CON.2;
  OPA3CON_OPA3PCH1     : bit  absolute OPA3CON.1;
  OPA3CON_OPA3PCH0     : bit  absolute OPA3CON.0;
  ...
  DAC2CON0_DAC2EN      : bit  absolute DAC2CON0.5;
  DAC2CON0_DAC2OE1     : bit  absolute DAC2CON0.4;
  DAC2CON0_DAC2OE2     : bit  absolute DAC2CON0.3;
  DAC2REF              : byte absolute $0592;
  DAC3CON0             : byte absolute $0593;
  DAC3CON0_DAC3EN      : bit  absolute DAC3CON0.5;
  DAC3CON0_DAC3OE1     : bit  absolute DAC3CON0.4;
  DAC3CON0_DAC3OE2     : bit  absolute DAC3CON0.3;
  DAC3REF              : byte absolute $0594;
  DAC4CON0             : byte absolute $0595;
  DAC4CON0_DAC4EN      : bit  absolute DAC4CON0.5;
  DAC4CON0_DAC4OE1     : bit  absolute DAC4CON0.4;
  DAC4CON0_DAC4OE2     : bit  absolute DAC4CON0.3;
  ...
  PSMC4SYNC_P4POFST    : bit  absolute PSMC4SYNC.6;
  PSMC4SYNC_P4PRPOL    : bit  absolute PSMC4SYNC.5;
  PSMC4SYNC_P4DCPOL    : bit  absolute PSMC4SYNC.4;
  PSMC4SYNC_P4SYNC2    : bit  absolute PSMC4SYNC.3;
  PSMC4SYNC_P4SYNC1    : bit  absolute PSMC4SYNC.2;
  PSMC4SYNC_P4SYNC0    : bit  absolute PSMC4SYNC.1;
  PSMC4CLK             : byte absolute $0F14;
  PSMC4CLK_P4CPRE1     : bit  absolute PSMC4CLK.5;
  PSMC4CLK_P4CPRE0     : bit  absolute PSMC4CLK.4;
  PSMC4CLK_P4CSRC1     : bit  absolute PSMC4CLK.3;
  PSMC4CLK_P4CSRC0     : bit  absolute PSMC4CLK.2;
  PSMC4OEN             : byte absolute $0F15;
  PSMC4OEN_P4OEB       : bit  absolute PSMC4OEN.2;
  PSMC4OEN_P4OEA       : bit  absolute PSMC4OEN.1;
  PSMC4POL             : byte absolute $0F16;
  PSMC4POL_P4INPOL     : bit  absolute PSMC4POL.3;
  PSMC4POL_P4POLB      : bit  absolute PSMC4POL.2;
  PSMC4POL_P4POLA      : bit  absolute PSMC4POL.1;
  PSMC4BLNK            : byte absolute $0F17;
  PSMC4BLNK_P4FEBM1    : bit  absolute PSMC4BLNK.5;
  PSMC4BLNK_P4FEBM0    : bit  absolute PSMC4BLNK.4;
  PSMC4BLNK_P4REBM1    : bit  absolute PSMC4BLNK.3;
  PSMC4BLNK_P4REBM0    : bit  absolute PSMC4BLNK.2;
  PSMC4REBS            : byte absolute $0F18;
  PSMC4REBS_P4REBSIN   : bit  absolute PSMC4REBS.5;
  ...
  PSMC4FEBS_P4FEBSIN   : bit  absolute PSMC4FEBS.5;
  ...
  PSMC4PHS_P4PHSIN     : bit  absolute PSMC4PHS.6;
  PSMC4PHS_P4PHSC4     : bit  absolute PSMC4PHS.5;
  PSMC4PHS_P4PHSC3     : bit  absolute PSMC4PHS.4;
  PSMC4PHS_P4PHSC2     : bit  absolute PSMC4PHS.3;
  PSMC4PHS_P4PHSC1     : bit  absolute PSMC4PHS.2;
  PSMC4PHS_P4PHST      : bit  absolute PSMC4PHS.1;
  PSMC4DCS             : byte absolute $0F1B;
  PSMC4DCS_P4DCSIN     : bit  absolute PSMC4DCS.6;
  PSMC4DCS_P4DCSC4     : bit  absolute PSMC4DCS.5;
  PSMC4DCS_P4DCSC3     : bit  absolute PSMC4DCS.4;
  PSMC4DCS_P4DCSC2     : bit  absolute PSMC4DCS.3;
  PSMC4DCS_P4DCSC1     : bit  absolute PSMC4DCS.2;
  PSMC4DCS_P4DCST      : bit  absolute PSMC4DCS.1;
  PSMC4PRS             : byte absolute $0F1C;
  PSMC4PRS_P4PRSIN     : bit  absolute PSMC4PRS.6;
  PSMC4PRS_P4PRSC4     : bit  absolute PSMC4PRS.5;
  PSMC4PRS_P4PRSC3     : bit  absolute PSMC4PRS.4;
  PSMC4PRS_P4PRSC2     : bit  absolute PSMC4PRS.3;
  PSMC4PRS_P4PRSC1     : bit  absolute PSMC4PRS.2;
  PSMC4PRS_P4PRST      : bit  absolute PSMC4PRS.1;
  ...
  PSMC4ASDC_P4ASDOV    : bit  absolute PSMC4ASDC.4;
  PSMC4ASDL            : byte absolute $0F1E;
  PSMC4ASDL_P4ASDLB    : bit  absolute PSMC4ASDL.2;
  PSMC4ASDL_P4ASDLA    : bit  absolute PSMC4ASDL.1;
  PSMC4ASDS            : byte absolute $0F1F;
  PSMC4ASDS_P4ASDSIN   : bit  absolute PSMC4ASDS.5;
  ...
  PSMC4STR0_P4STRB     : bit  absolute PSMC4STR0.2;
  PSMC4STR0_P4STRA     : bit  absolute PSMC4STR0.1;
  PSMC4STR1            : byte absolute $0F2F;
  PSMC4STR1_P4SSYNC    : bit  absolute PSMC4STR1.7;
  PSMC4STR1_P4LSMEN    : bit  absolute PSMC4STR1.6;
  PSMC4STR1_P4HSMEN    : bit  absolute PSMC4STR1.5;
  ...
  {$SET_STATE_RAM '10C-11F:SFR'}  // LATA, LATB, LATC, LATD, LATE, CM1CON0, CM1CON1, CM2CON0, CM2CON1, CMOUT, BORCON, FVRCON, DAC1CON0, DAC1CON1, CM4CON0, CM4CON1, APFCON2, APFCON1, CM3CON0, CM3CON1
  {$SET_STATE_RAM '120-16F:GPR'} 
  {$SET_STATE_RAM '170-17F:GPR'} 
  {$SET_STATE_RAM '180-180:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '18C-197:SFR'}  // ANSELA, ANSELB, ANSELC, ANSELD, ANSELE, EEADRL, EEADRH, EEDATL, EEDATH, EECON1, EECON2, VREGCON
  ...
  {$SET_STATE_RAM '591-596:SFR'}  // DAC2CON0, DAC2REF, DAC3CON0, DAC3REF, DAC4CON0, DAC4REF
  ...
  {$SET_UNIMP_BITS '515:C7'} // OPA3CON bits 5,4,3 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS 'ED5:3F'} // PSMC3OEN bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS 'ED6:7F'} // PSMC3POL bit 7 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS 'EDE:3F'} // PSMC3ASDL bits 7,6 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS 'EEE:3F'} // PSMC3STR0 bits 7,6 un-implemented (read as 0)
  ...
  // Pin  5 : RA3/AN3/Vref+/C1IN1+/DAC1Vref+/DAC2Vref+/DAC3Vref+/DAC4Vref+
  // Pin  6 : RA4/C1OUT/OPA1IN+/T0CKI
  // Pin  7 : RA5/AN4/C2OUT/OPA1IN-/SS/DAC2OUT1
  // Pin  8 : RE0/AN5/CCP3/PSMC4B
  // Pin  9 : RE1/AN6/PSMC3B
  // Pin 10 : RE2/AN7/PSMC3A
  // Pin 11 : Vdd
  // Pin 12 : Vss
  // Pin 13 : RA7/Vref+/PSMC1CLK/PSMC2CLK/PSMC3CLK/PSMC4CLK/OSC1/CLKIN
  // Pin 14 : RA6/C2OUT/OSC2/CLKOUT/VCAP
  // Pin 15 : RC0/SOSCO/T1CKI/PSMC1A
  // Pin 16 : RC1/SOSCI/PSMC1B/CCP2
  // Pin 17 : RC2/PSMC1C/CCP1
  // Pin 18 : RC3/PSMC1D/SCK/SCL
  // Pin 19 : RD0/OPA3IN+
  // Pin 20 : RD1/AN21/C1IN4-/C2IN4-/C3IN4-/C4IN4-/OPA3OUT
  // Pin 21 : RD2/OPA3IN-/DAC4OUT1
  // Pin 22 : RD3/PSMC4A
  // Pin 23 : RC4/PSMC1E/SDI/SDA
  // Pin 24 : RC5/PSMC1F/SDO
  // Pin 25 : RC6/PSMC2A/TX/CK
  // Pin 26 : RC7/PSMC2B/RX/DT
  // Pin 27 : RD4/PSMC3F
  // Pin 28 : RD5/PSMC3E
  // Pin 29 : RD6/PSMC3D/C3OUT
  // Pin 30 : RD7/PSMC3C/C4OUT
  // Pin 31 : Vss
  // Pin 32 : Vdd
  // Pin 33 : RB0/AN12/C2IN1+/PSMC1IN/PSMC2IN/PSMC3IN/PSMC4IN/CCP1/INT
  // Pin 34 : RB1/AN10/C1IN3-/C2IN3-/C3IN3-/C4IN3-/OPA2OUT
  // Pin 35 : RB2/AN8/OPA2IN-/CLKR/DAC3OUT1
  // Pin 36 : RB3/AN9/C1IN2-/C2IN2-/C3IN2-/OPA2IN+/CCP2
  // Pin 37 : RB4/AN11/C3IN1+/SS
  // Pin 38 : RB5/AN13/T1G/SDO/CCP3/C4IN2-
  // Pin 39 : RB6/TX/CK/SDI/SDA/C4IN1+/ICSPCLK/ICDCLK
  // Pin 40 : RB7/DAC1OUT2/DAC2OUT2/DAC3OUT2/DAC4OUT2/RX/DT/SCK/SCL/ICSPDAT/ICDDAT

...
var
  ...
  PIR5_CCP7IF          : bit  absolute PIR5.5;
  PIR5_COG3IF          : bit  absolute PIR5.4;
  PIR5_C6IF            : bit  absolute PIR5.3;
  PIR5_C5IF            : bit  absolute PIR5.2;
  PIR6                 : byte absolute $0016;
  PIR6_PWM11IF         : bit  absolute PIR6.5;
  PIR6_PWM6IF          : bit  absolute PIR6.4;
  PIR6_PWM5IF          : bit  absolute PIR6.3;
  ...
  PIE5_CCP7IE          : bit  absolute PIE5.5;
  PIE5_COG3IE          : bit  absolute PIE5.4;
  PIE5_C6IE            : bit  absolute PIE5.3;
  PIE5_C5IE            : bit  absolute PIE5.2;
  ...
  PRG1RTSS_RTSS3       : bit  absolute PRG1RTSS.4;
  PRG1RTSS_RTSS2       : bit  absolute PRG1RTSS.3;
  PRG1RTSS_RTSS1       : bit  absolute PRG1RTSS.2;
  PRG1RTSS_RTSS0       : bit  absolute PRG1RTSS.1;
  PRG1FTSS             : byte absolute $078F;
  PRG1FTSS_FTSS3       : bit  absolute PRG1FTSS.4;
  PRG1FTSS_FTSS2       : bit  absolute PRG1FTSS.3;
  PRG1FTSS_FTSS1       : bit  absolute PRG1FTSS.2;
  PRG1FTSS_FTSS0       : bit  absolute PRG1FTSS.1;
  PRG1INS              : byte absolute $0790;
  PRG1INS_INS3         : bit  absolute PRG1INS.4;
  PRG1INS_INS2         : bit  absolute PRG1INS.3;
  PRG1INS_INS1         : bit  absolute PRG1INS.2;
  PRG1INS_INS0         : bit  absolute PRG1INS.1;
  PRG1CON0             : byte absolute $0791;
  PRG1CON0_FEDG        : bit  absolute PRG1CON0.6;
  PRG1CON0_REDG        : bit  absolute PRG1CON0.5;
  PRG1CON0_OS          : bit  absolute PRG1CON0.2;
  ...
  PWMEN_MPWM11EN       : bit  absolute PWMEN.3;
  PWMEN_MPWM6EN        : bit  absolute PWMEN.2;
  PWMEN_MPWM5EN        : bit  absolute PWMEN.1;
  PWMLD                : byte absolute $0D8F;
  PWMLD_MPWM11LD       : bit  absolute PWMLD.3;
  PWMLD_MPWM6LD        : bit  absolute PWMLD.2;
  PWMLD_MPWM5LD        : bit  absolute PWMLD.1;
  PWMOUT               : byte absolute $0D90;
  PWMOUT_MPWM11OUT     : bit  absolute PWMOUT.3;
  PWMOUT_MPWM6OUT      : bit  absolute PWMOUT.2;
  PWMOUT_MPWM5OUT      : bit  absolute PWMOUT.1;
  ...
  {$SET_STATE_RAM '010-01F:SFR'}  // PORTE, PIR1, PIR2, PIR3, PIR4, PIR5, PIR6, TMR0, TMR1L, TMR1H, T1CON, T1GCON, TMR3L, TMR3H, T3CON, T3GCON
  ...
  {$SET_STATE_RAM '090-09F:SFR'}  // TRISE, PIE1, PIE2, PIE3, PIE4, PIE5, PIE6, OPTION_REG, PCON, WDTCON, OSCTUNE, OSCCON, OSCSTAT, BORCON, FVRCON, ZCD1CON
  ...
  {$SET_STATE_RAM '111-11D:SFR'}  // CMOUT, CM1CON0, CM1CON1, CM1NSEL, CM1PSEL, CM2CON0, CM2CON1, CM2NSEL, CM2PSEL, CM3CON0, CM3CON1, CM3NSEL, CM3PSEL
  ...
  {$SET_STATE_RAM '210-217:SFR'}  // WPUE, SSP1BUF, SSP1ADD, SSP1MSK, SSP1STAT, SSP1CON1, SSP1CON2, SSP1CON3
  ...
  {$SET_STATE_RAM '291-29C:SFR'}  // CCPR1L, CCPR1H, CCP1CON, CCP1CAP, CCPR2L, CCPR2H, CCP2CON, CCP2CAP, CCPR7L, CCPR7H, CCP7CON, CCP7CAP
  ...
  {$SET_STATE_RAM '315-319:SFR'}  // MD1CON0, MD1CON1, MD1SRC, MD1CARL, MD1CARH
  ...
  {$SET_STATE_RAM '390-399:SFR'}  // INLVE, IOCAP, IOCAN, IOCAF, IOCBP, IOCBN, IOCBF, IOCCP, IOCCN, IOCCF
  ...
  {$SET_STATE_RAM '50F-51A:SFR'}  // OPA1NCHS, OPA1PCHS, OPA1CON, OPA1ORS, OPA2NCHS, OPA2PCHS, OPA2CON, OPA2ORS, OPA3NCHS, OPA3PCHS, OPA3CON, OPA3ORS
  {$SET_STATE_RAM '520-56F:GPR'} 
  {$SET_STATE_RAM '570-57F:GPR'} 
  {$SET_STATE_RAM '580-580:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '58D-59A:SFR'}  // DACLD, DAC1CON0, DAC1REFL, DAC1REFH, DAC2CON0, DAC2REFL, DAC2REFH, DAC3CON0, DAC3REF, DAC4CON0, DAC4REF, DAC5CON0, DAC5REFL, DAC5REFH
  {$SET_STATE_RAM '59E-59F:SFR'}  // DAC7CON0, DAC7REF
  {$SET_STATE_RAM '5A0-5EF:GPR'} 
  {$SET_STATE_RAM '5F0-5FF:GPR'} 
  {$SET_STATE_RAM '600-600:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '614-61C:SFR'}  // PWM3DCL, PWM3DCH, PWM3CON, PWM4DCL, PWM4DCH, PWM4CON, PWM9DCL, PWM9DCH, PWM9CON
  ...
  {$SET_STATE_RAM '90C-917:SFR'}  // CM4CON0, CM4CON1, CM4NSEL, CM4PSEL, CM5CON0, CM5CON1, CM5NSEL, CM5PSEL, CM6CON0, CM6CON1, CM6NSEL, CM6PSEL
  ...
  {$SET_STATE_RAM 'D8E-DC0:SFR'}  // PWMEN, PWMLD, PWMOUT, PWM5PHL, PWM5PHH, PWM5DCL, PWM5DCH, PWM5PRL, PWM5PRH, PWM5OFL, PWM5OFH, PWM5TMRL, PWM5TMRH, PWM5CON, PWM5INTE, PWM5INTF, PWM5CLKCON, PWM5LDCON, PWM5OFCON, PWM6PHL, PWM6PHH, PWM6DCL, PWM6DCH, PWM6PRL, PWM6PRH, PWM6OFL, PWM6OFH, PWM6TMRL, PWM6TMRH, PWM6CON, PWM6INTE, PWM6INTF, PWM6CLKCON, PWM6LDCON, PWM6OFCON, PWM11PHL, PWM11PHH, PWM11DCL, PWM11DCH, PWM11PRL, PWM11PRH, PWM11OFL, PWM11OFH, PWM11TMRL, PWM11TMRH, PWM11CON, PWM11INTE, PWM11INTF, PWM11CLKCON, PWM11LDCON, PWM11OFCON
  {$SET_STATE_RAM 'DF0-DFF:GPR'} 
  {$SET_STATE_RAM 'E00-E00:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM 'E0C-E1B:SFR'}  // PPSLOCK, INTPPS, T0CKIPPS, T1CKIPPS, T1GPPS, T3CKIPPS, T3GPPS, T5CKIPPS, T5GPPS, T2INPPS, T4INPPS, T6INPPS, T8INPPS, CCP1PPS, CCP2PPS, CCP7PPS
  {$SET_STATE_RAM 'E1D-E1F:SFR'}  // COG1INPPS, COG2INPPS, COG3INPPS
  {$SET_STATE_RAM 'E21-E29:SFR'}  // MD1CLPPS, MD1CHPPS, MD1MODPPS, MD2CLPPS, MD2CHPPS, MD2MODPPS, MD3CLPPS, MD3CHPPS, MD3MODPPS
  {$SET_STATE_RAM 'E2D-E32:SFR'}  // PRG1RPPS, PRG1FPPS, PRG2RPPS, PRG2FPPS, PRG3RPPS, PRG3FPPS
  {$SET_STATE_RAM 'E35-E3E:SFR'}  // CLCIN0PPS, CLCIN1PPS, CLCIN2PPS, CLCIN3PPS, ADCACTPPS, SSPCLKPPS, SSPDATPPS, SSPSSPPS, RXPPS, CKPPS
  {$SET_STATE_RAM 'E70-E7F:GPR'} 
  {$SET_STATE_RAM 'E80-E80:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM 'E90-EA7:SFR'}  // RA0PPS, RA1PPS, RA2PPS, RA3PPS, RA4PPS, RA5PPS, RA6PPS, RA7PPS, RB0PPS, RB1PPS, RB2PPS, RB3PPS, RB4PPS, RB5PPS, RB6PPS, RB7PPS, RC0PPS, RC1PPS, RC2PPS, RC3PPS, RC4PPS, RC5PPS, RC6PPS, RC7PPS
  ...
  {$SET_UNIMP_BITS '015:53'} // PIR5 bits 7,5,3,2 un-implemented (read as 0)
  {$SET_UNIMP_BITS '016:07'} // PIR6 bits 7,6,5,4,3 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '095:53'} // PIE5 bits 7,5,3,2 un-implemented (read as 0)
  {$SET_UNIMP_BITS '096:07'} // PIE6 bits 7,6,5,4,3 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '111:3F'} // CMOUT bits 7,6 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '29E:3F'} // CCPTMRS1 bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS '29F:3F'} // CCPTMRS2 bits 7,6 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '390:08'} // INLVE bits 7,6,5,4,2,1,0 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '58D:13'} // DACLD bits 7,6,5,3,2 un-implemented (read as 0)
  ...
  // Pin  1 : AN0/C1IN0-/C2IN0-/C3IN0-/C4IN0-/C5IN0-/C6IN0-/IOCA0/RA0
  // Pin  2 : VPP/MCLR_n/ICD_n/IOCE3/RE3
  // Pin  3 : OPA1OUT/PRG1IN0/PRG2IN1/OPA2IN1+/OPA2IN1-/AN1/C1IN1-/C2IN1-/C3IN1-/C4IN1-/IOCA1/RA1
  // Pin  4 : DAC1OUT1/DAC1REF0-/DAC2REF0-/DAC3REF0-/DAC4REF0-/DAC5REF0-/DAC7REF0-/VREF-/AN2/C1IN0+/C2IN0+/C3IN0+/C4IN0+/C5IN0+/C6IN0+/IOCA2/RA2
  // Pin  5 : DAC1REF0+/DAC2REF0+/DAC3REF0+/DAC4REF0+/DAC5REF0+/DAC7REF0+/VREF+/AN3/C1IN1+/IOCA3/RA3
  // Pin  6 : DAC4OUT1/OPA1IN0+/IOCA4/RA4
  // Pin  7 : DAC2OUT1/OPA1IN0-/AN4/IOCA5/RA5
  // Pin  8 : VSS
  // Pin  9 : OSC1/CLKIN/IOCA7/RA7
  // Pin 10 : OSC2/CLKOUT/C6IN1+/IOCA6/RA6
  // Pin 11 : SOSCO/DAC5OUT1/IOCC0/RC0
  // Pin 12 : SOSCI/DAC7OUT1/IOCC1/RC1
  // Pin 13 : AN14/C5IN2-/C6IN2-/IOCC2/RC2
  // Pin 14 : AN15/C1IN4-/C2IN4-/C3IN4-/C4IN4-/C5IN4-/C6IN4-/C7IN4-/C8IN4-/SCL/IOCC3/RC3
  // Pin 15 : AN16/C5IN3-/C6IN3-/SDA/IOCC4/RC4
  // Pin 16 : OPA3IN0+/AN17/IOCC5/RC5
  // Pin 17 : OPA3OUT/SLMP3IN0/AN18/C5IN1-/C6IN1-/IOCC6/RC6
  // Pin 18 : OPA3IN0-/AN19/IOCC7/RC7
  // Pin 19 : VSS
  // Pin 20 : VDD
  // Pin 21 : AN12/ZCD/C2IN1+/IOCB0/HIB0/RB0
  // Pin 22 : OPA2OUT/PRG1IN1/OPA1IN1+/OPA1IN1-/PRG2IN0/AN10/C1IN3-/C2IN3-/C3IN3-/C4IN3-/IOCB1/HIB1/RB1
  // Pin 23 : DAC3OUT1/OPA2IN0-/AN8/IOCB2/RB2
  // Pin 24 : OPA2IN0+/AN9/C1IN2-/C2IN2-/C3IN2-/IOCB3/RB3
  // Pin 25 : AN11/C3IN1+/IOCB4/RB4
  // Pin 26 : DAC5REF1-/DAC7REF1-/AN13/C4IN2-/IOCB5/RB5
  // Pin 27 : ICSPCLK/ICDCLK/DAC5REF1+/DAC7REF1+/C4IN1+/IOCB6/RB6
  // Pin 28 : ICSPDAT/ICDDAT/DAC1OUT2/DAC2OUT2/DAC5OUT2/DAC3OUT2/DAC4OUT2/DAC7OUT2/C5IN1+/IOCB7/RB7


  // -- RAM to PIN mapping --

  {$MAP_RAM_TO_PIN '00C:0-1,1-3,2-4,3-5,4-6,5-7,6-10,7-9'} // PORTA

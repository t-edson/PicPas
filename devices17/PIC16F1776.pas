...
var
  ...
  {$SET_STATE_RAM '010-01F:SFR'}            // Bank 0 : PORTE, PIR1, PIR2, PIR3, PIR4, PIR5, PIR6, TMR0, TMR1L, TMR1H, T1CON, T1GCON, TMR3L, TMR3H, T3CON, T3GCON
  {$SET_STATE_RAM '020-06F:GPR'}           
  {$SET_STATE_RAM '070-07F:GPR:ALLMAPPED'} 
  {$SET_STATE_RAM '08C-08E:SFR'}            // Bank 1 : TRISA, TRISB, TRISC
  {$SET_STATE_RAM '090-09F:SFR'}            // Bank 1 : TRISE, PIE1, PIE2, PIE3, PIE4, PIE5, PIE6, OPTION_REG, PCON, WDTCON, OSCTUNE, OSCCON, OSCSTAT, BORCON, FVRCON, ZCD1CON
  {$SET_STATE_RAM '0A0-0EF:GPR'}           
  {$SET_STATE_RAM '10C-10E:SFR'}            // Bank 2 : LATA, LATB, LATC
  {$SET_STATE_RAM '111-11D:SFR'}            // Bank 2 : CMOUT, CM1CON0, CM1CON1, CM1NSEL, CM1PSEL, CM2CON0, CM2CON1, CM2NSEL, CM2PSEL, CM3CON0, CM3CON1, CM3NSEL, CM3PSEL
  ...
  {$SET_STATE_RAM '291-29C:SFR'}            // Bank 5 : CCPR1L, CCPR1H, CCP1CON, CCP1CAP, CCPR2L, CCPR2H, CCP2CON, CCP2CAP, CCPR7L, CCPR7H, CCP7CON, CCP7CAP
  ...
  {$SET_STATE_RAM '315-319:SFR'}            // Bank 6 : MD1CON0, MD1CON1, MD1SRC, MD1CARL, MD1CARH
  ...
  {$SET_STATE_RAM '390-399:SFR'}            // Bank 7 : INLVE, IOCAP, IOCAN, IOCAF, IOCBP, IOCBN, IOCBF, IOCCP, IOCCN, IOCCF
  ...
  {$SET_STATE_RAM '50F-51A:SFR'}            // Bank 10 : OPA1NCHS, OPA1PCHS, OPA1CON, OPA1ORS, OPA2NCHS, OPA2PCHS, OPA2CON, OPA2ORS, OPA3NCHS, OPA3PCHS, OPA3CON, OPA3ORS
  {$SET_STATE_RAM '520-56F:GPR'}           
  {$SET_STATE_RAM '58D-59A:SFR'}            // Bank 11 : DACLD, DAC1CON0, DAC1REFL, DAC1REFH, DAC2CON0, DAC2REFL, DAC2REFH, DAC3CON0, DAC3REF, DAC4CON0, DAC4REF, DAC5CON0, DAC5REFL, DAC5REFH
  {$SET_STATE_RAM '59E-59F:SFR'}            // Bank 11 : DAC7CON0, DAC7REF
  {$SET_STATE_RAM '5A0-5EF:GPR'}           
  {$SET_STATE_RAM '614-61C:SFR'}            // Bank 12 : PWM3DCL, PWM3DCH, PWM3CON, PWM4DCL, PWM4DCH, PWM4CON, PWM9DCL, PWM9DCH, PWM9CON
  ...
  {$SET_STATE_RAM '90C-917:SFR'}            // Bank 18 : CM4CON0, CM4CON1, CM4NSEL, CM4PSEL, CM5CON0, CM5CON1, CM5NSEL, CM5PSEL, CM6CON0, CM6CON1, CM6NSEL, CM6PSEL
  ...
  {$SET_STATE_RAM 'E0C-E1B:SFR'}            // Bank 28 : PPSLOCK, INTPPS, T0CKIPPS, T1CKIPPS, T1GPPS, T3CKIPPS, T3GPPS, T5CKIPPS, T5GPPS, T2INPPS, T4INPPS, T6INPPS, T8INPPS, CCP1PPS, CCP2PPS, CCP7PPS
  {$SET_STATE_RAM 'E1D-E1F:SFR'}            // Bank 28 : COG1INPPS, COG2INPPS, COG3INPPS
  {$SET_STATE_RAM 'E21-E29:SFR'}            // Bank 28 : MD1CLPPS, MD1CHPPS, MD1MODPPS, MD2CLPPS, MD2CHPPS, MD2MODPPS, MD3CLPPS, MD3CHPPS, MD3MODPPS
  {$SET_STATE_RAM 'E2D-E32:SFR'}            // Bank 28 : PRG1RPPS, PRG1FPPS, PRG2RPPS, PRG2FPPS, PRG3RPPS, PRG3FPPS
  {$SET_STATE_RAM 'E35-E3E:SFR'}            // Bank 28 : CLCIN0PPS, CLCIN1PPS, CLCIN2PPS, CLCIN3PPS, ADCACTPPS, SSPCLKPPS, SSPDATPPS, SSPSSPPS, RXPPS, CKPPS
  {$SET_STATE_RAM 'E90-EA7:SFR'}            // Bank 29 : RA0PPS, RA1PPS, RA2PPS, RA3PPS, RA4PPS, RA5PPS, RA6PPS, RA7PPS, RB0PPS, RB1PPS, RB2PPS, RB3PPS, RB4PPS, RB5PPS, RB6PPS, RB7PPS, RC0PPS, RC1PPS, RC2PPS, RC3PPS, RC4PPS, RC5PPS, RC6PPS, RC7PPS

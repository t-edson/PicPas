...
var
  ...
  PIR2_TMR10IF        : bit  absolute PIR2.3;
  PIR2_TMR8IF         : bit  absolute PIR2.2;
  ...
  PIE2_TMR10IE        : bit  absolute PIE2.3;
  PIE2_TMR8IE         : bit  absolute PIE2.2;
  ...
  APFCON_T3CKISEL     : bit  absolute APFCON.2;
  ...
  ANSELD_ANSD3        : bit  absolute ANSELD.4;
  ANSELD_ANSD2        : bit  absolute ANSELD.3;
  ANSELD_ANSD1        : bit  absolute ANSELD.2;
  ANSELD_ANSD0        : bit  absolute ANSELD.1;
  ...
  T8CON_T8CKPS0       : bit  absolute T8CON.1;
  ...
  T10CON_T10CKPS0     : bit  absolute T10CON.1;
  ...
  {$SET_STATE_RAM '08C-097:SFR'}  // TRISA, TRISB, TRISC, TRISD, TRISE, PIE1, PIE2, PIE3, PIE4, OPTION_REG, PCON, WDTCON
  {$SET_STATE_RAM '099-09E:SFR'}  // OSCCON, OSCSTAT, ADRESL, ADRESH, ADCON0, ADCON1
  {$SET_STATE_RAM '0A0-0EF:GPR'} 
  {$SET_STATE_RAM '0F0-0FF:GPR'} 
  {$SET_STATE_RAM '100-100:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '10C-110:SFR'}  // LATA, LATB, LATC, LATD, LATE
  ...
  {$SET_STATE_RAM '18F-197:SFR'}  // ANSELD, ANSELE, PMADRL, PMADRH, PMDATL, PMDATH, PMCON1, PMCON2, VREGCON
  ...
  {$SET_STATE_RAM '20F-217:SFR'}  // WPUD, WPUE, SSP1BUF, SSP1ADD, SSP1MSK, SSP1STAT, SSP1CON1, SSP1CON2, SSP1CON3
  ...
  {$SET_STATE_RAM '29D-29F:SFR'}  // CCPTMRS0, CCPTMRS1, CCPTMRS2
  ...
  {$SET_STATE_RAM '411-41E:SFR'}  // TMR3L, TMR3H, T3CON, T3GCON, TMR4, PR4, T4CON, TMR5L, TMR5H, T5CON, T5GCON, TMR6, PR6, T6CON
  ...
  {$SET_STATE_RAM '595-597:SFR'}  // TMR8, PR8, T8CON
  {$SET_STATE_RAM '59C-59E:SFR'}  // TMR10, PR10, T10CON
  {$SET_STATE_RAM '5F0-5FF:GPR'} 
  {$SET_STATE_RAM '600-600:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '611-61F:SFR'}  // CCPR6L, CCPR6H, CCP6CON, CCPR7L, CCPR7H, CCP7CON, CCPR8L, CCPR8H, CCP8CON, CCPR9L, CCPR9H, CCP9CON, CCPR10L, CCPR10H, CCP10CON

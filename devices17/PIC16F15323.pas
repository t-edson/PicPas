...
var
  ...
  OSCCON3_CSWHOLD          : bit  absolute OSCCON3.5;
  OSCCON3_ORDY             : bit  absolute OSCCON3.4;
  OSCCON3_NOSCR            : bit  absolute OSCCON3.3;
  OSCSTAT                  : byte absolute $0890;
  OSCSTAT_EXTOR            : bit  absolute OSCSTAT.6;
  OSCSTAT_HFOR             : bit  absolute OSCSTAT.5;
  OSCSTAT_MFOR             : bit  absolute OSCSTAT.4;
  OSCSTAT_LFOR             : bit  absolute OSCSTAT.3;
  ...
  OSCEN_MFOEN              : bit  absolute OSCEN.4;
  OSCEN_LFOEN              : bit  absolute OSCEN.3;

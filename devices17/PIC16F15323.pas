...
var
  ...
  PMD1_DDS1MD              : bit  absolute PMD1.7;
  ...
  STATUS_SHAD_STATUS_SHAD2 : bit  absolute STATUS_SHAD.2;
  STATUS_SHAD_STATUS_SHAD1 : bit  absolute STATUS_SHAD.1;
  STATUS_SHAD_STATUS_SHAD0 : bit  absolute STATUS_SHAD.0;
  ...
  {$SET_STATE_RAM '012-012:SFR'}  // TRISA
  {$SET_STATE_RAM '014-014:SFR'}  // TRISC
  {$SET_STATE_RAM '018-018:SFR'}  // LATA
  {$SET_STATE_RAM '01A-01A:SFR'}  // LATC
  ...
  {$SET_STATE_RAM '1ECB-1ECC:SFR'}  // RX1DTPPS, TX1CKPPS
  ...
  {$SET_STATE_RAM '1F10-1F15:SFR'}  // RA0PPS, RA1PPS, RA2PPS, RA3PPS, RA4PPS, RA5PPS
  {$SET_STATE_RAM '1F20-1F25:SFR'}  // RC0PPS, RC1PPS, RC2PPS, RC3PPS, RC4PPS, RC5PPS
  ...
  {$SET_UNIMP_BITS '012:37'} // TRISA bits 7,6,3 un-implemented (read as 0)
  {$SET_UNIMP_BITS '014:3F'} // TRISC bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS '018:37'} // LATA bits 7,6,3 un-implemented (read as 0)
  {$SET_UNIMP_BITS '01A:3F'} // LATC bits 7,6 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '70F:37'} // PIR3 bits 7,6,3 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '717:C1'} // PIE1 bits 5,4,3,2,1 un-implemented (read as 0)
  {$SET_UNIMP_BITS '718:43'} // PIE2 bits 7,5,4,3,2 un-implemented (read as 0)
  {$SET_UNIMP_BITS '719:33'} // PIE3 bits 7,6,3,2 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '79A:51'} // PMD4 bits 7,5,3,2,1 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '88F:98'} // OSCCON3 bits 6,5,2,1,0 un-implemented (read as 0)
  {$SET_UNIMP_BITS '890:F5'} // OSCSTAT bits 3,1 un-implemented (read as 0)
  {$SET_UNIMP_BITS '891:F4'} // OSCEN bits 3,1,0 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '1F4E:3F'} // ANSELC bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F4F:3F'} // WPUC bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F50:3F'} // ODCONC bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F51:3F'} // SLRCONC bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F52:3F'} // INLVLC bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F53:3F'} // IOCCP bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F54:3F'} // IOCCN bits 7,6 un-implemented (read as 0)
  {$SET_UNIMP_BITS '1F55:3F'} // IOCCF bits 7,6 un-implemented (read as 0)
  ...
  // Pin  1 : VDD
  // Pin  2 : ECIN/OSC1/CLKIN/ANA5/IOCA5/RA5
  // Pin  3 : OSC2/CLKOUT/ANA4/C1IN1-/IOCA4/RA4
  // Pin  4 : MCLR/VPP/IOCA3/RA3
  // Pin  5 : ANC5/IOCC5/RC5
  // Pin  6 : ANC4/IOCC4/RC4
  // Pin  7 : ANC3/C1IN3-/C2IN3-/IOCC3/RC3
  // Pin  8 : ANC2/C2IN2-/C1IN2-/IOCC2/RC2
  // Pin  9 : ANC1/C2IN1-/C1IN1-/SMB_I2C/IOCC1/RC1
  // Pin 10 : ANC0/C2IN0+/SMB_I2C/IOCC0/RC0
  // Pin 11 : ZCD1/ANA2/IOCA2/RA2
  // Pin 12 : ICSPCLK/ICDCLK/DAC1REF+/VREF+/ANA1/C2IN0-/C1IN0-/IOCA1/RA1
  ...
  {$define _RSTOSC_Reserved  = $3FCF}  // Reserved
  ...
  {$define _WDTCCS_Reserved  = $17FF}  // Reserved
  ...
  {$define _BBSIZE_BB4K      = $3FFC}  // * half of user program memory

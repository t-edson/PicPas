...
var
  ...
  PWM9CON_OE           : bit  absolute PWM9CON.6;
  ...
  {$SET_UNIMP_BITS '61C:F0'} // PWM9CON bits 3,2,1,0 un-implemented (read as 0)
  ...
  // Pin  2 : AN0/C1IN0-/C2IN0-/C3IN0-/C4IN0-/C5IN0-/C6IN0-/IOCA0/RA0

...
var
  ...
  APFCON0_RXDTSEL     : bit  absolute APFCON0.3;
  APFCON0_T1GSEL      : bit  absolute APFCON0.2;
  APFCON0_TXCKSEL     : bit  absolute APFCON0.1;
  APFCON1             : byte absolute $011E;
  APFCON1_SDO2SEL     : bit  absolute APFCON1.5;
  APFCON1_SS2SEL      : bit  absolute APFCON1.4;
  ...
  {$SET_UNIMP_BITS '11D:8C'} // APFCON0 bits 6,5,4,1,0 un-implemented (read as 0)
  {$SET_UNIMP_BITS '11E:3F'} // APFCON1 bits 7,6 un-implemented (read as 0)
  ...
  // Pin  1 : Vdd
  // Pin  2 : RA5/CLKIN/OSC1/T1OSI/SDO2/T1CKI/P2A/CCP2
  // Pin  3 : RA4/AN3/CPS3/OSC2/CLKOUT/T1OSO/CLKR/SS2/P2B/T1G
  // Pin  4 : RA3/T1G/Vpp/MCLR
  // Pin  5 : RC5/CCP1/P1A/DT/RX/MDCIN2
  // Pin  6 : RC4/C2OUT/SRNQ/P1B/CK/TX/MDOUT
  // Pin  7 : RC3/AN7/CPS7/C12IN3-/P1C/CCP2/P2A/MDMIN
  // Pin  8 : RC6/AN8/CPS8/CCP4/SS1
  // Pin  9 : RC7/AN9/CPS9/SDO
  // Pin 10 : RB7/CK/TX/SCK2/SCL2
  // Pin 11 : RB6/SCL1/SCK1
  // Pin 12 : RB5/AN11/CPS11/RX/DT/SDA2/SDI2
  // Pin 13 : RB4/AN10/CPS10/SDA1/SDI1
  // Pin 14 : RC2/AN6/CPS6/C12IN2-/P1D/P2B/MDCIN1
  // Pin 15 : RC1/AN5/CPS5/C12IN1-/P1C/SDO2
  // Pin 16 : RC0/AN4/CPS4/C2IN+/P1D/SS2
  // Pin 17 : RA2/AN2/CPS2/T0CKI/INT/C1OUT/SRQ/CCP3/FLT0
  // Pin 18 : RA1/AN1/CPS1/C12IN0-/Vref+/SRI/ICSPCLK/ICDCLK
  // Pin 19 : RA0/AN0/CPS0/C1IN+/Vref-/DACOUT/ICSPDAT/ICDDAT
  // Pin 20 : Vss

...
var
  ...
  PIR3_CCP5IF         : bit  absolute PIR3.5;
  PIR3_CCP4IF         : bit  absolute PIR3.4;
  PIR3_CCP3IF         : bit  absolute PIR3.3;
  PIR3_TMR6IF         : bit  absolute PIR3.2;
  PIR3_TMR4IF         : bit  absolute PIR3.1;
  PIR4                : byte absolute $0014;
  PIR4_RC2IF          : bit  absolute PIR4.5;
  PIR4_TX2IF          : bit  absolute PIR4.4;
  PIR4_BCL2IF         : bit  absolute PIR4.3;
  PIR4_SSP2IF         : bit  absolute PIR4.2;
  ...
  CPSCON0_CPSRNG1     : bit  absolute CPSCON0.5;
  CPSCON0_CPSRNG0     : bit  absolute CPSCON0.4;
  CPSCON0_CPSOUT      : bit  absolute CPSCON0.3;
  CPSCON0_T0XCS       : bit  absolute CPSCON0.2;
  ...
  PIE3_CCP5IE         : bit  absolute PIE3.5;
  PIE3_CCP4IE         : bit  absolute PIE3.4;
  PIE3_CCP3IE         : bit  absolute PIE3.3;
  PIE3_TMR6IE         : bit  absolute PIE3.2;
  PIE3_TMR4IE         : bit  absolute PIE3.1;
  PIE4                : byte absolute $0094;
  PIE4_RC2IE          : bit  absolute PIE4.5;
  PIE4_TX2IE          : bit  absolute PIE4.4;
  PIE4_BCL2IE         : bit  absolute PIE4.3;
  PIE4_SSP2IE         : bit  absolute PIE4.2;
  ...
  CM3CON0_C3SP        : bit  absolute CM3CON0.3;
  CM3CON0_C3HYS       : bit  absolute CM3CON0.2;
  CM3CON0_C3SYNC      : bit  absolute CM3CON0.1;
  ...
  CM3CON1_C3NCH1      : bit  absolute CM3CON1.3;
  CM3CON1_C3NCH0      : bit  absolute CM3CON1.2;
  ...
  ANSELE_ANSE2        : bit  absolute ANSELE.7;
  ANSELE_ANSE1        : bit  absolute ANSELE.6;
  ANSELE_ANSE0        : bit  absolute ANSELE.5;
  ...
  CCP4CON_DC4B1       : bit  absolute CCP4CON.7;
  CCP4CON_DC4B0       : bit  absolute CCP4CON.6;
  CCP4CON_CCP4M3      : bit  absolute CCP4CON.5;
  CCP4CON_CCP4M2      : bit  absolute CCP4CON.4;
  CCP4CON_CCP4M1      : bit  absolute CCP4CON.3;
  CCP4CON_CCP4M0      : bit  absolute CCP4CON.2;
  CCPR5L              : byte absolute $031C;
  CCPR5H              : byte absolute $031D;
  CCP5CON             : byte absolute $031E;
  CCP5CON_DC5B1       : bit  absolute CCP5CON.7;
  CCP5CON_DC5B0       : bit  absolute CCP5CON.6;
  CCP5CON_CCP5M3      : bit  absolute CCP5CON.5;
  CCP5CON_CCP5M2      : bit  absolute CCP5CON.4;
  CCP5CON_CCP5M1      : bit  absolute CCP5CON.3;
  CCP5CON_CCP5M0      : bit  absolute CCP5CON.2;
  ...
  T4CON_T4OUTPS3      : bit  absolute T4CON.7;
  T4CON_T4OUTPS2      : bit  absolute T4CON.6;
  T4CON_T4OUTPS1      : bit  absolute T4CON.5;
  T4CON_T4OUTPS0      : bit  absolute T4CON.4;
  T4CON_TMR4ON        : bit  absolute T4CON.3;
  T4CON_T4CKPS1       : bit  absolute T4CON.2;
  T4CON_T4CKPS0       : bit  absolute T4CON.1;
  TMR6                : byte absolute $041C;
  PR6                 : byte absolute $041D;
  T6CON               : byte absolute $041E;
  T6CON_T6OUTPS3      : bit  absolute T6CON.7;
  T6CON_T6OUTPS2      : bit  absolute T6CON.6;
  T6CON_T6OUTPS1      : bit  absolute T6CON.5;
  T6CON_T6OUTPS0      : bit  absolute T6CON.4;
  T6CON_TMR6ON        : bit  absolute T6CON.3;
  T6CON_T6CKPS1       : bit  absolute T6CON.2;
  ...
  LCDCON_CS1          : bit  absolute LCDCON.4;
  LCDCON_CS0          : bit  absolute LCDCON.3;
  LCDCON_LMUX1        : bit  absolute LCDCON.2;
  LCDCON_LMUX0        : bit  absolute LCDCON.1;
  ...
  LCDREF_LCDIRE       : bit  absolute LCDREF.6;
  LCDREF_LCDIRS       : bit  absolute LCDREF.5;
  LCDREF_LCDIRI       : bit  absolute LCDREF.4;
  ...
  LCDRL_LRLAT2        : bit  absolute LCDRL.3;
  ...
  LCDDATA14_SEG45COM0 : bit  absolute LCDDATA14.6;
  LCDDATA14_SEG44COM0 : bit  absolute LCDDATA14.5;
  LCDDATA14_SEG43COM0 : bit  absolute LCDDATA14.4;
  LCDDATA14_SEG42COM0 : bit  absolute LCDDATA14.3;
  LCDDATA14_SEG41COM0 : bit  absolute LCDDATA14.2;
  LCDDATA14_SEG40COM0 : bit  absolute LCDDATA14.1;
  ...
  LCDDATA17_SEG45COM1 : bit  absolute LCDDATA17.6;
  LCDDATA17_SEG44COM1 : bit  absolute LCDDATA17.5;
  LCDDATA17_SEG43COM1 : bit  absolute LCDDATA17.4;
  LCDDATA17_SEG42COM1 : bit  absolute LCDDATA17.3;
  LCDDATA17_SEG41COM1 : bit  absolute LCDDATA17.2;
  LCDDATA17_SEG40COM1 : bit  absolute LCDDATA17.1;
  ...
  LCDDATA20_SEG45COM2 : bit  absolute LCDDATA20.6;
  LCDDATA20_SEG44COM2 : bit  absolute LCDDATA20.5;
  LCDDATA20_SEG43COM2 : bit  absolute LCDDATA20.4;
  LCDDATA20_SEG42COM2 : bit  absolute LCDDATA20.3;
  LCDDATA20_SEG41COM2 : bit  absolute LCDDATA20.2;
  LCDDATA20_SEG40COM2 : bit  absolute LCDDATA20.1;
  ...
  LCDDATA23_SEG45COM3 : bit  absolute LCDDATA23.6;
  LCDDATA23_SEG44COM3 : bit  absolute LCDDATA23.5;
  LCDDATA23_SEG43COM3 : bit  absolute LCDDATA23.4;
  LCDDATA23_SEG42COM3 : bit  absolute LCDDATA23.3;
  LCDDATA23_SEG41COM3 : bit  absolute LCDDATA23.2;
  LCDDATA23_SEG40COM3 : bit  absolute LCDDATA23.1;
  ...
  {$SET_STATE_RAM '08C-09E:SFR'}  // TRISA, TRISB, TRISC, TRISD, TRISE, PIE1, PIE2, PIE3, PIE4, OPTION_REG, PCON, WDTCON, OSCTUNE, OSCCON, OSCSTAT, ADRESL, ADRESH, ADCON0, ADCON1
  {$SET_STATE_RAM '0A0-0EF:GPR'} 
  {$SET_STATE_RAM '0F0-0FF:GPR'} 
  {$SET_STATE_RAM '100-100:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '10C-11B:SFR'}  // LATA, LATB, LATC, LATD, LATE, CM1CON0, CM1CON1, CM2CON0, CM2CON1, CMOUT, BORCON, FVRCON, DACCON0, DACCON1, SRCON0, SRCON1
  {$SET_STATE_RAM '11D-11F:SFR'}  // APFCON, CM3CON0, CM3CON1
  ...
  {$SET_STATE_RAM '190-196:SFR'}  // ANSELE, EEADRL, EEADRH, EEDATL, EEDATH, EECON1, EECON2
  ...
  {$SET_STATE_RAM '28C-28D:SFR'}  // PORTF, PORTG
  {$SET_STATE_RAM '291-296:SFR'}  // CCPR1L, CCPR1H, CCP1CON, PWM1CON, CCP1AS, PSTR1CON
  {$SET_STATE_RAM '298-29F:SFR'}  // CCPR2L, CCPR2H, CCP2CON, PWM2CON, CCP2AS, PSTR2CON, CCPTMRS0, CCPTMRS1
  {$SET_STATE_RAM '2A0-2EF:GPR'} 
  {$SET_STATE_RAM '2F0-2FF:GPR'} 
  {$SET_STATE_RAM '300-300:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '30C-30D:SFR'}  // TRISF, TRISG
  {$SET_STATE_RAM '311-316:SFR'}  // CCPR3L, CCPR3H, CCP3CON, PWM3CON, CCP3AS, PSTR3CON
  {$SET_STATE_RAM '318-31A:SFR'}  // CCPR4L, CCPR4H, CCP4CON
  {$SET_STATE_RAM '31C-31E:SFR'}  // CCPR5L, CCPR5H, CCP5CON
  {$SET_STATE_RAM '320-36F:GPR'} 
  {$SET_STATE_RAM '370-37F:GPR'} 
  {$SET_STATE_RAM '380-380:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '38C-38D:SFR'}  // LATF, LATG
  ...
  {$SET_STATE_RAM '40C-40D:SFR'}  // ANSELF, ANSELG
  {$SET_STATE_RAM '415-417:SFR'}  // TMR4, PR4, T4CON
  {$SET_STATE_RAM '41C-41E:SFR'}  // TMR6, PR6, T6CON
  {$SET_STATE_RAM '420-46F:GPR'} 
  {$SET_STATE_RAM '470-47F:GPR'} 
  {$SET_STATE_RAM '480-480:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '48D-48D:SFR'}  // WPUG
  {$SET_STATE_RAM '491-497:SFR'}  // RC2REG, TX2REG, SP2BRGL, SP2BRGH, RC2STA, TX2STA, BAUD2CON
  ...
  {$SET_STATE_RAM '791-795:SFR'}  // LCDCON, LCDPS, LCDREF, LCDCST, LCDRL
  {$SET_STATE_RAM '798-79D:SFR'}  // LCDSE0, LCDSE1, LCDSE2, LCDSE3, LCDSE4, LCDSE5
  {$SET_STATE_RAM '7A0-7B7:SFR'}  // LCDDATA0, LCDDATA1, LCDDATA2, LCDDATA3, LCDDATA4, LCDDATA5, LCDDATA6, LCDDATA7, LCDDATA8, LCDDATA9, LCDDATA10, LCDDATA11, LCDDATA12, LCDDATA13, LCDDATA14, LCDDATA15, LCDDATA16, LCDDATA17, LCDDATA18, LCDDATA19, LCDDATA20, LCDDATA21, LCDDATA22, LCDDATA23

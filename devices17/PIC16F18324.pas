...
var
  ...
  INTCON_GIE             : bit  absolute INTCON.3;
  INTCON_PEIE            : bit  absolute INTCON.2;
  INTCON_INTEDG          : bit  absolute INTCON.1;
  ...
  PIR2_TMR6IF            : bit  absolute PIR2.6;
  PIR2_C2IF              : bit  absolute PIR2.5;
  PIR2_C1IF              : bit  absolute PIR2.4;
  PIR2_NVMIF             : bit  absolute PIR2.3;
  ...
  TMR0L_TMR07            : bit  absolute TMR0L.7;
  TMR0L_TMR06            : bit  absolute TMR0L.6;
  TMR0L_TMR05            : bit  absolute TMR0L.5;
  TMR0L_TMR04            : bit  absolute TMR0L.4;
  TMR0L_TMR03            : bit  absolute TMR0L.3;
  TMR0L_TMR02            : bit  absolute TMR0L.2;
  TMR0L_TMR01            : bit  absolute TMR0L.1;
  TMR0L_TMR00            : bit  absolute TMR0L.0;
  TMR0H                  : byte absolute $0016;
  TMR0H_TMR015           : bit  absolute TMR0H.7;
  TMR0H_TMR014           : bit  absolute TMR0H.6;
  TMR0H_TMR013           : bit  absolute TMR0H.5;
  TMR0H_TMR012           : bit  absolute TMR0H.4;
  TMR0H_TMR011           : bit  absolute TMR0H.3;
  TMR0H_TMR010           : bit  absolute TMR0H.2;
  TMR0H_TMR09            : bit  absolute TMR0H.1;
  TMR0H_TMR08            : bit  absolute TMR0H.0;
  ...
  PIE2_TMR6IE            : bit  absolute PIE2.6;
  PIE2_C2IE              : bit  absolute PIE2.5;
  PIE2_C1IE              : bit  absolute PIE2.4;
  PIE2_NVMIE             : bit  absolute PIE2.3;
  ...
  ADACT_ADACT4           : bit  absolute ADACT.5;
  ADACT_ADACT3           : bit  absolute ADACT.4;
  ADACT_ADACT2           : bit  absolute ADACT.3;
  ADACT_ADACT1           : bit  absolute ADACT.2;
  ADACT_ADACT0           : bit  absolute ADACT.1;
  ...
  CM1CON0_C1ON           : bit  absolute CM1CON0.6;
  CM1CON0_C1OUT          : bit  absolute CM1CON0.5;
  ...
  CM2CON0_C2ON           : bit  absolute CM2CON0.6;
  CM2CON0_C2OUT          : bit  absolute CM2CON0.5;
  ...
  DACCON0_DAC1EN         : bit  absolute DACCON0.5;
  DACCON0_DAC1OE         : bit  absolute DACCON0.4;
  DACCON0_DAC1PSS1       : bit  absolute DACCON0.3;
  DACCON0_DAC1PSS0       : bit  absolute DACCON0.2;
  DACCON0_DAC1NSS        : bit  absolute DACCON0.1;
  ...
  ODCONC_ODCC5           : bit  absolute ODCONC.6;
  ...
  CCP1CON_CCP1OUT        : bit  absolute CCP1CON.6;
  CCP1CON_CCP1FMT        : bit  absolute CCP1CON.5;
  ...
  CCP2CON_CCP2OUT        : bit  absolute CCP2CON.6;
  CCP2CON_CCP2FMT        : bit  absolute CCP2CON.5;
  ...
  CCP3CON_CCP3OUT        : bit  absolute CCP3CON.6;
  CCP3CON_CCP3FMT        : bit  absolute CCP3CON.5;
  ...
  CCP4CON_CCP4OUT        : bit  absolute CCP4CON.6;
  CCP4CON_CCP4FMT        : bit  absolute CCP4CON.5;
  ...
  MDCON_MDEN             : bit  absolute MDCON.5;
  ...
  T4CON_T4CKPS0          : bit  absolute T4CON.1;
  ...
  T5CON_TMR5ON           : bit  absolute T5CON.1;
  ...
  T6CON_T6CKPS0          : bit  absolute T6CON.1;
  ...
  PWM5DCL_PWM5DCL1       : bit  absolute PWM5DCL.2;
  PWM5DCL_PWM5DCL0       : bit  absolute PWM5DCL.1;
  ...
  PWM5CON_PWM5EN         : bit  absolute PWM5CON.3;
  PWM5CON_PWM5OUT        : bit  absolute PWM5CON.2;
  PWM5CON_PWM5POL        : bit  absolute PWM5CON.1;
  PWM6DCL                : byte absolute $061A;
  PWM6DCL_PWM6DCL1       : bit  absolute PWM6DCL.2;
  PWM6DCL_PWM6DCL0       : bit  absolute PWM6DCL.1;
  ...
  PWM6CON_PWM6EN         : bit  absolute PWM6CON.3;
  PWM6CON_PWM6OUT        : bit  absolute PWM6CON.2;
  PWM6CON_PWM6POL        : bit  absolute PWM6CON.1;
  ...
  CWG1DAT_CWG1DAT3       : bit  absolute CWG1DAT.3;
  CWG1DAT_CWG1DAT2       : bit  absolute CWG1DAT.2;
  CWG1DAT_CWG1DAT1       : bit  absolute CWG1DAT.1;
  CWG1DAT_CWG1DAT0       : bit  absolute CWG1DAT.0;
  ...
  CWG1CON0_MODE2         : bit  absolute CWG1CON0.5;
  CWG1CON0_MODE1         : bit  absolute CWG1CON0.4;
  CWG1CON0_MODE0         : bit  absolute CWG1CON0.3;
  ...
  CWG2DAT_CWG2DAT3       : bit  absolute CWG2DAT.3;
  CWG2DAT_CWG2DAT2       : bit  absolute CWG2DAT.2;
  CWG2DAT_CWG2DAT1       : bit  absolute CWG2DAT.1;
  CWG2DAT_CWG2DAT0       : bit  absolute CWG2DAT.0;
  ...
  PCON0_RWDT             : bit  absolute PCON0.5;
  PCON0_RMCLR            : bit  absolute PCON0.4;
  PCON0_RI               : bit  absolute PCON0.3;
  PCON0_POR              : bit  absolute PCON0.2;
  PCON0_BOR              : bit  absolute PCON0.1;
  ...
  PMD2_DACMD             : bit  absolute PMD2.4;
  PMD2_ADCMD             : bit  absolute PMD2.3;
  ...
  PMD4_UART1MD           : bit  absolute PMD4.2;
  ...
  OSCSTAT1_EXTOR         : bit  absolute OSCSTAT1.6;
  OSCSTAT1_HFOR          : bit  absolute OSCSTAT1.5;
  OSCSTAT1_LFOR          : bit  absolute OSCSTAT1.4;
  OSCSTAT1_SOR           : bit  absolute OSCSTAT1.3;
  OSCSTAT1_ADOR          : bit  absolute OSCSTAT1.2;
  OSCSTAT1_PLLR          : bit  absolute OSCSTAT1.1;
  OSCEN                  : byte absolute $091D;
  OSCEN_EXTOEN           : bit  absolute OSCEN.6;
  OSCEN_HFOEN            : bit  absolute OSCEN.5;
  ...
  RXPPS_RXDTPPS4         : bit  absolute RXPPS.4;
  RXPPS_RXDTPPS3         : bit  absolute RXPPS.3;
  RXPPS_RXDTPPS2         : bit  absolute RXPPS.2;
  RXPPS_RXDTPPS1         : bit  absolute RXPPS.1;
  RXPPS_RXDTPPS0         : bit  absolute RXPPS.0;
  TXPPS                  : byte absolute $0E25;
  TXPPS_TXCKPPS4         : bit  absolute TXPPS.4;
  TXPPS_TXCKPPS3         : bit  absolute TXPPS.3;
  TXPPS_TXCKPPS2         : bit  absolute TXPPS.2;
  TXPPS_TXCKPPS1         : bit  absolute TXPPS.1;
  TXPPS_TXCKPPS0         : bit  absolute TXPPS.0;
  ...
  {$SET_STATE_RAM '010-01F:SFR'}  // PIR0, PIR1, PIR2, PIR3, PIR4, TMR0L, TMR0H, T0CON0, T0CON1, TMR1L, TMR1H, T1CON, T1GCON, TMR2, PR2, T2CON
  ...
  {$SET_STATE_RAM '090-094:SFR'}  // PIE0, PIE1, PIE2, PIE3, PIE4
  {$SET_STATE_RAM '097-097:SFR'}  // WDTCON
  ...
  {$SET_STATE_RAM '197-197:SFR'}  // VREGCON
  ...
  {$SET_STATE_RAM '291-298:SFR'}  // CCPR1L, CCPR1H, CCP1CON, CCP1CAP, CCPR2L, CCPR2H, CCP2CON, CCP2CAP
  {$SET_STATE_RAM '29F-29F:SFR'}  // CCPTMRS
  ...
  {$SET_STATE_RAM '311-318:SFR'}  // CCPR3L, CCPR3H, CCP3CON, CCP3CAP, CCPR4L, CCPR4H, CCP4CON, CCP4CAP
  ...
  {$SET_STATE_RAM '397-39A:SFR'}  // IOCCP, IOCCN, IOCCF, CLKRCON
  {$SET_STATE_RAM '39C-39F:SFR'}  // MDCON, MDSRC, MDCARH, MDCARL
  {$SET_STATE_RAM '3F0-3FF:GPR'} 
  {$SET_STATE_RAM '400-400:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '411-41F:SFR'}  // TMR3L, TMR3H, T3CON, T3GCON, TMR4, PR4, T4CON, TMR5L, TMR5H, T5CON, T5GCON, TMR6, PR6, T6CON, CCDCON
  ...
  {$SET_STATE_RAM '617-61C:SFR'}  // PWM5DCL, PWM5DCH, PWM5CON, PWM6DCL, PWM6DCH, PWM6CON
  {$SET_STATE_RAM '61F-61F:SFR'}  // PWMTMRS
  {$SET_STATE_RAM '670-67F:GPR'} 
  {$SET_STATE_RAM '680-680:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '691-699:SFR'}  // CWG1CLKCON, CWG1DAT, CWG1DBR, CWG1DBF, CWG1CON0, CWG1CON1, CWG1AS0, CWG1AS1, CWG1STR
  {$SET_STATE_RAM '6F0-6FF:GPR'} 
  {$SET_STATE_RAM '700-700:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '711-719:SFR'}  // CWG2CLKCON, CWG2DAT, CWG2DBR, CWG2DBF, CWG2CON0, CWG2CON1, CWG2AS0, CWG2AS1, CWG2STR
  ...
  {$SET_STATE_RAM '891-896:SFR'}  // NVMADRL, NVMADRH, NVMDATL, NVMDATH, NVMCON1, NVMCON2
  {$SET_STATE_RAM '89B-89B:SFR'}  // PCON0
  {$SET_STATE_RAM '8F0-8FF:GPR'} 
  {$SET_STATE_RAM '900-900:SFR'}  // mapped to INDF0
  {$SET_STATE_RAM '911-916:SFR'}  // PMD0, PMD1, PMD2, PMD3, PMD4, PMD5
  {$SET_STATE_RAM '918-91F:SFR'}  // CPUDOZE, OSCCON1, OSCCON2, OSCCON3, OSCSTAT1, OSCEN, OSCTUNE, OSCFRQ
  ...
  {$SET_STATE_RAM 'E0F-E1C:SFR'}  // PPSLOCK, INTPPS, T0CKIPPS, T1CKIPPS, T1GPPS, CCP1PPS, CCP2PPS, CCP3PPS, CCP4PPS, CWG1PPS, CWG2PPS, MDCIN1PPS, MDCIN2PPS, MDMINPPS
  {$SET_STATE_RAM 'E20-E22:SFR'}  // SSP1CLKPPS, SSP1DATPPS, SSP1SSPPS
  {$SET_STATE_RAM 'E24-E25:SFR'}  // RXPPS, TXPPS
  {$SET_STATE_RAM 'E28-E2F:SFR'}  // CLCIN0PPS, CLCIN1PPS, CLCIN2PPS, CLCIN3PPS, T3CKIPPS, T3GPPS, T5CKIPPS, T5GPPS
  ...
  {$SET_UNIMP_BITS '012:F3'} // PIR2 bits 3,2 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '092:F3'} // PIE2 bits 3,2 un-implemented (read as 0)
  ...
  // Pin  5 : ANC5/IOCC5/RC5
  // Pin  6 : ANC4/IOCC4/RC4
  // Pin  7 : ANC3/C1IN3-/C2IN3-/IOCC3/RC3
  // Pin  8 : ANC2/C1IN2-/C2IN2-/IOCC2/RC2
  // Pin  9 : ANC1/C1IN1-/C2IN1-/SMB_I2C/IOCC1/RC1
  // Pin 10 : ANC0/C2IN0+/SMB_I2C/IOCC0/RC0
  // Pin 11 : DAC1REF-/VREF-/ANA2/IOCA2/RA2
  // Pin 12 : ICSPCLK/ICDCLK/DAC1REF+/ANA1/C1IN0-/C2IN0-/IOCA1/RA1
  // Pin 13 : ICSPDAT/ICDDAT/DAC1OUT/ANA0/C1IN0+/IOCA0/RA0
  // Pin 14 : VSS
  ...
  {$define _WRT_BOOT              = $3FFE}  // 0000h to 01FFh write-protected, 0200h to 0FFFh may be modified
  {$define _WRT_HALF              = $3FFD}  // 0000h to 07FFh write-protected, 0800h to 0FFFh may be modified
  {$define _WRT_ALL               = $3FFC}  // 0000h to 0FFFh write protected, no addresses may be modified

...
var
  ...
  {$SET_STATE_RAM '98F-993:SFR'}  // CMOUT, CM1CON0, CM1CON1, CM1NCH, CM1PCH
  ...
  {$SET_UNIMP_BITS '70E:41'} // PIR2 bits 7,5,4,3,2,1 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '718:41'} // PIE2 bits 7,5,4,3,2,1 un-implemented (read as 0)
  ...
  {$SET_UNIMP_BITS '798:63'} // PMD2 bits 7,4,3,2 un-implemented (read as 0)
  ...
  // Pin  5 : ZCD1/ANA2/IOCA2/RA2
  // Pin  6 : ICSPCLK/ICDCLK/DAC1REF+/VREF+/ANA1/C1IN0-/IOCA1/RA1

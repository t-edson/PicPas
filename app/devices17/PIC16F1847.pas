...
var
  ...
  {$SET_STATE_RAM '00C-00D:SFR'}            // Bank 0 : PORTA, PORTB
  {$SET_STATE_RAM '011-01C:SFR'}            // Bank 0 : PIR1, PIR2, PIR3, PIR4, TMR0, TMR1L, TMR1H, T1CON, T1GCON, TMR2, PR2, T2CON
  {$SET_STATE_RAM '01E-01F:SFR'}            // Bank 0 : CPSCON0, CPSCON1
  {$SET_STATE_RAM '020-06F:GPR'}           
  {$SET_STATE_RAM '070-07F:GPR:ALLMAPPED'} 
  {$SET_STATE_RAM '08C-08D:SFR'}            // Bank 1 : TRISA, TRISB
  {$SET_STATE_RAM '091-09E:SFR'}            // Bank 1 : PIE1, PIE2, PIE3, PIE4, OPTION_REG, PCON, WDTCON, OSCTUNE, OSCCON, OSCSTAT, ADRESL, ADRESH, ADCON0, ADCON1
  {$SET_STATE_RAM '0A0-0EF:GPR'}           
  {$SET_STATE_RAM '10C-10D:SFR'}            // Bank 2 : LATA, LATB

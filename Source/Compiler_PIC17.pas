...
uses
  ...
  XpresTypesPIC, XpresElementsPIC, Pic17Utils, Pic17Devices, Parser, ParserDirec,
  GenCodBas_PIC17, GenCod_PIC17, ParserDirec_PIC17, Globales, FormConfig {Por diseño, parecería que GenCodBas, no debería accederse desde aquí};
type
 { TCompiler }
...
procedure SetLanguage;
begin
  ParserDirec_PIC17.SetLanguage;
{$I ..\language\tra_Parser.pas}
end;
procedure TCompiler_PIC17.cInNewLine(lin: string);
...
function TCompiler_PIC17.StartOfSection: boolean;
begin
  Result := (cIn.tokL ='var') or (cIn.tokL ='const') or
            (cIn.tokL ='type') or (cIn.tokL ='procedure');
end;
procedure TCompiler_PIC17.ResetFlashAndRAM;
...
procedure TCompiler_PIC17.getListOfIdent(var itemList: TStringDynArray; out srcPosArray: TSrcPosArray);
...
function TCompiler_PIC17.getParamType: TxpEleType;
...
procedure TCompiler_PIC17.ProcComments;
...
procedure TCompiler_PIC17.ProcCommentsNoExec;
...
procedure TCompiler_PIC17.CompileLastEnd;
...
function TCompiler_PIC17.AddVariable(varName: string; eleTyp: TxpEleType; srcPos: TSrcPos
  ): TxpEleVar;
...
function TCompiler_PIC17.AddType(typName: string; srcPos: TSrcPos): TxpEleType;
...
procedure TCompiler_PIC17.CaptureDecParams(fun: TxpEleFun);
...
function TCompiler_PIC17.CompileStructBody(GenCode: boolean): boolean;
...
function TCompiler_PIC17.CompileConditionalBody(out FinalBank: byte): boolean;
...
function TCompiler_PIC17.CompileNoConditionBody(GenCode: boolean): boolean;
...
function TCompiler_PIC17.VerifyEND: boolean;
...
function TCompiler_PIC17.GetExpressionBool: boolean;
...
procedure TCompiler_PIC17.CompileIF;
...
procedure TCompiler_PIC17.Cod_JumpIfTrue;
...
procedure TCompiler_PIC17.CompileREPEAT;
...
procedure TCompiler_PIC17.CompileWHILE;
...
procedure TCompiler_PIC17.CompileFOR;
{Compila uan extructura WHILE}
var
  l1: Word;
  dg: Integer;
...
procedure TCompiler_PIC17.Tree_AddElement(elem: TxpElement);
begin
...
//Métodos OVERRIDE
procedure TCompiler_PIC17.TipDefecNumber(var Op: TOperand; toknum: string);
...
procedure TCompiler_PIC17.TipDefecString(var Op: TOperand; tokcad: string);
...
procedure TCompiler_PIC17.TipDefecBoolean(var Op: TOperand; tokcad: string);
//Devuelve el tipo de cadena encontrado en un token
begin
...
procedure TCompiler_PIC17.CompileProcBody(fun: TxpEleFun);
...
function TCompiler_PIC17.OpenContextFrom(filePath: string): boolean;
...
procedure TCompiler_PIC17.CompileGlobalConstDeclar;
var
...
function TCompiler_PIC17.GetAdicVarDeclar(out IsBit: boolean): TAdicVarDec;
...
procedure TCompiler_PIC17.array_length(const OpPtr: pointer);
...
procedure TCompiler_PIC17.array_high(const OpPtr: pointer);
...
procedure TCompiler_PIC17.array_low(const OpPtr: pointer);
...
procedure TCompiler_PIC17.ArrayDeclaration(out itemTyp: TxpEleType; out nEle: integer);
...
procedure TCompiler_PIC17.CompileTypeDeclar(IsInterface: boolean; typName: string = '');
...
function TCompiler_PIC17.GetTypeVarDeclar: TxpEleType;
...
procedure TCompiler_PIC17.CompileVarDeclar(IsInterface: boolean = false);
...
procedure TCompiler_PIC17.CompileProcHeader(out fun: TxpEleFun; ValidateDup: boolean = true);
...
procedure TCompiler_PIC17.CompileProcDeclar(IsImplementation: boolean);
...
procedure TCompiler_PIC17.CompileInstruction;
...
procedure TCompiler_PIC17.CompileInstructionDummy;
...
procedure TCompiler_PIC17.CompileCurBlock;
...
procedure TCompiler_PIC17.CompileCurBlockDummy;
...
procedure TCompiler_PIC17.CompileUnit(uni: TxpElement);
...
procedure TCompiler_PIC17.CompileUsesDeclaration;
...
procedure TCompiler_PIC17.CompileProgram;
...
procedure TCompiler_PIC17.CompileLinkProgram;
...
function TCompiler_PIC17.IsUnit: boolean;
...
procedure TCompiler_PIC17.RAMusage(lins: TStrings; varDecType: TVarDecType; ExcUnused: boolean);
...
procedure TCompiler_PIC17.DumpCode(lins: TSTrings; incAdrr, incCom, incVarNam: boolean);
begin
  pic.DumpCode(lins, incAdrr, incCom, incVarNam);
end;
function TCompiler_PIC17.RAMusedStr: string;
var
  usedRAM, totRAM: Word;
begin
...
function TCompiler_PIC17.FLASHusedStr: string;
var
  totROM: Integer;
  usedROM: Word;
begin
...
procedure TCompiler_PIC17.GetResourcesUsed(out ramUse, romUse, stkUse: single);
var
  totROM, usedROM: Word;
  usedRAM, totRAM: Word;
begin
...
procedure TCompiler_PIC17.GenerateListReport(lins: TStrings);
{Genera un reporte detallado de la compialción}
var
  curInst, opc: TPIC17Inst;
  i: word;
  OpCodeCoun: array[low(TPIC17Inst)..high(TPIC17Inst)] of integer;
  tmpList: TStringList;
...
begin
  ...
  ////////////////////////////////////////////////////////////
  //Limpia contadores
  for opc := low(TPIC17Inst) to high(TPIC17Inst) do begin
    OpCodeCoun[opc] := 0;
  end;
  //Cuenta apariciones
  ...
  for opc := low(TPIC17Inst) to high(TPIC17Inst) do begin
    tmpList.Add(Format('%.4d', [OpCodeCoun[Opc]]) + '-' + PIC17InstName[opc]);
  end;
  tmpList.Sort;  //Ordena
...
destructor TCompiler_PIC17.Destroy;
begin
  inherited Destroy;
end;

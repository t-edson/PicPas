...
type
  ...
  TGenCod1PICBase = class(TCompilerBase)
  private
...
{ TGenCodPic }
procedure TGenCod1PICBase.ProcByteUsed(offs, bnk: byte;
  regPtr: TPICBaseRamCellPtr);
begin
  linRep := linRep + regPtr^.name +
            ' DB ' + 'bnk'+ IntToStr(bnk) + ':$' + IntToHex(offs, 3) + LineEnding;
end;
procedure TGenCod1PICBase.PutLabel(lbl: string);
...
procedure TGenCod1PICBase.PutFwdComm(cmt: string);
...
function TGenCod1PICBase.ReportRAMusage: string;
...
function TGenCod1PICBase.ValidateByteRange(n: integer): boolean;
...
function TGenCod1PICBase.ValidateWordRange(n: integer): boolean;
//Verifica que un valor entero, se pueda convertir a byte. Si no, devuelve FALSE.
begin
...
function TGenCod1PICBase.ValidateDWordRange(n: Int64): boolean;
begin
...
procedure TGenCod1PICBase.ExchangeP1_P2;
...
procedure TGenCod1PICBase.GenerateROBdetComment;
...
procedure TGenCod1PICBase.GenerateROUdetComment;
{Genera un comentario detallado en el código ASM. Válido solo para
...
procedure TGenCod1PICBase.AssignRAM(out addr: word; regName: string; shared: boolean);
...
procedure TGenCod1PICBase.AssignRAMbit(out addr: word; out bit: byte; regName: string; shared: boolean);
begin
...
function TGenCod1PICBase.CreateRegisterByte(RegType: TPicRegType): TPicRegister;
...
function TGenCod1PICBase.CreateRegisterBit(RegType: TPicRegType): TPicRegisterBit;
{Crea una nueva entrada para registro en listRegAux[], pero no le asigna memoria.
 Si encuentra error, devuelve NIL. Este debería ser el único punto de entrada
para agregar un nuevo registro a listRegAux.}
var
...
function TGenCod1PICBase.CreateTmpVar(nam: string; eleTyp: TxpEleType): TxpEleVar;
...
function TGenCod1PICBase.NewTmpVarWord(rL, rH: TPicRegister): TxpEleVar;
...
function TGenCod1PICBase.NewTmpVarDword(rL, rH, rE, rU: TPicRegister): TxpEleVar;
...
function TGenCod1PICBase.GetAuxRegisterByte: TPicRegister;
...
function TGenCod1PICBase.GetAuxRegisterBit: TPicRegisterBit;
{Devuelve la dirección de un registro de trabajo libre. Si no encuentra alguno, lo crea.
 Si hay algún error, llama a GenError() y devuelve NIL}
var
  reg: TPicRegisterBit;
...
function TGenCod1PICBase.GetStkRegisterByte: TPicRegister;
...
function TGenCod1PICBase.GetStkRegisterBit: TPicRegisterBit;
...
function TGenCod1PICBase.GetVarBitFromStk: TxpEleVar;
...
function TGenCod1PICBase.GetVarByteFromStk: TxpEleVar;
...
function TGenCod1PICBase.GetVarWordFromStk: TxpEleVar;
...
function TGenCod1PICBase.GetVarDWordFromStk: TxpEleVar;
...
function TGenCod1PICBase.FreeStkRegisterBit: boolean;
...
function TGenCod1PICBase.FreeStkRegisterByte: boolean;
...
function TGenCod1PICBase.FreeStkRegisterWord: boolean;
...
function TGenCod1PICBase.FreeStkRegisterDWord: boolean;
...
procedure TGenCod1PICBase.AssignRAMinBit(absAdd, absBit: integer;
...
procedure TGenCod1PICBase.AssignRAMinByte(absAdd: integer;
...
procedure TGenCod1PICBase.CreateVarInRAM(nVar: TxpEleVar; shared: boolean = false);
...
procedure TGenCod1PICBase.SetResultNull;
...
procedure TGenCod1PICBase.SetResultConst(typ: TxpEleType);
...
procedure TGenCod1PICBase.SetResultVariab(rVar: TxpEleVar; Inverted: boolean = false);
{Fija los parámetros del resultado de una subexpresion. Este método se debe ejcutar,
siempre antes de evaluar cada subexpresión.}
begin
...
procedure TGenCod1PICBase.SetResultExpres(typ: TxpEleType; ChkRTState: boolean = true);
...
procedure TGenCod1PICBase.SetResultVarRef(rVarBase: TxpEleVar);
begin
...
procedure TGenCod1PICBase.SetResultExpRef(rVarBase: TxpEleVar; typ: TxpEleType; ChkRTState: boolean = true);
begin
  if ChkRTState then begin
    //Se pide verificar si se están suando los RT, para salvarlos en la pila.
    if RTstate<>nil then begin
...
procedure TGenCod1PICBase.SetROBResultConst_bool(valBool: boolean);
begin
  GenerateROBdetComment;
  SetResultConst(typBool);
  res.valBool := valBool;
end;
procedure TGenCod1PICBase.SetROBResultConst_bit(valBit: boolean);
begin
  GenerateROBdetComment;
  SetResultConst(typBit);
  res.valBool := valBit;
end;
procedure TGenCod1PICBase.SetROBResultConst_byte(valByte: integer);
begin
  GenerateROBdetComment;
...
procedure TGenCod1PICBase.SetROBResultConst_char(valByte: integer);
begin
  GenerateROBdetComment;
  SetResultConst(typChar);
  res.valInt := valByte;
end;
procedure TGenCod1PICBase.SetROBResultConst_word(valWord: integer);
begin
  GenerateROBdetComment;
...
procedure TGenCod1PICBase.SetROBResultConst_dword(valWord: Int64);
begin
  GenerateROBdetComment;
...
procedure TGenCod1PICBase.SetROBResultVariab(rVar: TxpEleVar; Inverted: boolean);
begin
  GenerateROBdetComment;
  SetResultVariab(rVar, Inverted);
end;
//Fija el resultado de ROP como expresión
procedure TGenCod1PICBase.SetROBResultExpres_bit(Opt: TxpOperation; Inverted: boolean);
...
procedure TGenCod1PICBase.SetROBResultExpres_bool(Opt: TxpOperation; Inverted: boolean);
...
procedure TGenCod1PICBase.SetROBResultExpres_byte(Opt: TxpOperation);
...
procedure TGenCod1PICBase.SetROBResultExpres_char(Opt: TxpOperation);
...
procedure TGenCod1PICBase.SetROBResultExpres_word(Opt: TxpOperation);
...
procedure TGenCod1PICBase.SetROBResultExpres_dword(Opt: TxpOperation);
{Define el resultado como una expresión de tipo Word, y se asegura de reservar los
registros H,W, para devolver la salida.}
begin
  GenerateROBdetComment;
...
//Fija el resultado de ROU
procedure TGenCod1PICBase.SetROUResultConst_bit(valBit: boolean);
begin
  GenerateROUdetComment;
  SetResultConst(typBit);
  res.valBool := valBit;
end;
procedure TGenCod1PICBase.SetROUResultConst_byte(valByte: integer);
begin
  GenerateROUdetComment;
  if not ValidateByteRange(valByte) then
    exit;  //Error de rango
...
procedure TGenCod1PICBase.SetROUResultVariab(rVar: TxpEleVar; Inverted: boolean);
begin
  GenerateROUdetComment;
  SetResultVariab(rVar, Inverted);
end;
procedure TGenCod1PICBase.SetROUResultVarRef(rVarBase: TxpEleVar);
{Fija el resultado como una referencia de tipo stVarRefVar}
begin
  GenerateROUdetComment;
  SetResultVarRef(rVarBase);
end;
procedure TGenCod1PICBase.SetROUResultExpres_bit(Inverted: boolean);
{Define el resultado como una expresión de tipo Bit, y se asegura de reservar el registro
...
procedure TGenCod1PICBase.SetROUResultExpres_byte;
{Define el resultado como una expresión de tipo Byte, y se asegura de reservar el
...
procedure TGenCod1PICBase.SetROUResultExpRef(rVarBase: TxpEleVar; typ: TxpEleType);
...
//Adicionales
procedure TGenCod1PICBase.ChangeResultBitToBool;
...
procedure TGenCod1PICBase.ChangeResultCharToByte;
begin

end;
function TGenCod1PICBase.ChangePointerToExpres(var ope: TOperand): boolean;
...
procedure TGenCod1PICBase.CodAsmFD(const inst: TPICBaseInst; const f: byte;
  d: TPICBaseDestin);
begin
  pic.codAsmFD(inst, f, d);
end;
procedure TGenCod1PICBase.CodAsmK(const inst: TPICBaseInst; const k: byte);
begin
  pic.codAsmK(inst, k);
end;
...
procedure TGenCod1PICBase._BANKRESET;
...
procedure TGenCod1PICBase._BANKSEL(targetBank: byte);
...
procedure TGenCod1PICBase.GenCodBank(targetAdrr: word);
...
function TGenCod1PICBase._PC: word; inline;
{Devuelve la dirección actual en Flash}
begin
  Result := pic.iFlash;
end;
function TGenCod1PICBase._CLOCK: integer; inline;
{Devuelve la frecuencia de reloj del PIC}
begin
  Result := pic.frequen;
end;
procedure TGenCod1PICBase._LABEL(igot: integer);
...
procedure TGenCod1PICBase._ANDLW(const k: word); inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmK(i_ANDLW, k);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._ADDWF(const f: byte; d: TPICBaseDestin);
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFD(i_ADDWF, f,d);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._ANDWF(const f: byte; d: TPICBaseDestin);
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFD(i_ANDWF, f,d);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._CLRF(const f: byte); inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmF(i_CLRF, f);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._CLRW; inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsm(i_CLRW);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._COMF(const f: byte; d: TPICBaseDestin);
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFD(i_COMF, f,d);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._DECF(const f: byte; d: TPICBaseDestin);
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFD(i_DECF, f,d);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._DECFSZ(const f: byte; d: TPICBaseDestin);
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFD(i_DECFSZ, f,d);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._INCF(const f: byte; d: TPICBaseDestin);
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFD(i_INCF, f,d);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._INCFSZ(const f: byte; d: TPICBaseDestin);
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFD(i_INCFSZ, f,d);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._IORWF(const f: byte; d: TPICBaseDestin);
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFD(i_IORWF, f,d);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._MOVF(const f: byte; d: TPICBaseDestin);
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFD(i_MOVF, f,d);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._MOVWF(const f: byte);
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmF(i_MOVWF, f);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._NOP; inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsm(i_NOP);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._RLF(const f: byte; d: TPICBaseDestin);
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFD(i_RLF, f,d);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._RRF(const f: byte; d: TPICBaseDestin);
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFD(i_RRF, f,d);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._SUBWF(const f: byte; d: TPICBaseDestin);
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFD(i_SUBWF, f,d);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._SWAPF(const f: byte; d: TPICBaseDestin);
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFD(i_SWAPF, f,d);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._BCF(const f, b: byte); inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFB(i_BCF, f, b);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._BSF(const f, b: byte); //inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFB(i_BSF, f, b);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._BTFSC(const f, b: byte); inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFB(i_BTFSC, f, b);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._BTFSS(const f, b: byte); inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFB(i_BTFSS, f, b);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._CALL(const a: word); inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmA(i_CALL, a);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._CLRWDT; inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsm(i_CLRWDT);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._GOTO(const a: word); inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmA(i_GOTO, a);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._GOTO_PEND(out igot: integer);
...
procedure TGenCod1PICBase._IORLW(const k: word); inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmK(i_IORLW, k);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._MOVLW(const k: word); inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmK(i_MOVLW, k);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._RETFIE; inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsm(i_RETFIE);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._RETLW(const k: word); inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmK(i_RETLW, k);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._RETURN;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsm(i_RETURN);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._SLEEP; inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsm(i_SLEEP);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._XORLW(const k: word); inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmK(i_XORLW, k);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._XORWF(const f: byte; d: TPICBaseDestin);
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFD(i_XORWF, f,d);
  lastOpCode := i_Inval;
end;
procedure TGenCod1PICBase._IFZERO;
begin
  _BTFSC(STATUS, _Z);
end;
procedure TGenCod1PICBase._IFNZERO;
begin
  _BTFSS(STATUS, _Z);
end;
//Instrucciones que manejan el cambio de banco
{Estas instrucciones guardan la instrucción compilada en "lastOpCode".}
procedure TGenCod1PICBase.kADDWF(const f: word; d: TPICBaseDestin);
begin
  GenCodBank(f);
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFD(i_ADDWF, f,d);
...
procedure TGenCod1PICBase.kANDLW(const k: word); inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmK(i_ANDLW, k);
  lastOpCode := i_ANDLW;
end;
procedure TGenCod1PICBase.kANDWF(const f: TPicRegister; d: TPICBaseDestin);
begin
  GenCodBank(f.addr);
  pic.flash[pic.iFlash].curBnk := CurrBank;
...
procedure TGenCod1PICBase.kCLRF(const f: TPicRegister); inline;
begin
  GenCodBank(f.addr);
  pic.flash[pic.iFlash].curBnk := CurrBank;
...
procedure TGenCod1PICBase.kCLRW;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsm(i_CLRW);
  lastOpCode := i_CLRW;
end;
procedure TGenCod1PICBase.kCOMF(const f: word; d: TPICBaseDestin);
begin
  GenCodBank(f);
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFD(i_COMF, f,d);
...
procedure TGenCod1PICBase.kDECF(const f: word; d: TPICBaseDestin);
begin
  GenCodBank(f);
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFD(i_DECF, f,d);
...
procedure TGenCod1PICBase.kDECFSZ(const f: word; d: TPICBaseDestin);
begin
  GenCodBank(f);
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFD(i_DECFSZ, f,d);
...
procedure TGenCod1PICBase.kINCF(const f: TPicRegister; d: TPICBaseDestin);
begin
  GenCodBank(f.addr);
  pic.flash[pic.iFlash].curBnk := CurrBank;
...
procedure TGenCod1PICBase.kINCFSZ(const f: word; d: TPICBaseDestin);
begin
  GenCodBank(f);
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFD(i_INCFSZ, f,d);
...
procedure TGenCod1PICBase.kIORWF(const f: word; d: TPICBaseDestin);
begin
  GenCodBank(f);
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFD(i_IORWF, f,d);
...
procedure TGenCod1PICBase.kMOVF(const f: TPicRegister; d: TPICBaseDestin);
begin
  GenCodBank(f.addr);
  pic.flash[pic.iFlash].curBnk := CurrBank;
...
procedure TGenCod1PICBase.kMOVWF(const f: TPicRegister); inline;
begin
  GenCodBank(f.addr);
  pic.flash[pic.iFlash].curBnk := CurrBank;
...
procedure TGenCod1PICBase.kNOP; inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsm(i_NOP);
  lastOpCode := i_NOP;
end;
procedure TGenCod1PICBase.kRLF(const f: TPicRegister; d: TPICBaseDestin);
begin
  GenCodBank(f.addr);
  pic.flash[pic.iFlash].curBnk := CurrBank;
...
procedure TGenCod1PICBase.kRRF(const f: TPicRegister; d: TPICBaseDestin);
begin
  GenCodBank(f.addr);
  pic.flash[pic.iFlash].curBnk := CurrBank;
...
procedure TGenCod1PICBase.kSUBWF(const f: word; d: TPICBaseDestin);
begin
  GenCodBank(f);
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmFD(i_SUBWF, f,d);
...
procedure TGenCod1PICBase.kSWAPF(const f: TPicRegister; d: TPICBaseDestin);
begin
  GenCodBank(f.addr);
  pic.flash[pic.iFlash].curBnk := CurrBank;
...
procedure TGenCod1PICBase.kBCF(const f: TPicRegisterBit);
begin
  GenCodBank(f.addr);
  pic.flash[pic.iFlash].curBnk := CurrBank;
...
procedure TGenCod1PICBase.kBSF(const f: TPicRegisterBit);
begin
  GenCodBank(f.addr);
  pic.flash[pic.iFlash].curBnk := CurrBank;
...
procedure TGenCod1PICBase.kBTFSC(const f: TPicRegisterBit);
begin
  GenCodBank(f.addr);
  pic.flash[pic.iFlash].curBnk := CurrBank;
...
procedure TGenCod1PICBase.kBTFSS(const f: TPicRegisterBit);
begin
  GenCodBank(f.addr);
  pic.flash[pic.iFlash].curBnk := CurrBank;
...
procedure TGenCod1PICBase.kCALL(const a: word); inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmA(i_CALL, a);
  lastOpCode := i_CALL;
end;
procedure TGenCod1PICBase.kCLRWDT; inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsm(i_CLRWDT);
  lastOpCode := i_CLRWDT;
end;
procedure TGenCod1PICBase.kGOTO(const a: word); inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmA(i_GOTO, a);
  lastOpCode := i_GOTO;
end;
procedure TGenCod1PICBase.kGOTO_PEND(out igot: integer);
{Escribe una instrucción GOTO, pero sin precisar el destino aún. Devuelve la dirección
 donde se escribe el GOTO, para poder completarla posteriormente.
}
begin
...
procedure TGenCod1PICBase.kIORLW(const k: word); inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmK(i_IORLW, k);
  lastOpCode := i_IORLW;
end;
procedure TGenCod1PICBase.kMOVLW(const k: word); inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmK(i_MOVLW, k);
  lastOpCode := i_MOVLW;
end;
procedure TGenCod1PICBase.kRETFIE;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsm(i_RETFIE);
  lastOpCode := i_RETFIE;
end;
procedure TGenCod1PICBase.kRETLW(const k: word); inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmK(i_RETLW, k);
  lastOpCode := i_RETLW;
end;
procedure TGenCod1PICBase.kRETURN; inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsm(i_RETURN);
  lastOpCode := i_RETURN;
end;
procedure TGenCod1PICBase.kSLEEP; inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsm(i_SLEEP);
  lastOpCode := i_SLEEP;
end;
procedure TGenCod1PICBase.kXORLW(const k: word); inline;
begin
  pic.flash[pic.iFlash].curBnk := CurrBank;
  pic.codAsmK(i_XORLW, k);
  lastOpCode := i_XORLW;
end;
procedure TGenCod1PICBase.kXORWF(const f: TPicRegister; d: TPICBaseDestin);
begin
  GenCodBank(f.addr);
  pic.flash[pic.iFlash].curBnk := CurrBank;
...
function TGenCod1PICBase.PicName: string;
begin
  Result := pic.Model;
end;
function TGenCod1PICBase.PicNameShort: string;
{Genera el nombre del PIC, quitándole la parte inicial "PIC".}
begin
  Result := copy(pic.Model, 4, length(pic.Model));
end;
function TGenCod1PICBase.GetIdxParArray(out WithBrack: boolean; out par: TOperand): boolean;
...
function TGenCod1PICBase.GetValueToAssign(WithBrack: boolean; arrVar: TxpEleVar; out value: TOperand): boolean;
...
///////////////// Tipo Bit ////////////////
procedure TGenCod1PICBase.bit_LoadToRT(const OpPtr: pointer; modReturn: boolean);
...
procedure TGenCod1PICBase.bit_DefineRegisters;
begin
  //No es encesario, definir registros adicionales a W
end;
procedure TGenCod1PICBase.bit_SaveToStk;
...
//////////////// Tipo Byte /////////////
procedure TGenCod1PICBase.byte_LoadToRT(const OpPtr: pointer; modReturn: boolean);
...
procedure TGenCod1PICBase.byte_DefineRegisters;
begin
  //No es encesario, definir registros adicionales a W
end;
procedure TGenCod1PICBase.byte_SaveToStk;
var
  stk: TPicRegister;
begin
...
procedure TGenCod1PICBase.byte_GetItem(const OpPtr: pointer);
...
procedure TGenCod1PICBase.byte_SetItem(const OpPtr: pointer);
...
procedure TGenCod1PICBase.byte_ClearItems(const OpPtr: pointer);
...
procedure TGenCod1PICBase.byte_bit(const OpPtr: pointer; nbit: byte);
...
procedure TGenCod1PICBase.byte_bit0(const OpPtr: pointer);
begin
  byte_bit(OpPtr, 0);
end;
procedure TGenCod1PICBase.byte_bit1(const OpPtr: pointer);
begin
  byte_bit(OpPtr, 1);
end;
procedure TGenCod1PICBase.byte_bit2(const OpPtr: pointer);
begin
  byte_bit(OpPtr, 2);
end;
procedure TGenCod1PICBase.byte_bit3(const OpPtr: pointer);
begin
  byte_bit(OpPtr, 3);
end;
procedure TGenCod1PICBase.byte_bit4(const OpPtr: pointer);
begin
  byte_bit(OpPtr, 4);
end;
procedure TGenCod1PICBase.byte_bit5(const OpPtr: pointer);
begin
  byte_bit(OpPtr, 5);
end;
procedure TGenCod1PICBase.byte_bit6(const OpPtr: pointer);
begin
  byte_bit(OpPtr, 6);
end;
procedure TGenCod1PICBase.byte_bit7(const OpPtr: pointer);
begin
  byte_bit(OpPtr, 7);
end;
//////////////// Tipo DWord /////////////
procedure TGenCod1PICBase.word_LoadToRT(const OpPtr: pointer; modReturn: boolean);
...
procedure TGenCod1PICBase.word_DefineRegisters;
begin
...
procedure TGenCod1PICBase.word_SaveToStk;
var
  stk: TPicRegister;
begin
  //guarda W
...
procedure TGenCod1PICBase.word_GetItem(const OpPtr: pointer);
//Función que devuelve el valor indexado
var
  Op: ^TOperand;
  arrVar, tmpVar: TxpEleVar;
...
procedure TGenCod1PICBase.word_SetItem(const OpPtr: pointer);
//Función que fija un valor indexado
var
  WithBrack: Boolean;
var
...
procedure TGenCod1PICBase.word_ClearItems(const OpPtr: pointer);
begin

end;
procedure TGenCod1PICBase.word_Low(const OpPtr: pointer);
...
procedure TGenCod1PICBase.word_High(const OpPtr: pointer);
...
//////////////// Tipo DWord /////////////
procedure TGenCod1PICBase.dword_LoadToRT(const OpPtr: pointer; modReturn: boolean);
{Carga el valor de una expresión a los registros de trabajo.}
var
  Op: ^TOperand;
begin
...
procedure TGenCod1PICBase.dword_DefineRegisters;
begin
...
procedure TGenCod1PICBase.dword_SaveToStk;
var
  stk: TPicRegister;
begin
  //guarda W
...
procedure TGenCod1PICBase.dword_Low(const OpPtr: pointer);
...
procedure TGenCod1PICBase.dword_High(const OpPtr: pointer);
...
procedure TGenCod1PICBase.dword_Extra(const OpPtr: pointer);
...
procedure TGenCod1PICBase.dword_Ultra(const OpPtr: pointer);
...
procedure TGenCod1PICBase.dword_LowWord(const OpPtr: pointer);
...
procedure TGenCod1PICBase.dword_HighWord(const OpPtr: pointer);
...
constructor TGenCod1PICBase.Create;
begin
  inherited Create;
...
destructor TGenCod1PICBase.Destroy;
begin
  INDF.Destroy;
  FSR.Destroy;
  C.Destroy;
